...
<form id="form-application-document" method="POST" enctype="multipart/form-data" action="{{ route('application.submitapp') }}" autocomplete="off">
	@csrf
           	...
           	<div class="card card-info">
				...
				<div class="card-body">
					<div class="card-tools text-right">
						<a href="{{ route('application.formdocumentadd', $application->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i><span class="hidden-xs"> ADD DOCUMENT</span></a>
					</div><br/>
					<div class="row">
                        <div class="col-12">
					...
					<div class="row">
						<div class="col-12 text-center">
                            ...
                            <a href="javascript:void(0);" class="btn btn-primary btn-sm" onclick="event.preventDefault(); document.getElementById('form-application-document').submit();"><i class="fas fa-save"></i><span class="hidden-xs"> {{ __('app.submit') }}</span></a>
						</div>							
					</div>
