...
<div class="text-center mt-4">
    <button type="button" class="btn btn-sm" style="background-color: #3c2387; color: #fff; border: 1px solid #6f42c1; border-radius: 8px;" onclick="goToDokumenTab()" id="next-btn">
