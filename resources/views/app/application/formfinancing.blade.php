				...
				<div class="card-body">
					<div class="row"> 
						<div class="col-sm-6"> 
							<div class="form-group">	
								...
								<select class="form-control" id="selFinancingType" name="selFinancingType" required autocomplete="off">
									<option value="">{{ __('app.please_select')}}</option>
									@foreach($financingType as $ft)
										<option value="{{$ft->id}}">{{ (App::getLocale() == 'en') ? $ft->name : $ft->name_ms }}</option>
									@endforeach	
								</select>
							</div>
							<div class="form-group">
								<label class="col-form-label">Insurance / Takaful (Motor Vehicle) : </label>
								<input type="number" id="txtInsuranceMotor" name="txtInsuranceMotor" value="" class="form-control" required>
							</div>
							<div class="form-group">
								<label class="col-form-label">Deposit : </label>
								<input type="text" id="txtDeposit" name="txtDeposit" value="" class="form-control" required>
							</div>								
						</div>
						<div class="col-sm-6"> 							
							<div class="form-group">
								<label class="col-form-label">Cash Price : </label>
								<input type="text" id="txtCashPrice" name="txtCashPrice" value="" class="form-control" required>
							</div>
							<div class="form-group">
								<label class="col-form-label">Insurance / Takaful (AutoSecure-i1) : </label>
								<input type="number" id="txtInsuranceAutoSecure" name="txtInsuranceAutoSecure" value="" class="form-control">
							</div>
							<div class="form-group">
								<label class="col-form-label">Amount Financed : </label>
								<input type="text" id="txtAmountFinanced" name="txtAmountFinanced" value="" class="form-control" required>
							</div>								
						</div>
						<div class="col-sm-5">
							<div class="form-group">
								<label class="col-form-label">Term/Profit Charges (Fixed Rate) : </label>
								<input type="text" id="txtProfitCharge" name="txtProfitCharge" value="" class="form-control" required>
							</div>
						</div>
						<div class="col-sm-1">
							<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="number" id="txtTenure" name="txtTenure" value="" class="form-control" required>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-12 text-center">
							...
							<a href="javascript:void(0);" class="btn btn-primary btn-sm" onclick="event.preventDefault(); document.getElementById('form-application-financing').submit();"><i class="fas fa-save"></i><span class="hidden-xs"> {{ __('app.save') }}</span></a>
						</div>							
					</div>
