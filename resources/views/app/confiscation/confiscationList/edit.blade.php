                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="radio" id="disokong" name="keputusan" value="Ya" required>
                                                <label for="disokong">Disokong</label>
                                                <input type="radio" id="tidak_disokong" name="keputusan" value="Tidak" style="margin-left:40%;"required>
