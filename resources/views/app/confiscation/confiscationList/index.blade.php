                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-4">
                            <div class="card-header bg-primary">
								<h4 class="mb-0" style="color:white;">Lucut Hak Elaun Sara Hidup Nelayan Darat </h4>
                            </div>
                                        ...
                                        @if (!$confiscation->isEmpty())
                                            ...
                                            <tbody>
                                                @foreach ($confiscation as $a)
                                                    <tr>
                                                        <td>
                                                            <a href="{{ route('confiscation.support-application.edit', $a->id) }}" class="btn btn-sm btn-primary">
