...
@section('content')
<form id="form-profile-create" method="POST"nenctype="multipart/form-data" action="{{ route('profile.storeprofileuser') }}">
@csrf
    <!-- Page Content -->
    <div id="app-content">
                  ...
                  <div class="card card-primary" style="outline: 2px solid lightgray;">
                    <div class="card-header" style="padding-bottom: 2px;">
                        ...
                        <ul class="nav nav-tabs" id="tabMenu" role="tablist">
                            ...
                            @if($user_roles_darat==true)
                            <li class="nav-item">
                                <a class="nav-link active" id="pangkalan-tab" data-bs-toggle="tab" onclick="redirectToPage('{{ route('profile.pangkalanDarat') }}')" role="tab" aria-controls="" aria-selected="false">
                        ...
                        <div class="tab-content" id="tabContent">
                            <!-- Maklumat Individu Content -->
                             <div class="tab-pane fade show active" id="kewangan" role="tabpanel" aria-labelledby="kewangan-tab">
                             <h6 class="section-title" style="font-weight: bold; font-size: 0.9rem; color: #1070d5; border-bottom: 2px solid #1070d5; padding-bottom: 5px; margin-bottom: 2%;">Butiran Pangkalan Pendaratan/Peralatan</h6>
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group">
                                <label>Nama Sungai/Tasik <span style="color: red;">*</span></label>
                                <input type="text" name="nama_syarikat" class="form-control" id="ic" value="SUNGAI BERNAM" disabled>
                              </div>
                            </div>
                            <div class="col-sm-6">
                              <div class="form-group">
                                <label>No. Lesen Menangkap Ikan (Jika Ada)</label>
                                <input type="text" name="nama_syarikat" class="form-control" id="ic" value="-" disabled>
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group">
                                <label>Daerah</label>
                                <select id="pemilikan" name="pemilikan" class="form-control" disabled>
                                  <option value="Syarikat Berhad" >Pilih Daerah</option>
                                  <option value="Syarikat Berhad" selected>BAGAN DATOH</option>
                                  <option value="Syarikat Berhad" >Pemohon Lesen Vesel (Nelayan Darat)</option>
                                  <option value="Syarikat Berhad" >Pengusaha SKL</option>
                                  <option value="Syarikat Berhad" >Pemilik Vesel</option>
                                  <option value="Syarikat Berhad" >Waris/Pentadbir Harta</option>
                                </select>
                              </div>
                            </div>
                            <div class="col-sm-6">
                            <div class="form-group">
                                <label>Tempoh Sah Lesen</label>
                                <div class="d-flex align-items-center">
                                    <span style="margin-right: 10px;">Dari</span>
                                    <input type="date" id="lesen_dari" name="tempoh_sah_lesen_dari" class="form-control" style="max-width: 200px;" value="2024-07-22" disabled>
                                    <span style="margin: 0 10px;">sehingga</span>
                                    <input type="date" id="lesen_sehingga" name="tempoh_sah_lesen_sehingga" class="form-control" style="max-width: 200px;" value="2025-12-31" disabled>
                                </div>
                            </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="form-group">
                                <label>Pangkalan Pendaratan Ikan (Kg./Kawasan) <span style="color: red;">*</span></label>
                                <input type="text" name="nama_syarikat" class="form-control" id="ic" value="PENGKALAN NELAYAN BAGAN PASIR B" disabled>
                              </div>
                            </div>
                            <div class="col-sm-6">
                              <div class="form-group">
                                <label>Peralatan Utama</label>
                                <select id="pemilikan" name="pemilikan" class="form-control" disabled>
                                  <option value="Syarikat Berhad" >Pilih Peralatan Utama</option>
                                  <option value="Syarikat Berhad" selected>PUKAT RAWAI</option>
                                  <option value="Syarikat Berhad" >Pemohon Lesen Vesel (Nelayan Darat)</option>
                                  <option value="Syarikat Berhad" >Pengusaha SKL</option>
                                  <option value="Syarikat Berhad" >Pemilik Vesel</option>
                                  <option value="Syarikat Berhad" >Waris/Pentadbir Harta</option>
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                  <label>Peralatan Tambahan
                                      <!-- <button class="btn btn-outline-primary btn-sm ml-2" type="button" value="" id="addInputBtn" onclick="addPeralatanTambahanInput()" style="padding: 2px 8px;">
                                  ...
                                  <div class="input-group mb-2">
                                      <select id="pemilikan1" name="pemilikan[]" class="form-control" disabled>
                                          <option value="" >Pilih Peralatan Tambahan</option>
                                          <option value="nelayan_laut" selected>-</option>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        function formatDate(input) {
            ...
            if (dateValue) {
                ...
                input.type = "text"; // Change type to text to allow custom display
                input.value = `${day}/${month}/${year.substring(2)}`; // Format as DD/MM/YY
            }
        }

        formatDate(document.getElementById("lesen_dari"));
        formatDate(document.getElementById("lesen_sehingga"));
    });
</script>
@endpush
