...
@section('content')
<form id="form-profile-update" method="GET" enctype="multipart/form-data" action="{{ route('profile.editPenglibatanSyarikat', ['company_id' => $company->id]) }}">
    @csrf
    <div id="app-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="penglibatan" id="pernah_terlibat" value="pernah_terlibat"
                                                {{ $penglibatan_exists && isset($bil_vesel) && $bil_vesel >= 1 ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="pemprosesan" name="industri[]" value="PEMPROSESAN" 
                                                            @if(in_array(1, $jenis_industri)) checked @endif disabled>
                                                        <label class="form-check-label" for="pemprosesan" style="color: black;">Pemprosesan</label>
                                                    </div>
                                                    <div class="form-check mt-2">
                                                        <input class="form-check-input" type="checkbox" id="limbungan" name="industri[]" value="LIMBUNGAN" 
                                                            @if(in_array(2, $jenis_industri)) checked @endif disabled>
                                                        <label class="form-check-label" for="limbungan" style="color: black;">Limbungan</label>
                                                    </div>
                                                    <div class="form-check mt-2">
                                                        <input class="form-check-input" type="checkbox" id="kilang_ais" name="industri[]" value="KILANG AIS" 
                                                            @if(in_array(3, $jenis_industri)) checked @endif disabled>
                                                        <label class="form-check-label" for="kilang_ais" style="color: black;">Kilang Ais</label>
                                                    </div>
                                                    <div class="form-check mt-2">
                                                        <input class="form-check-input" type="checkbox" id="bilik_sejuk" name="industri[]" value="BILIK SEJUK"
                                                            @if(in_array(4, $jenis_industri)) checked @endif disabled>
                                                        <label class="form-check-label" for="bilik_sejuk" style="color: black;">Bilik Sejuk</label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-check mt-2">
                                                        <input class="form-check-input" type="checkbox" id="pemborong_perikanan" name="industri[]" value="PEMBORONG PERIKANAN" 
                                                            @if(in_array(5, $jenis_industri)) checked @endif disabled>
                                                        <label class="form-check-label" for="pemborong_perikanan" style="color: black;">Pemborong Perikanan</label>
                                                    </div>
                                                    <div class="form-check mt-2">
                                                        <input class="form-check-input" type="checkbox" id="peruncitan_perikanan" name="industri[]" value="PERUNCITAN PERIKANAN" 
                                                            @if(in_array(6, $jenis_industri)) checked @endif disabled>
                                                        <label class="form-check-label" for="peruncitan_perikanan" style="color: black;">Peruncitan Perikanan</label>
                                                    </div>
                                                    <div class="form-check mt-2">
                                                        <input class="form-check-input" type="checkbox" id="lain_lain" name="industri[]" value="LAIN-LAIN" 
                                                            @if(in_array(7, $jenis_industri)) checked @endif disabled>
                                                    ...
                                                    <input type="text" id="lain_lain_input" name="lain_lain_input" class="form-control mt-2" placeholder="Sila nyatakan" 
                                                        value="{{ $industri_lain }}" style="display: @if(in_array(7, $jenis_industri)) block @else none @endif;" readonly>
                                                </div>
