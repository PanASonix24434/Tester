<div class="container mt-4">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            <h4 class="mb-0"  style="color: white;">Gambar </h4>
        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <img src="{{ asset('images/no-image.jpg') }}" class="card-img-top img-fluid" alt="Gambar Enjin">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <img src="{{ asset('images/no-image.jpg') }}" class="card-img-top img-fluid"  alt="Gambar No. Enjin">
                        <div class="card-body text-center">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <img src="{{ asset('images/no-image.jpg') }}" class="card-img-top img-fluid"  alt="Gambar Penanda Enjin Vesel (PEV)">
                        <div class="card-body text-center">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <img src="{{ asset('images/no-image.jpg') }}" class="card-img-top img-fluid"   alt="Gambar Turbo">
                        <div class="card-body text-center">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <img src="{{ asset('images/no-image.jpg') }}" class="card-img-top img-fluid"   alt="Gambar Generator">
                        <div class="card-body text-center">
