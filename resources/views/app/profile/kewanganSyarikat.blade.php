                  ...
                  <div class="card card-primary" style="outline: 2px solid lightgray;">
                    <div class="card-header" style="padding-bottom: 2px;">
                        ...
                        <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="butiran-kewangan-tab" data-bs-toggle="tab" onclick="redirectToPage('{{ route('profile.kewanganSyarikat', ['company_id' => $company->id]) }}')" role="tab" aria-controls="butiran-kewangan" aria-selected="false">
                                        Butiran Kewangan
                                    </a>
                                </li>
                                <li class="nav-item">
                            ...
                            <br>
                                    ...
                                    <h6 class="section-title" style="font-weight: bold; font-size: 0.9rem; color: #1070d5; border-bottom: 2px solid #1070d5; padding-bottom: 5px; margin-bottom: 2%;">Butiran Kewangan</h6>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="nama_bank">Nama Bank </label>
                                                <input type="text" name="nama_bank" class="form-control" id="nama_bank" value="{{ $company ? 'BANK SIMPANAN NASIONAL (BSN)' : '' }}" disabled  {{ !$company ? 'disabled' : '' }}>
                                            </div> 

                                            <div class="form-group">
                                                <label for="no_akaun">No. Akaun Bank </label>
                                                <input type="text" name="no_akaun" class="form-control" id="no_akaun" value="{{ $company ? '0810041100017526' : '' }}" disabled  {{ !$company ? 'disabled' : '' }}>
                                            </div> 

                                            <div class="form-group">
                                                <label>Penyata Akaun Semasa - 3 Bulan (RM)</label>
                                            </div> 

                                            
                                            <div class="form-group d-flex align-items-center">
                                                <div style="flex: 1; margin-right: 10px;">
                                                    <label for="select_month_1">Bulan (1)</label>
                                                    <select id="select_month_1" name="select_month_1" class="form-control month-selector" data-input-id="select_month_1" disabled>
                                                        <option value="" disabled>Pilih Bulan</option>
                                                        <option value="januari"disabled selected>JANUARI</option>
                                                    </select>
                                                </div>
                                                <div style="flex: 2;">
                                                    <label for="penyata_akaun_1">Penyata Akaun (RM)</label>
                                                    <input type="text" name="penyata_akaun_1" class="form-control penyata-input" id="penyata_akaun_1"  value="{{ $company ? '7,860.00' : '' }}" disabled  {{ !$company ? 'disabled' : '' }}>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group d-flex align-items-center">
                                                <div style="flex: 1; margin-right: 10px;">
                                                    <label for="select_month_2">Bulan (2)</label>
                                                    <select id="select_month_2" name="select_month_2" class="form-control month-selector" data-input-id="penyata_akaun_2" disabled>
                                                        <option value="" disabled>Pilih Bulan</option>
                                                        <option value="febuari"disabled selected>FEBUARI</option>
                                                    </select>
                                                </div>
                                                <div style="flex: 2;">
                                                    <label for="penyata_akaun_2">Penyata Akaun (RM)</label>
                                                    <input type="text" name="penyata_akaun_2" class="form-control penyata-input" id="penyata_akaun_2"  value="{{ $company ? '5,103.52' : '' }}" disabled  {{ !$company ? 'disabled' : '' }}>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group d-flex align-items-center">
                                                <div style="flex: 1; margin-right: 10px;">
                                                    <label for="select_month_3">Bulan (3)</label>
                                                    <select id="select_month_3" name="select_month_3" class="form-control month-selector" data-input-id="select_month_3" disabled>
                                                        <option value="" disabled>Pilih Bulan</option>
                                                        <option value="mac"disabled selected>MAC</option>
                                                    </select>
                                                </div>
                                                <div style="flex: 2;">
                                                    <label for="penyata_akaun_3">Penyata Akaun (RM)</label>
                                                    <input type="text" name="penyata_akaun_3" class="form-control penyata-input" id="penyata_akaun_3"  value="{{ $company ? '9,612.01' : '' }}" disabled  {{ !$company ? 'disabled' : '' }}>
                                                </div>
                                            </div>           
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                            <label for="penyata_untungrugi">Penyata Untung/Rugi Akaun Yang Diaudit (RM) </label>
                                            <input type="text" name="penyata_untungrugi" class="form-control" id="penyata_untungrugi" value="{{ $company ? '14,780.00' : '' }}" disabled  {{ !$company ? 'disabled' : '' }}>
                                        </div>
                                        <div class="form-group">
                                            <label for="aset_syarikat"> Jumlah Aset Syarikat (RM) </label>
                                            <input type="text" name="aset_syarikat" class="form-control" id="aset_syarikat" value="{{ $company ? '1,005,803.00' : '' }}" disabled  {{ !$company ? 'disabled' : '' }}>
                                        </div>
                                        <div class="form-group">
                                            <label>Rekod Transaksi Bulanan </label>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="aktif_transaksi_bulanan" id="aktif" value="aktif" {{ $company ? 'checked disabled' : '' }} {{ !$company ? 'disabled' : '' }}>
                                                <label class="form-check-label" for="aktif">Aktif</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="tidakaktif_transaksi_bulanan" id="tidak_aktif" value="tidak_aktif" {{ $company ? : '' }} disabled  {{ !$company ? 'checked disabled' : '' }} {{ !$company ? 'disabled' : '' }}>
...
<script>
    // Enable corresponding "Penyata Akaun" input when month is selected
    document.querySelectorAll('.month-selector').forEach(selector => {
        selector.addEventListener('change', function () {
            const inputId = this.dataset.inputId;
            const penyataInput = document.getElementById(inputId);
            if (penyataInput) {
                penyataInput.disabled = false;
                penyataInput.focus();
            }
        });
    });
