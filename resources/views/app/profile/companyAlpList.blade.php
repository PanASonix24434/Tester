...
@section('content')
    ...
    <div class="content-header" style="margin-top:-20px;">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Maklumat Ahli Lembaga Pengarah</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            </div><!-- /.col -->
          </div><!-- /.row -->
                                    ...
                                    <div class="card card-outline">
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                <a href="{{ route('profile.profileCompanyAlpCreate', $company_profile_id) }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i><span class="hidden-xs"> {{ __('app.create') }}</span></a>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                                ...
                                                                <tbody>
                                                                    @foreach ($alps as $a)
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ $a->alp_icno }}</td>
                                                                            <td>{{ $a->alp_email }}</td>
                                                                            <td>{{ $a->alp_phone_no }}</td>
                                                                            <td>{{ $a->alp_position }}</td>
                                                                            @if ($a->alp_citizenship == 1)
                                                                                <td>WARGANEGARA</td>
                                                                            @else
                                                ...
                                                <div class="col-md-8">
                                                    <div class="table-responsive">
                                                        {!! $alps->appends(\Request::except('page'))->render() !!}
                                                    </div>
                                                </div>
                                                @if (!$alps->isEmpty())
                                                    <div class="col-md-4">
                                                        <span class="float-md-right">
                                                            {{ __('app.table_info', [ 'first' => $alps->firstItem(), 'last' => $alps->lastItem(), 'total' => $alps->total() ]) }}
                                                        </span>
                                                    </div>
                                                @endif
                                            </div>
