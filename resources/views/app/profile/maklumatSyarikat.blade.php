...
@section('content')
<form id="form-profile-update" method="GET" enctype="multipart/form-data" action="{{ route('profile.editMaklumatSyarikat', ['id' => $company->id]) }}">
    @csrf
    <div id="app-content">
                            ...
                            <br>
                                    ...
                                    <h6 class="section-title" style="font-weight: bold; font-size: 0.9rem; color: #1070d5; border-bottom: 2px solid #1070d5; padding-bottom: 5px; margin-bottom: 2%;">Butiran Am Syarikat</h6>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group has-validation" style="margin-top: 5px;">
                                                    ...
                                                    <input type="number" class="form-control" id="txtPhoneNoOffice" name="txtPhoneNoOffice" 
                                                        value="{{ isset($company->no_phone_office) ? substr($company->no_phone_office, 1) : '' }}" 
                                                        style="background-color: #F1F2F4; border: 1px solid #ced4da; height: auto;" disabled 
                                                        aria-describedby="inputGroupPrepend">
                                                </div>
                                            </div>
                                            ...
                                            <input type="text" name="fax" class="form-control" id="fax" value="{{ $fax ?? '' }}" readonly>
                                            </div>   
                                            <div class="form-group">
