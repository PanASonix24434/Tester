                  ...
                  <div class="card card-primary" style="outline: 2px solid lightgray;">
                    <div class="card-header" style="padding-bottom: 2px;">
                        ...
                        <ul class="nav nav-tabs" id="tabMenu" role="tablist">
                            ...
                            @if($user_roles_darat==true)
                            <li class="nav-item">
                                <a class="nav-link active" id="kesalahan-tab" data-bs-toggle="tab" onclick="redirectToPage('{{ route('profile.kesalahanDarat') }}')" role="tab" aria-controls="" aria-selected="false">
                                    Kesalahan
                                </a>
                            </li>
                            @endif
                        ...
                        <div class="tab-content" id="tabContent">
                            <!-- Maklumat Individu Content -->
                             <div class="tab-pane fade show active" id="kesalahan" role="tabpanel" aria-labelledby="kesalahan-tab">
                             <h6 class="section-title" style="font-weight: bold; font-size: 0.9rem; color: #1070d5; border-bottom: 2px solid #1070d5; padding-bottom: 5px; margin-bottom: 2%;">Rekod Kesalahan</h6>
                             <div class="row">
                            <div class="col-sm-12 table-responsive">
                            <table class="table table-bordered" style="border: 1px solid #ddd;">
                                  <thead class="table-light" style="border: 1px solid #ddd;">
                                      <tr>
                                          <th style="border: 1px;">Bil</th>
                                          <th style="border: 1px;">Tarikh Kesalahan Direkodkan</th>
                                          <th style="border: 1px;">Kaedah</th>
                                          <th style="border: 1px;">Seksyen Dalam Kaedah</th>
                                          <th style="border: 1px;">Kesalahan</th>
                                          <th style="border: 1px;">Keputusan</th>
                                      </tr>
                                  </thead>
                                  <tbody id="listDoc">
                                      <tr>
                                          <td colspan="6" style="border: 1px solid #ddd; text-align: center; padding: 8px;">
