                  ...
                  <div class="card card-primary" style="outline: 2px solid lightgray;">
                    <div class="card-header" style="padding-bottom: 2px;">
                        ...
                        <ul class="nav nav-tabs" id="tabMenu" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="kewangan-tab" data-bs-toggle="tab" onclick="redirectToPage('{{ route('profile.kewanganDarat') }}')" role="tab" aria-controls="" aria-selected="false">
                                    Maklumat Kewangan
                                </a>
                            </li>
                            @endif
                        ...
                        <div class="tab-content" id="tabContent">
                            <!-- Maklumat Individu Content -->
                             ...
                             <h6 class="section-title" style="font-weight: bold; font-size: 0.9rem; color: #1070d5; border-bottom: 2px solid #1070d5; padding-bottom: 5px; margin-bottom: 2%;">Maklumat Kewangan</h6>
                          <div class="row">
                            ...
                            @else
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="status_esh">Penerima Elaun Sara Hidup (ESH)?</label>
                                        <br>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status_esh" id="esh" value="esh" checked disabled>
                                            <label class="form-check-label" for="esh">Ya</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status_esh" id="bukan_esh" value="bukan_esh" disabled>
                                            <label class="form-check-label" for="bukan_esh">Tidak</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="status_pencen">Penerima Pencen?</label>
                                        <br>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status_pencen" id="pencen" value="pencen" checked disabled>
                                            <label class="form-check-label" for="pencen">Ya</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status_pencen" id="bukan_pencen" value="bukan_pencen" disabled>
                                            <label class="form-check-label" for="bukan_pencen">Tidak</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Jumlah Pencen Sebulan (RM)</label>
                                        <input type="text" class="form-control" value="350" disabled>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="status_kwsp">Pencarum KWSP?</label>
                                        <br>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status_kwsp" id="kwsp" value="kwsp" checked disabled>
                                            <label class="form-check-label" for="kwsp">Ya</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status_kwsp" id="bukan_kwsp" value="bukan_kwsp" disabled>
                                            <label class="form-check-label" for="bukan_kwsp">Tidak</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="status">Penerima Bantuan?</label>
                                        <br>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status" id="bantuan" value="bantuan" disabled>
                                            <label class="form-check-label" for="bantuan">Ya</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status" id="bukan_bantuan" value="bukan_bantuan" checked disabled>
                                            <label class="form-check-label" for="bukan_bantuan">Tidak</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Jumlah Bantuan Sebulan (RM)</label>
