...
@section('title', 'Semakan Keputusan Stok SSD')
                        ...
                        <div class="card-body">
                            <div class="tab-content" id="semakanTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="maklumat" role="tabpanel" aria-labelledby="maklumat-tab">
                                    @include('app.ssd_stock.partials.semakan_maklumat_permohonan')
                                </div>

                                <!-- Status Permohonan Tab -->
                                <div class="tab-pane fade" id="status" role="tabpanel" aria-labelledby="status-tab">
                                    @include('app.ssd_stock.partials.semakan_status_permohonan')
                                </div>

                                <!-- Tindakan Tab -->
                                <div class="tab-pane fade" id="tindakan" role="tabpanel" aria-labelledby="tindakan-tab">
                                    @include('app.ssd_stock.partials.semakan_tindakan')
                                </div>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $('input[name="nombor_siri[]"]').on('input', function() {
        console.log('Serial number changed:', $(this).val());
    });
    
    // Handle approved quantity input changes
    $('input[name="kuantiti_diluluskan[]"]').on('input', function() {
        console.log('Approved quantity changed:', $(this).val());
    });
