...
@section('title', 'Semakan Key Out - KCSPT(N)')
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs" id="keyOutTabs" role="tablist">
                                <li class="nav-item">
...
$(document).ready(function() {
    ...
    $('#keyOutTabs a').on('click', function (e) {
        e.preventDefault();
        $(this).tab('show');
    });
});
