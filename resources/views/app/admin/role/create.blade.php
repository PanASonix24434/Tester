                    ...
                    <div class="text-right">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Tambah Peranan</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      ...
                      <div class="card mb-10">
                        <form id="form-role-create" method="POST" action="{{ route('administration.roles.store') }}" onclick="return getSelectedPermissions()">
                            @csrf
                            ...
                            <div class="tab-content p-4" id="myTabContent">
                              <div class="tab-pane fade show active" id="role" role="tabpanel" aria-labelledby="role-tab">
								...
								<div class="mb-3">
									...
									<input type="number" id="txtQuota" name="txtQuota" class="form-control" />
								</div>
                                @if($validate_lblquota == true)
                                    <span id="name_error" class="text-danger" role="alert">
                                        <strong>Sila masukkan maklumat kuota.</strong>
                                    </span>
                                @endif

                                <!-- Entity -->
								<div class="mb-3">
                                    <label id="lblSelEntity" class="form-label" for="selEntity">Pejabat Bertugas : </label>
                        ...
                        <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                            ...
                            <!--<a href="javascript:void(0);" class="btn btn-secondary btn-sm" onclick="event.preventDefault(); document.getElementById('form-role-create').submit();"><i class="fas fa-save"></i> Simpan</a>-->
                            <button type="submit" class="btn btn-secondary btn-sm" onclick="return confirm($('<span>Simpan Peranan ?</span>').text())">
...
@push('scripts')
    ...
    <script type="text/javascript">
		...
		if (String.fromCharCode(charCode).match(/[a-zA-Z (),\/\-]/g)) {
            ...
            //document.getElementById("lblQuota").append('<span style="color: red;">*</span>');

            

            //$('body').find('input, select, textarea').filter('[required]:visible').find('label').append('<span style="color: red;">*</span>');
	    });
