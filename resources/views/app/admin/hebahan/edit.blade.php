        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-9">
                    <!-- Page header -->
                    <div class="mb-5">
                        <h3 class="mb-0">Lihat Hebahan</h3>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-right">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Lihat Hebahan</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="txtDesc" id="txtDesc" class="form-control" rows="12" placeholder="" readonly>{{ $hebahan[0]->kandungan }}</textarea>
                                    </div>

                                    @if ($hebahan[0]->status == 3)
                                        <!-- Penerangan -->
                                        <div class="form-group">
                                            <label for="txtRemarkReject">Ulasan Ditolak : </label>
                                            <textarea name="txtRemarkReject" id="txtRemarkReject" class="form-control" rows="12" placeholder="" readonly>{{ $hebahan[0]->remark_reject }}</textarea>
                                        </div>
                                    @endif
