...
@section('content')
                            ...
                            <div class="card-header">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 align-items-center">
                                        ...
                                        <div class="mb-6">
                                            <label for="source" class="form-label">Punca Modul : </label>
                                            <input type="text" id="source" name="source" value="{{ $source }}" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 align-items-center">
                                        <div class="mb-6">
                        ...
                        @if (!$audits->isEmpty())
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th style="width:25px; min-width:25px;"></th>
                                    <th style="white-space:nowrap;">Punca Modul</th>
                                    <th style="white-space:nowrap;">{{ __('app.action') }}</th>
                                    <th style="white-space:nowrap;">Dimasukkan Oleh</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <!-- Large modal -->
                                        <a href="{{ route('administration.audit-logs.show', $audit->id) }}" class="btn btn-primary btn-sm audit-view" data-bs-toggle="modal"
                                        data-bs-target=".gd-example-modal-xl"><i class="fa fa-search"></i></a>
    ...
    <!-- modal -->
    <div id="audit-view" class="modal fade gd-example-modal-xl">
    ...
    <!--<div id="audit-view" class="modal fade gd-example-modal-lg" tabindex="-1" role="dialog"
