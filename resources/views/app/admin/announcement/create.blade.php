                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      ...
                      <div class="card mb-10 row">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('administration.announcement.store') }}">
                            @csrf
                            ...
                            <div class="card-body row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" id="tarikh_mula" name="tarikh_mula" class="form-control" required />
                                    </div>
                                    @error('tarikh_mula')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" id="tarikh_hingga" name="tarikh_hingga" class="form-control" required />
                                    </div>
                                    @error('tarikh_hingga')
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="txtDesc" id="txtDesc" class="form-control" rows="9" placeholder="" required></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-3">
