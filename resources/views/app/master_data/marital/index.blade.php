            ...
            <div class="card card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{route('master-data.marital.create')}}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i><span class="hidden-xs"> Add</span></a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                                            ...
                                            @foreach ($marital as $item)
                                                <tr>   
                                                    <td>
                                                        ...
                                                        data-href="{{ route('master-data.marital.delete', $item->id) }}" >
                        ...
                        <div class="col-md-8">
                            <div class="table-responsive">
                                {!! $marital->appends(\Request::except('page'))->render() !!}
                            </div>
                        </div>
                        @if (!$marital->isEmpty())
                            <div class="col-md-4">
                                <span class="float-md-right">
                                    {{ __('app.table_info', [ 'first' => $marital->firstItem(), 'last' => $marital->lastItem(), 'total' => $marital->total() ]) }}
                                </span>
                            </div>
                        @endif
                    </div>
