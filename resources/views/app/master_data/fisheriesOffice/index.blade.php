                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form method="GET" action="{{ route('master-data.fisheries-office.index') }}"
                                    class="mb-4">

                                    <div class="row">
                                        <!-- Search by Name -->
                                        <div class="col-md mb-3">
                                            <label class="form-label">Name Pejabat Perikanan</label>
                                            <input type="text" name="name" class="form-control"
                                                value="{{ request('name') }}"
                                                placeholder="Cari nama pejabat perikanan...">
                                        </div>
                                    ...
                                    <table class="table table-borderless align-middle">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th>Pejabat Perikanan Negeri / Daerah</th>
                                                <th>Daerah</th>
                                                <th>Negeri</th>
                                                <th>Status</th>
                                        ...
                                        <tbody>
                                            @forelse($stateOffice as $index => $office)
                                            <tr>
                                                <td class="text-center">{{ $index + 1 }}</td>
                                                <td>{{ $office->officeName->entity_name }}</td>
                                            ...
                                            @empty
                                            <tr>
                                                <td colspan="5" class="text-center text-muted">Tiada data pejabat perikanan.</td>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
