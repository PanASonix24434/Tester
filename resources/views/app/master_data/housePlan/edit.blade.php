            ...
            <div class="card card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('master-data.plans.index') }}" class="btn btn-default btn-sm"><i class="fas fa-times"></i><span class="hidden-xs"> {{ __('app.back') }}</span></a>
                ...
                <div class="card-body">
                    <form id="form-parliament-add" method="POST" enctype="multipart/form-data" action="{{ route('master-data.plans.update', $plan->id) }}" autocomplete="off">
                        @csrf
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="title">Nama Pelan</label>
                            <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $plan-> title }}" required>
                                @error('title')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="path">{{$plan->filename}}</label>													
                                        </div>
                                </div>
                            </div> 
                            <div class="col-sm-12">
