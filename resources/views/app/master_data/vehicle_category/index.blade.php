            ...
            <div class="card card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{route('master-data.vehicle_category.create')}}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i><span class="hidden-xs"> Add</span></a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                                            ...
                                            @foreach ($vehicle_category as $item)
                                                <tr>
                                                    <td>
                                                        ...
                                                        data-href="{{ route('master-data.vehicle_category.delete', $item->id) }}" >
                        ...
                        <div class="col-md-8">
                            <div class="table-responsive">
                                {!! $vehicle_category->appends(\Request::except('page'))->render() !!}
                            </div>
                        </div>
                        @if (!$vehicle_category->isEmpty())
                            <div class="col-md-4">
                                <span class="float-md-right">
                                    {{ __('app.table_info', [ 'first' => $vehicle_category->firstItem(), 'last' => $vehicle_category->lastItem(), 'total' => $vehicle_category->total() ]) }}
                                </span>
                            </div>
                        @endif
                    </div>
