        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-9">
                    <!-- Page header -->
                    <div class="mb-5">
                        <h3 class="mb-0">Tambah Daerah</h3>
                    </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      ...
                      <div class="card mb-10">
                        <form id="form-district-add" method="POST" action="{{ route('master-data.districts.store') }}" autocomplete="off">
                            @csrf
                        ...
                        <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                            ...
                            <a href="javascript:void(0);" class="btn btn-secondary btn-sm" onclick="event.preventDefault(); document.getElementById('form-district-add').submit();"><i class="fas fa-save"></i> Simpan</a>
                        </div><br/>
