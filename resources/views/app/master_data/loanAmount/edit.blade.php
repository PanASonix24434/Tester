        ...
        <div class="col-md-12">
            <div class="card card-outline">
                <div class="card-header">
                    <h3 class="card-title">KEMASKINI HAD PINJAMAN MAKSIMUM</h3>
                ...
                <div class="card-body">
                    <form id="form-amount-add" method="POST" enctype="multipart/form-data" action="{{ route('master-data.amount.update', $amount->id) }}" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="amount">Had Pinjaman Maksimum (RM) : </label>
                                    <input id="amount" name="amount" class="form-control" type="text" value="{{ number_format($amount->loan_amount) }}" disabled/>    
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="status" name="status" required autocomplete="off">
                                        ...
                                        @if ($amount->is_active == true || $amount->is_active == '1')
