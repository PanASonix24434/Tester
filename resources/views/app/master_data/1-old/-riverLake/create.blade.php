    ...
    <div class="app-content-area">
        <div class="container-fluid">
            <div class="row d-flex align-items-center mb-4">
                <div class="col-md-9">
                    <div>
                        <h3 class="mb-0">Senarai Sungai Dan Tasik</h3>
                        <small class="text-muted">Tambah sungai dan tasik</small>
                    </div>
                </div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item">
                                <a href="{{ route('master-data.river-lake.index') }}">Data Utama</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="card-body">
                                    <form method="POST" action="{{ route('master-data.river-lake.store') }}">
                                        @csrf

                                        <div class="mb-3">
                                            <label for="name" class="form-label">Nama Sungai / Tasik<span
