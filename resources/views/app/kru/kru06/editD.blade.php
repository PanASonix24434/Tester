                                ...
                                <div class="tab-content p-4" id="pills-tabContent-javascript-behavior">
                                    <div class="tab-pane tab-example-design fade show active" id="pills-javascript-behavior-design"
                                        ...
                                        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active disabled" href="{{route('kelulusanpenggunaankrubukanwarganegara.permohonan.editD',$id)}}">Maklumat Dokumen</a>
                                            </li>
                                            <li class="nav-item">
                                        ...
                                        <div class="tab-content p-4" id="myTabContent">
                                            <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                                <form id="form" method="POST" enctype="multipart/form-data" action="{{ route('kelulusanpenggunaankrubukanwarganegara.permohonan.updateD',$id) }}">
                                                    @csrf
                                                    <div class="row">
                                                        @if ( $docIc != null)
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label>Salinan Kad Pengenalan Majikan (jika pemilik individu)</label>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>Salinan Kelulusan Penggajian Pekerja Asing (Jabatan Tenaga Kerja Semenanjung Malaysia)</label>
                                                                <div class="input-group">
                                                        ...
                                                        {{-- <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>Salinan Surat / Pasport Kru yang dicetak Pelekat PLKS <span style="color: red;">*</span></label>
                                                                <div class="input-group">
                                                                    @if ( $docPassportPLKS != null)
                                                                        <a href="{{ route('kruhelper.previewDoc', $docPassportPLKS->id) }}" target="_blank">{{$docPassportPLKS->file_name}}</a>&nbsp;
                                                                        <button type="button" class="btn btn-danger btn-sm"
                                                                            onclick="event.preventDefault(); if (confirm('Hapus Dokumen?')) {
                                                                                    document.getElementById('delete-link-form-{{ $docPassportPLKS->id }}').submit();
                                                                                }">
                                                                            <i class="fas fa-trash"></i>
                                                                        </button>
                                                                    @else
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 text-lg-center mt-3">
                                                            ...
                                                            <a href="{{ route('kelulusanpenggunaankrubukanwarganegara.permohonan.editE',$id) }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-right"></i> Seterusnya</a>
                                                ...
                                                {{--
                                                @if ( $docPassportPLKS != null)
                                                    <form id="delete-link-form-{{ $docPassportPLKS->id }}" 
                                                        action="{{route('kruhelper.deleteDoc',$docPassportPLKS->id)}}" 
                                                        method="POST" 
                                                        style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
