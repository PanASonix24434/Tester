                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('kelulusanpenggunaankrubukanwarganegara.keputusandaerah.index') }}">Permohonan Kelulusan Penggunaan Kru Bukan Warganegara Untuk Bekerja Di Atas Vesel Penangkapan Ikan Tempatan</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <!-- <li class="nav-item">
                                    <a class="nav-link disabled" id="vesel-tab" data-bs-toggle="tab" href="#vesel" role="tab"
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                        ...
                                        @elseif($appPermission->kru_application_type_id==$kru07Id)
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ $appForeign!=null ? strtoupper($appForeign->crew_placement) : '' }}" disabled />
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    <label class="form-label">Di Bawah Pengawasan : </label>
                                                    <input type="text" class="form-control" value="{{ $appForeign!=null ? strtoupper($appForeign->supervised) : '' }}" disabled />
                                                </div>
                                            </div>
                                        @endif
                                        <div class="col-lg-12 text-lg-center mt-3">
                                        <a href="{{ route('kelulusanpenggunaankrubukanwarganegara.keputusandaerah.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                            ...
                                            <tbody id="listKru">
                                                ...
                                                @foreach ($foreignKrus as $foreignKru)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($doc!=null)
                                                                <a href="{{ route('kruhelper.previewKruForeignDoc', $doc->id) }}" target="_blank">{{$foreignKru->passport_number}}</a>
                                                            @else
                                                                {{$foreignKru->passport_number}}
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" name="selKrus[]" class="custom-control-input" id="{{'kru'.$count}}" value="{{$foreignKru->id}}" {{$foreignKru->has_plks==true ? 'checked' : '' }}  disabled>
                                                                <label class="custom-control-label" for="{{'kru'.$count}}"></label>
                                                            </div>
                                                        </td>
                                                        <td>{{$foreignKru->plks_number}}</td>
                                ...
                                <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    ...
                                    <form id="form" method="POST" action="{{ route('kelulusanpenggunaankrubukanwarganegara.keputusandaerah.update',$id) }}">
                                        @csrf
                                        <div class="card-body">
                                            <!-- Vessel -->
                                            <div class="col-6">
                                                                ...
                                                                @foreach ($foreignKrus as $kru)
                                                                    @if ($kru->has_plks)
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: center;">
                                                                                <div class="custom-control custom-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" id="{{'kruSupported'.$count}}" value="{{$kru->id}}" {{$kru->supported ? 'checked' : '' }} disabled>
                                                                                    <label class="custom-control-label" for="{{'kruSupported'.$count}}"></label>
                                                                                </div>
                                                                            </td>
                                                                            <td style="text-align: center;">
                                                                                <div class="custom-control custom-checkbox">
                                                                                    <input type="checkbox" name="selApprovedKrus[]" class="custom-control-input" id="{{'kruApproved'.$count}}" value="{{$kru->id}}" {{$kru->approved ? 'checked' : '' }}>
