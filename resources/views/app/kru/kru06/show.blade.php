                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('kelulusanpenggunaankrubukanwarganegara.permohonan.index') }}">Permohonan Kelulusan Penggunaan Kru Bukan Warganegara Untuk Bekerja Di Atas Vesel Penangkapan Ikan Tempatan</a></li>
                                ...
                                <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            ...
                                            @if ($app->kru_application_status_id == $statusIncompleteId)
                                                <a href="{{ route('kelulusanpenggunaankrubukanwarganegara.permohonan.edit',$id) }}" class="btn btn-secondary btn-sm"><i class="fas fa-edit"></i> Kemaskini</a>
                                            @endif
                                            @if ($app->kru_application_status_id == $statusApprovedId)
                                                <a href="{{ route('kelulusanpenggunaankrubukanwarganegara.permohonan.exportApprovalLetter',$id) }}" target="_blank" class="btn btn-warning btn-sm"><i class="fas fa-print"></i> Surat Kelulusan</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
