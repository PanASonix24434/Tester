        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <!-- Page header -->
                    <div class="mb-5">
                        <h3 class="mb-0">Pembaharuan Kebenaran Penggunaan Kru Bukan Warganegara Untuk Bekerja Di Atas Vesel Penangkapan Ikan Tempatan</h3>
                    </div>
                </div>
                <div class="col-md-6">
                                        ...
                                        @if (!empty($applications) && !$applications->isEmpty())
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- <td>
                                                        {{ App\Models\Kru\KruApplicationForeignKru::where('kru_application_id',$a->id)->pluck('name')->implode(', ') }}
                                                    </td> -->
                                                    ...
                                                    <td>
                                                        @if ( $a->kru_application_status_id == $statusDisimpanId)
                                                            <a class="btn btn-sm btn-warning" href="{{ route('pembaharuanpenggunaankrubukanwarganegara.permohonan.edit', $a->id) }}">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        @else
                                                            <a class="btn btn-sm btn-primary" href="{{ route('pembaharuanpenggunaankrubukanwarganegara.permohonan.show', $a->id) }}">
