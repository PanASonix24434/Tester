            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-9">
                        <!-- Page header -->
                        <div class="mb-5">
                            <h3 class="mb-0">Cetakan Surat</h3>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Cetakan Surat</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                ...
                                <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    <h6 class="section-title" style="font-weight: bold; color: #1070d5; border-bottom: 2px solid #1070d5; padding-bottom: 5px; margin-bottom: 0%;">Cetakan Surat</h6>
                                    <form id="form" method="POST" action="{{ route('pembaharuanpenggunaankrubukanwarganegara.keputusandaerah.update',$id) }}">
                                                            ...
                                                            @if (!$foreignKrus->isEmpty())
                                                                ...
                                                                @foreach ($foreignKrus as $kru)
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: center;">
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input type="checkbox" name="selApprovedKrus[]" class="custom-control-input" id="{{'kruApproved'.$count}}" value="{{$foreignKru->id}}" {{$foreignKru->approved ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 text-lg-center mt-3">
                                                ...
                                                <a href="{{ route('pembaharuanpenggunaankrubukanwarganegara.permohonan.exportPermissionLetter',$id) }}" target="_blank" class="btn btn-warning btn-sm"><i class="fas fa-print"></i> Surat Kebenaran</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
