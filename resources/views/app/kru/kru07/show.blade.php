                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('pembaharuanpenggunaankrubukanwarganegara.permohonan.index') }}">Permohonan Kebenaran Penggunaan Kru Bukan Warganegara Untuk Bekerja Di Atas Vesel Penangkapan Ikan Tempatan</a></li>
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="txtPlacement" class="form-label">Penempatan Kru Terkini :</label>
                                                <input type="text" class="form-control" id="txtPlacement" name="txtPlacement" value="{{ $appForeign!=null ? $appForeign->crew_placement : '' }}" disabled/>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="txtSupervised" class="form-label">Di Bawah Pengawasan :</label>
                                                <input type="text" class="form-control" id="txtSupervised" name="txtSupervised" value="{{ $appForeign!=null ? $appForeign->supervised : '' }}" disabled/>
                                            </div>
                                        </div>
                                    </div>
                                    <br\>
                                    <div class="row">
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('pembaharuanpenggunaankrubukanwarganegara.permohonan.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                            @if ($app->kru_application_status_id == $statusIncompleteId)
                                                <a href="{{ route('pembaharuanpenggunaankrubukanwarganegara.permohonan.editB',$id) }}" class="btn btn-secondary btn-sm"><i class="fas fa-edit"></i> Kemaskini</a>
                                            @endif
                                            @if ($app->is_approved)
                                ...
                                <div class="tab-pane fade" id="vesel" role="tabpanel" aria-labelledby="vesel-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('pembaharuanpenggunaankrubukanwarganegara.permohonan.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                            @if ($app->kru_application_status_id == $statusIncompleteId)
                                                <a href="{{ route('pembaharuanpenggunaankrubukanwarganegara.permohonan.edit',$id) }}" class="btn btn-secondary btn-sm"><i class="fas fa-edit"></i> Kemaskini</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
