                                ...
                                <div class="tab-content p-4" id="pills-tabContent-javascript-behavior">
                                    <div class="tab-pane tab-example-design fade show active" id="pills-javascript-behavior-design"
                                        ...
                                        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active disabled" href="{{route('pembaharuanpenggunaankrubukanwarganegara.permohonan.edit',$id)}}">Senarai Vesel</a>
                                            </li>
                                            <li class="nav-item">
                                        ...
                                        <div class="tab-content p-4" id="myTabContent">
                                            <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                                <form id="form" method="POST" action="{{ route('pembaharuanpenggunaankrubukanwarganegara.permohonan.update',$id) }}">
                                                    @csrf
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 text-lg-center mt-3 mt-lg-0">
                                                            ...
                                                            <a href="{{ route('pembaharuanpenggunaankrubukanwarganegara.permohonan.editB',$id) }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-right"></i> Seterusnya</a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
