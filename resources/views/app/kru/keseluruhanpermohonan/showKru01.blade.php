                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    @if ($decisionStatusIds->contains('id',$app->kru_application_status_id))
                                        ...
                                        aria-controls="action" aria-selected="false">Keputusan Permohonan</a>
                                    @else
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{ $kru->kru_position_id != null ? App\Models\Codemaster::withTrashed()->find($kru->kru_position_id)->name_ms : ''}}" disabled/>
                                            </div>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{ $kru->kewarganegaraan_status_id != null ? App\Models\Codemaster::withTrashed()->find($kru->kewarganegaraan_status_id)->name_ms : ''}}" disabled/>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{ $kru->bumiputera_status_id != null ? App\Models\Codemaster::withTrashed()->find($kru->bumiputera_status_id)->name_ms : ''}}" disabled/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
