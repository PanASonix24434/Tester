        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <!-- Page header -->
                    <div class="mb-5">
                        <h3 class="mb-0">Senarai Permohonan Pembatalan Kad Pendaftaran Nelayan (Tempatan / Pemastautin Tetap)</h3>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-5 text-right">
                        <a href="{{ route('pembatalankadpendaftarannelayan.permohonan.create') }}" class="btn btn-secondary btn-sm"><i class="fas fa-plus"></i> <span class="hidden-xs"> Tambah</span></a>
                    </div>
                </div>
            </div>
            <div>
                                        ...
                                        @if (!empty($applications) && !$applications->isEmpty())
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- <td>
                                                        {{ App\Models\Kru\KruApplicationKru::where('kru_application_id',$a->id)->pluck('name')->implode(', ') }}
                                                    </td> -->
                                                    ...
                                                    <td>
                                                        @if ( $a->kru_application_status_id == $statusDisimpanId)
                                                            <a class="btn btn-sm btn-warning" href="{{ route('pembatalankadpendaftarannelayan.permohonan.edit', $a->id) }}">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        @else
                                                            <a class="btn btn-sm btn-primary" href="{{ route('pembatalankadpendaftarannelayan.permohonan.show', $a->id) }}">
