                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" value="{{ $vessel->no_pendaftaran }}" disabled/>
                                            </div>
                                            <!-- ICNo -->
                                            <div class="mb-3">
                                                <label class="form-label">No. Kad Pengenalan : </label>
                                                <input class="form-control" value="{{$appKru->ic_number}}" disabled/>
                                            </div>
                                            <!-- Bangsa -->
                                            <div class="mb-3">
                                                <label class="form-label">Bangsa : </label>
                                                <input class="form-control" value="{{ $appKru->race_id != null ? App\Models\CodeMaster::withTrashed()->find($appKru->race_id)->name_ms : ''}}" disabled/>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <!-- Position -->
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" value="{{ $appKru->kru_position_id != null ? App\Models\CodeMaster::withTrashed()->find($appKru->kru_position_id)->name_ms : ''}}" disabled/>
                                            </div>
                                            <!-- User FullName -->
                                            <div class="mb-3">
                                                <label class="form-label">Nama : </label>
                                                <input class="form-control" value="{{$appKru->name}}" disabled />
                                            </div>
                                        </div>
                                                    ...
                                                    @if (!$kruDocs->isEmpty())
                                                        ...
                                                        @foreach ($kruDocs as $kruDoc)
                                                            <tr>
                                                                ...
                                                                <td><a href="{{ route('kruhelper.previewKruDoc', $kruDoc->id) }}" target="_blank">{{$kruDoc->description}}</a></td>
