                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('kadpendaftarannelayan.sokonganwilayah.index') }}">Permohonan Kad Pendaftaran Nelayan (Tempatan / Pemastautin Tetap)</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" value="{{ $app->vessel_id != null ? App\Models\Vessel::withTrashed()->find($app->vessel_id)->vessel_no : ''}}" disabled/>
                                            </div>
                                            <!-- ICNo -->
                                            <div class="mb-3">
                                                <label class="form-label">No. Kad Pengenalan ( Tanpa '-' ) : </label>
                                                <input type="number" class="form-control" value="{{$kru->ic_number}}" disabled/>
                                            </div>
                                            <!-- Bangsa -->
                                            <div class="mb-3">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{Helper::getCodeMasterNameById($kru->kru_position_id)}}" disabled/>
                                            </div>
                                            <!-- User FullName -->
                                            <div class="mb-3">
                                                <label class="form-label">Nama ( Masukkan seperti dalam kad pengenalan) : </label>
                                                <input type="text" id="name" name="name" class="form-control" style="text-transform: uppercase" value="{{$kru->name}}" disabled />
                                            </div>
                                        </div>
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('kadpendaftarannelayan.sokonganwilayah.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    ...
                                    <form id="form" method="POST" action="{{ route('kadpendaftarannelayan.sokonganwilayah.update',$id) }}">
                                        @csrf
                                        <div class="card-body">
                                            ...
                                            1. Status Kesihatan Kru : {{Helper::getCodeMasterNameById($kru->kru_health_id)}}
                                            "></i>
                                            <div class="form-group">
