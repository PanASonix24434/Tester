                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('kadpendaftarannelayan.keputusannegeri.index') }}">Permohonan Kad Pendaftaran Nelayan (Tempatan / Pemastautin Tetap)</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('kadpendaftarannelayan.keputusannegeri.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                ...
                                <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    ...
                                    @endphp
                                    <div>1. Status Kesihatan Kru : <b>{{Helper::getCodeMasterNameById($kru->kru_health_id)}}</b> @if ($pkndoc != null) <a href="{{ route('kruhelper.previewKruDoc', $pkndoc->id) }}" target="_blank">({{$pkndoc->description}})</a> @else '-Tiada Dokumen-' @endif</div>
                                    <div>2. Status Kewarganegaraan : <b>{{ $kru->kewarganegaraan_status_id != null ? App\Models\Codemaster::withTrashed()->find($kru->kewarganegaraan_status_id)->name_ms : ''}}</b> </div>
                                    <br>
                                    ...
                                    <form id="form" method="POST" action="{{ route('kadpendaftarannelayan.keputusannegeri.update',$id) }}">
                                        @csrf
                                        <div class="card-body">
                                            <label style="margin-top: 0;">Keputusan :</label>
                                            <div class="form-group">
