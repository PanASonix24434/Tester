                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('kadpendaftarannelayan.keputusanwilayah.index') }}">Permohonan Kad Pendaftaran Nelayan (Tempatan / Pemastautin Tetap)</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Sokongan Wilayah</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                    <div class="row">
                                        <!-- AppType -->
                                        <div class="mb-6">
                                            <label class="form-label">Jenis Permohonan : <span style="color:red;">*</span></label>
                                            <input type="text" class="form-control" value="{{$app2->application_type}}" disabled/>
                                        </div>
                                        <div class="col-6">
                                            <!-- Vessel -->
                                            <div class="mb-3">
                                                <label class="form-label">Vesel : <span style="color:red;">*</span></label>
                                                <input type="text" class="form-control" value="{{$vesel->vessel_number}}" disabled/>
                                            </div>
                                            <!-- ICNo -->
                                            <div class="mb-3">
                                                <label class="form-label">No. Kad Pengenalan ( Tanpa '-' ) : <span style="color:red;">*</span></label>
                                                <input type="number" class="form-control" value="{{$app2->ic_number}}" disabled/>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <!-- Position -->
                                            <div class="mb-3">
                                                <label class="form-label">Jawatan : <span style="color:red;">*</span></label>
                                                <input type="text" class="form-control" value="{{Helper::getCodeMasterNameById($app2->kru_position_id)}}" disabled/>
                                            </div>
                                            <!-- User FullName -->
                                            <div class="mb-3">
                                                <label class="form-label">Nama ( Masukkan seperti dalam kad pengenalan) : <span style="color:red;">*</span></label>
                                                <input type="text" id="name" name="name" class="form-control" style="text-transform: uppercase" value="{{$app2->name}}" disabled />
                                            </div>
                                        </div>
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('kadpendaftarannelayan.keputusanwilayah.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" style="text-transform: uppercase" value="{{$app2->address1}}" disabled />
                                                <input type="text" class="form-control" style="text-transform: uppercase" value="{{$app2->address2}}" disabled/>
                                                <input type="text" class="form-control" style="text-transform: uppercase" value="{{$app2->address3}}" disabled/>
                                            </div>
                                            <!-- Postcode -->
                                            <div class="mb-3">
                                                <label class="form-label">Poskod : <span style="color:red;">*</span></label>
                                                <input type="number" class="form-control" value="{{$app2->postcode}}" disabled/>
                                            </div>
                                            <!-- City -->
                                            <div class="mb-3">
                                                <label class="form-label">Bandar : <span style="color:red;">*</span></label>
                                                <input type="text" class="form-control" style="text-transform: uppercase" value="{{$app2->city}}" disabled />
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <!-- Daerah -->
                                                <label class="form-label">Daerah : <span style="color:red;">*</span></label>
                                                <input type="text" class="form-control" value="{{Helper::getCodeMasterNameById($app2->district_id)}}" disabled/>
                                            <!-- Negeri -->
                                            <div class="mb-3">
                                                <label class="form-label">Negeri : <span style="color:red;">*</span></label>
                                                <input type="text" class="form-control" value="{{Helper::getCodeMasterNameById($app2->state_id)}}" disabled/>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('kadpendaftarannelayan.keputusanwilayah.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group has-validation">
                                                    ...
                                                    <input type="number" class="form-control" value="{{$app2->mobile_contact_number}}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" disabled value="{{$app2->email}}"/>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <!-- Mobile Phone No -->
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group has-validation">
                                                    <span class="input-group-text" id="inputGroupPrepend">+60</span>
                                                    <input type="number" class="form-control" value="{{$app2->home_contact_number}}"
                                                    aria-describedby="inputGroupPrepend" disabled>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                @if (!$logs->isEmpty())
                                                    ...
                                                    @foreach ($logs as $log)
                                                        ...
                                                        <div>
                                                            ...
                                                            <button onclick="window.print()" class="btn btn-link" style="text-decoration: none;">
                                ...
                                <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    ...
                                    <form id="form" method="POST" action="{{ route('kadpendaftarannelayan.keputusanwilayah.update',$id) }}">
                                        @csrf
                                        <div class="card-body">
                                            ...
                                            1. Status Kesihatan Kru : {{Helper::getCodeMasterNameById($app2->kru_health_id)}}
                                            "></i>
                                            <div class="form-group">
