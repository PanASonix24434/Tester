                                    ...
                                    <table class="table mb-0 table-centered table-hover">
                                        ...
                                        @if (!empty($applications) && !$applications->isEmpty())
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $a->submitted_at != null ? $a->submitted_at->format('d/m/Y h:i:s A') : '' }}</td>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-primary" href="{{ route('kadpendaftarannelayan.pengesahanbayaran.show', $a->id) }}">
