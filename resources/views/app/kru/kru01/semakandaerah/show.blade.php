                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('kadpendaftarannelayan.semakandaerah.index') }}">Permohonan Kad Pendaftaran Nelayan (Tempatan / Pemastautin Tetap)</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                @if ($kru->kewarganegaraan_status_id == $warganegaraId)
                                                    <input class="form-control" style="background-color: lightblue;" value="{{ $kru->kewarganegaraan_status_id != null ? App\Models\Codemaster::withTrashed()->find($kru->kewarganegaraan_status_id)->name_ms : ''}}" disabled/>
                                                @elseif ($kru->kewarganegaraan_status_id == $pemastautinTetapId)
                                                    <input class="form-control" style="background-color: salmon;" value="{{ $kru->kewarganegaraan_status_id != null ? App\Models\Codemaster::withTrashed()->find($kru->kewarganegaraan_status_id)->name_ms : ''}}" disabled/>
                                                @else
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('kadpendaftarannelayan.semakandaerah.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" value="{{$kru->address1}}" disabled />
                                                <input class="form-control" value="{{$kru->address2}}" disabled/>
                                                <input class="form-control" value="{{$kru->address3}}" disabled/>
                                            </div>
                                            <!-- Postcode -->
                                            <div class="mb-3">
                                                <label class="form-label">Poskod : </label>
                                                <input class="form-control" value="{{$kru->postcode}}" disabled/>
                                            </div>
                                            <!-- City -->
                                            <div class="mb-3">
                                                <label class="form-label">Bandar : </label>
                                                <input class="form-control" value="{{$kru->city}}" disabled />
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <!-- Daerah -->
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" value="{{Helper::getCodeMasterNameById($kru->district_id)}}" disabled/>
                                            </div>
                                            <!-- Negeri -->
                                            <div class="mb-3">
                                                <label class="form-label">Negeri : </label>
                                                <input class="form-control" value="{{Helper::getCodeMasterNameById($kru->state_id)}}" disabled/>
                                            </div>
                                        </div>
                                    </div>
                                    <hr/>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group has-validation">
                                                    ...
                                                    <input class="form-control" value="{{$kru->mobile_contact_number}}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" disabled value="{{$kru->email}}"/>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <!-- Mobile Phone No -->
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group has-validation">
                                                    <span class="input-group-text" id="inputGroupPrepend">+60</span>
                                                    <input class="form-control" value="{{$kru->home_contact_number}}"
                                                    aria-describedby="inputGroupPrepend" disabled>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    ...
                                    <form id="form" method="POST" enctype="multipart/form-data" action="{{ route('kadpendaftarannelayan.semakandaerah.update',$id) }}">
                                        @csrf
                                        <div class="card-body">
                                            ...
                                            <div id="lengkap" class="{{$savedLog!=null ? ($savedLog->completed ? '' : 'hidden') : 'hidden'}}" >
                                                <div class="form-group">
                                                    <label>Siasatan:</label>
                                                    @if ( $docSiasatan != null)
                                                        <a href="{{ route('kruhelper.previewKruDoc', $docSiasatan->id) }}" target="_blank">{{$docSiasatan->file_name}}</a>&nbsp;
                                                        <button type="button" class="btn btn-danger btn-sm"
                                                            onclick="event.preventDefault(); if (confirm('Hapus Dokumen?')) {
                                                                    document.getElementById('delete-link-form-{{ $docSiasatan->id }}').submit();
                                                                }">
                                                            <i class="fas fa-trash"></i>
                                                        </button>
                                                    @else
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input" id="docSiasatan" name="docSiasatan">
                                                            <label class="custom-file-label" for="docSiasatan">Pilih Fail</label>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    @if ( $docSiasatan != null)
                                        <form id="delete-link-form-{{ $docSiasatan->id }}" 
                                            action="{{route('kruhelper.deleteKruDoc',$docSiasatan->id)}}" 
                                            method="POST" 
                                            style="display: none;">
                                            @csrf
                                            @method('DELETE')
