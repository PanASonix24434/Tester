                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('gantiankadpendaftarannelayan.sokongannegeri.index') }}">Gantian Kad Pendaftaran Nelayan (Tempatan / Pemastautin Tetap)</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                ...
                                <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    ...
                                    <form id="form" method="POST" action="{{ route('gantiankadpendaftarannelayan.sokongannegeri.update',$id) }}">
                                        @csrf
                                        <div class="card-body">
