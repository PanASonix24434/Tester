        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <!-- Page header -->
                    <div class="mb-5">
                        <h3 class="mb-0">Senarai Gantian Kad Pendaftaran Nelayan (Tempatan / Pemastautin Tetap)</h3>
                    </div>
                </div>
            </div>
            <div>
                                        ...
                                        @if (!empty($applications) && !$applications->isEmpty())
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-primary" href="{{ route('gantiankadpendaftarannelayan.pengesahanbayaran.show', $a->id) }}">
