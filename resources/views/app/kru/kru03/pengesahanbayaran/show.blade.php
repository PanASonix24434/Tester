                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('gantiankadpendaftarannelayan.pengesahanbayaran.index') }}">Gantian Kad Pendaftaran Nelayan (Tempatan / Pemastautin Tetap)</a></li>
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                <div class="tab-pane fade" id="application" role="tabpanel" aria-labelledby="application-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('gantiankadpendaftarannelayan.pengesahanbayaran.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade show active" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="form" method="POST" action="{{ route('gantiankadpendaftarannelayan.pengesahanbayaran.update',$id) }}">
                                            @csrf
                                            <div class="form-group">
