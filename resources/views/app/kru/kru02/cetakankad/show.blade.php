                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('pembaharuankadpendaftarannelayan.cetakankad.index') }}">Permohonan Kad Pendaftaran Nelayan (Tempatan / Pemastautin Tetap)</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                <div class="tab-pane fade" id="application" role="tabpanel" aria-labelledby="application-tab">
                                    <div class="row">
                                                        ...
                                                        @if (!$selectedKrus->isEmpty())
                                                            ...
                                                            @foreach ($selectedKrus as $kru)
                                                                <tr>
                                                                    <td>{{++$count}}</td>
                                                                    <td>
                                                                        <a href="{{ route('pembaharuankadpendaftarannelayan.cetakankad.showKru',$kru->id) }}" target="_blank">{{$kru->ic_number}}</a>
                                                                    </td>
                                                                    <td>{{$kru->name}}</td>
                                        ...
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('pembaharuankadpendaftarannelayan.cetakankad.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade show active" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    <h6 class="section-title" style="font-weight: bold; color: #1070d5; border-bottom: 2px solid #1070d5; padding-bottom: 5px; margin-bottom: 0%;">Cetakan</h6>
                                    <form id="form"  method="POST" action="{{ route('pembaharuankadpendaftarannelayan.cetakankad.checkPin',$id) }}">
                                        @csrf
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="pin">Nombor PIN</label>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 text-lg-center mt-3">
                                                <a href="{{ route('pembaharuankadpendaftarannelayan.cetakankad.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                                <button id="btnSubmit" type="submit" name="action" value="submit" class="btn btn-primary btn-sm" onclick="return confirm($('<span>Semak No. Pin?</span>').text())">
                                                    <i class="fas fa-paper-plane"></i> Semak
                                                </button>
                                            </div>
                                        </div>
                                    </form>
...
@push('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if ($(this).valid()) {
                if ($("#pin").val() == "0001") {
                alert("Nombor PIN sah");
                $("#validPin").removeClass("hidden");
                $("#btnSubmitPin").prop("disabled", true);
                $("#pin").prop("disabled", true);
                // $("#txtRemark").attr("placeholder", "");
                } else {
                alert("Nombor PIN tidak sah");
                $("#validPin").addClass("hidden");
