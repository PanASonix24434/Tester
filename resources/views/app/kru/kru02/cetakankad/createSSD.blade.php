                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <form id="form" method="POST" action="{{ route('pembaharuankadpendaftarannelayan.cetakankad.updateSSD',$selectedKru->id) }}">
                                @csrf
                                <div class="row">
                                    <div class="mb-3">
                            ...
                            <form id="backForm" method="POST" action="{{ route('pembaharuankadpendaftarannelayan.cetakankad.checkPin',$id) }}" method="POST">
                                @csrf 
