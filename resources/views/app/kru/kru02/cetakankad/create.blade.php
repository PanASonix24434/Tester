                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('pembaharuankadpendaftarannelayan.cetakankad.index') }}">Pembaharuan Kad Pendaftaran Nelayan (Tempatan / Pemastautin Tetap)</a></li>
                        ...
                        <div class="card-body">
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ( $kru->ssd_number == null || $kru->has_sucessfully_printed === false )
                                                                <form method="GET" action="{{ route('pembaharuankadpendaftarannelayan.cetakankad.createSSD',$kru->id) }}">
                                                        ...
                                                        <td style="text-align: center;">
                                                            @if ( $kru->ssd_number != null && $kru->has_sucessfully_printed === null)
                                                                <a class="btn btn-secondary btn-sm" href="{{route('pembaharuankadpendaftarannelayan.cetakankad.print',$kru->id)}}" target="_blank"><i class="fas fa-print"></i> Cetak</a>
                                                            @else
                                                        ...
                                                        <td>
                                                            @if ( $kru->ssd_number != null && $kru->has_sucessfully_printed === null)
                                                                <form method="POST" action="{{ route('pembaharuankadpendaftarannelayan.cetakankad.updatePrinted',$kru->id) }}">
                                                                    @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-lg-center mt-3">
                                    <form method="POST" action="{{ route('pembaharuankadpendaftarannelayan.cetakankad.updateCompleted',$id) }}">
                                        @csrf
                                        <a href="{{ route('pembaharuankadpendaftarannelayan.cetakankad.show',$id) }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
