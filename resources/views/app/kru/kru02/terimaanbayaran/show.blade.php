                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('pembaharuankadpendaftarannelayan.terimaanbayaran.index') }}">Pembaharuan Kad Pendaftaran Nelayan (Tempatan / Pemastautin Tetap)</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{$vessel->vessel_no}}" disabled/>
                                            </div>
                                        </div>
                                        <div class="row">
                                                        ...
                                                        @if (!$selectedKrus->isEmpty())
                                                            ...
                                                            @foreach ($selectedKrus as $kru)
                                                                <tr>
                                                                    <td>{{++$count}}</td>
                                                                    <td>
                                                                        <a href="{{ route('pembaharuankadpendaftarannelayan.terimaanbayaran.showKru',$kru->id) }}" target="_blank">{{$kru->ic_number}}</a>
                                                                    </td>
                                                                    <td>{{$kru->name}}</td>
                                        ...
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('pembaharuankadpendaftarannelayan.terimaanbayaran.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade show active" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    ...
                                    <form id="form" method="POST" action="{{ route('pembaharuankadpendaftarannelayan.terimaanbayaran.update',$id) }}">
                                        @csrf
                                        <div class="card-body">
                                            <div class="col-sm-12 table-responsive">
                                                <div class="form-group">
                                                    <label class="col-form-label">Senarai Bayaran Diterima:</label>
                                                    <a href="{{ route('pembaharuankadpendaftarannelayan.terimaanbayaran.createReceipt',$id) }}" class="btn btn-secondary btn-sm float-right">
                                                        ...
                                                        @if ($receipts!=null && !$receipts->isEmpty())
                                                            @foreach ($receipts as $receipt)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td rowspan="{{$itemCount}}" style="vertical-align: middle; text-align: center;"><a href="{{ route('kruhelper.deleteReceipt', $receipt->id) }}" class="btn btn-danger btn-sm" onclick="return confirm($('<span>Hapus Maklumat Bayaran?</span>').text())"><i class="fas fa-trash"></i></button></td>
                                                                </tr>
                                                                @if ($itemCount > 1)
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="payee" class="form-control" style="text-transform: uppercase" id="payee" value="{{$payment!=null?$payment->payee:''}}" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
