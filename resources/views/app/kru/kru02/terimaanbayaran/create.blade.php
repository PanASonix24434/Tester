                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="form" method="POST" enctype="multipart/form-data" action="{{ route('pembaharuankadpendaftarannelayan.terimaanbayaran.storeReceipt',$id) }}">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('pembaharuankadpendaftarannelayan.terimaanbayaran.show',$id) }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnAddItem").click(function() {
                ...
                if(addedItemTypeSel == ''){
                    alert('Sila pilih item bayaran !!');
                }
                else if(addedAmountNum == ''){
                    alert('Sila masukkan nilai bayaran !!');
                }
                else{
                    //clear input
