                                ...
                                <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                    <div class="row">
                                                        ...
                                                        @if (!$selectedKrus->isEmpty())
                                                            ...
                                                            @foreach ($selectedKrus as $kru)
                                                                <tr>
                                                                    <td>{{++$count}}</td>
                                                                    <td>
                                                                        <a href="{{ route('pembaharuankadpendaftarannelayan.permohonan.showKru',$kru->id) }}" target="_blank">{{$kru->ic_number}}</a>
                                                                    </td>
                                                                    <td>{{$kru->name}}</td>
                                        ...
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            ...
                                            @if ($app->kru_application_status_id == $statusIncompleteId)
                                                <a href="{{ route('pembaharuankadpendaftarannelayan.permohonan.edit',$id) }}" class="btn btn-secondary btn-sm"><i class="fas fa-edit"></i> Kemaskini</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
