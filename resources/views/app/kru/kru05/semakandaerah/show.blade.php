                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('kebenaranpenggunaankrubukanwarganegara.semakandaerah.index') }}">Permohonan Kebenaran Penggunaan Kru Bukan Warganegara Untuk Bekerja Di Atas Vesel Penangkapan Ikan Tempatan</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('kebenaranpenggunaankrubukanwarganegara.semakandaerah.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                            ...
                                            <tbody id="listKru">
                                                ...
                                                @foreach ($foreignKrus as $foreignKru)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ route('kruhelper.downloadKruForeignDoc', $doc->id) }}" target="_blank">{{$foreignKru->passport_number}}</a></td>
                                ...
                                <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    ...
                                    <form id="form" method="POST" action="{{ route('kebenaranpenggunaankrubukanwarganegara.semakandaerah.update',$id) }}">
                                        @csrf
                                        <div class="card-body">
