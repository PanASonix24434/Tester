		...
		<div class="row">
			<div class="card card-info">
				<div class="card-body">
					...
					<br/>
					<div class="row">
						<div style="text-align: justify;">3.&nbsp;&nbsp;&nbsp;&nbsp;Untuk makluman tuan, kru berkenaan dijangka tiba pada tarikh <b>{{$immigrationDate}}</b> melalui pintu masuk <b>{{$immigrationGate}}</b>. Walaubagaimanapun, kelulusan kebenaran masuk kru tersebut adalah tertakluk kepada Akta Imigresen 1959/63 dan Peraturan pihak Jabatan Imigresen Malaysia.</div>
					</div>
					<br/>
					<div class="row">
