                                ...
                                <div class="tab-content p-4" id="pills-tabContent-javascript-behavior">
                                    <div class="tab-pane tab-example-design fade show active" id="pills-javascript-behavior-design"
                                        ...
                                        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active" href="{{route('kebenaranpenggunaankrubukanwarganegara.permohonan.editE',$id)}}">Perakuan</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content p-4" id="myTabContent">
                                            <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                                <form id="form" method="POST" action="{{ route('kebenaranpenggunaankrubukanwarganegara.permohonan.updateE',$id) }}">
                                                    @csrf
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 text-lg-center mt-3">
                                                            <a href="{{ route('kebenaranpenggunaankrubukanwarganegara.permohonan.editD',$id) }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
