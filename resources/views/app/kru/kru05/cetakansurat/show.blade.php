                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('kebenaranpenggunaankrubukanwarganegara.cetakansurat.index') }}">Permohonan Kebenaran Penggunaan Kru Bukan Warganegara Untuk Bekerja Di Atas Vesel Penangkapan Ikan Tempatan</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('kebenaranpenggunaankrubukanwarganegara.cetakansurat.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                ...
                                <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    <h6 class="section-title" style="font-weight: bold; color: #1070d5; border-bottom: 2px solid #1070d5; padding-bottom: 5px; margin-bottom: 0%;">Cetakan  Surat Kebenaran</h6>
                                    <div class="card-body">
                                        <!-- Vessel -->
                                        <div class="col-6">
                                            <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            ...
                                            <a type="submit" href="{{ route('kebenaranpenggunaankrubukanwarganegara.permohonan.exportPermissionLetter',$id) }}" target="_blank"  class="btn btn-warning btn-sm" >
                                                <i class="fas fa-print"></i> Cetak Surat Kebenaran
                                            </a>
                                        </div>
                                    </div>
                                </div>
