            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-9">
                        <!-- Page header -->
                        <div class="mb-5">
                            <h3 class="mb-0">Semakan Daerah</h3>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('pembatalanpenggunaankrubukanwarganegara.semakandaerah.index') }}">Permohonan Kebenaran Penggunaan Kru Bukan Warganegara Untuk Bekerja Di Atas Vesel Penangkapan Ikan Tempatan</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Semakan Daerah</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('pembatalanpenggunaankrubukanwarganegara.semakandaerah.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                ...
                                <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    ...
                                    <form id="form" method="POST" action="{{ route('pembatalanpenggunaankrubukanwarganegara.semakandaerah.update',$id) }}">
                                        @csrf
                                        <div class="card-body">
                                            <!-- Vessel -->
                                            <div class="col-6">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: center;">
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input type="checkbox" name="selSupportedKrus[]" class="custom-control-input" id="{{'kruSupported'.$count}}" value="{{$foreignKru->id}}" {{$foreignKru->supported ? 'checked' : '' }} >
