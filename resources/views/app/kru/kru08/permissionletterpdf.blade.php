		...
		<div class="row">
			<div class="card card-info">
				<div class="card-body">
					...
					<br/>
					<div class="row">
						<div style="text-align: justify;">3.&nbsp;&nbsp;&nbsp;&nbsp;Untuk makluman tuan, kru berkenaan dijangka tiba pada tarikh {{$immigrationDate}} melalui pintu masuk {{$immigrationGate}}. Walaubagaimanapun, kelulusan kebenaran masuk kru tersebut adalah tertakluk kepada Akta Imigresen 1959/63 dan Peraturan pihak Jabatan Imigresen Malaysia.</div>
					</div>
					<br/>
					<div class="row">
		...
		<div>
			<div class="card card-info">
				<div class="card-body">
					...
					<br/>
					<div class="row">
						<div><b><i>NOTA: SILA PASTIKAN KESEMUA RUANGAN DIISI DENGAN TEPAT TERUTAMA “JAWATAN” PEKERJA ASING YANG DIPOHON.</i></b></div>
					</div>
					<br/>
				</div>
			</div>
