                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('pembatalanpenggunaankrubukanwarganegara.keputusandaerah.index') }}">Permohonan Kebenaran Penggunaan Kru Bukan Warganegara Untuk Bekerja Di Atas Vesel Penangkapan Ikan Tempatan</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content p-4" id="tabContent">
                                <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            <a href="{{ route('pembatalanpenggunaankrubukanwarganegara.keputusandaerah.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                ...
                                <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                    ...
                                    <form id="form" method="POST" action="{{ route('pembatalanpenggunaankrubukanwarganegara.keputusandaerah.update',$id) }}">
                                        @csrf
                                        <div class="card-body">
                                            <!-- Vessel -->
                                            <div class="col-6">
                                                    ...
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Disokong FA DAERAH</th>
                                                                <th>Dipilih untuk Diluluskan</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody id="listKru">
                                                            @if (!$foreignKrus->isEmpty())
                                                                ...
                                                                @foreach ($foreignKrus as $kru)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{$kru->name}}</td>
                                                                        <td>{{$kru->revocation_reason}}</td>
                                                                        <td style="text-align: center;">
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input type="checkbox" class="custom-control-input" id="{{'kruSupported'.$count}}" value="{{$foreignKru->id}}" {{$foreignKru->supported ? 'checked' : '' }} disabled>
                                                                                <label class="custom-control-label" for="{{'kruSupported'.$count}}"></label>
                                                                            </div>
                                                                        </td>
                                                                        <td style="text-align: center;">
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input type="checkbox" name="selApprovedKrus[]" class="custom-control-input" id="{{'kruApproved'.$count}}" value="{{$foreignKru->id}}" {{$foreignKru->approved ? 'checked' : '' }}>
                                                                                <label class="custom-control-label" for="{{'kruApproved'.$count}}"></label>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                        ...
                                        <div class="row">
                                            ...
                                            <button class="btn btn-info btn-sm next-tab-btn" data-next-tab="log-tab"><i class="fas fa-arrow-left"></i> Kembali</button>
                                                <button type="submit" name="action" value="save" class="btn btn-sm" style="background-color: #007BFF; color: #fff; border: none; border-radius: 8px; padding: 8px 16px; font-weight: bold; box-shadow: 0 2px 8px rgba(0,123,255,0.3);" onclick="return confirm($('<span>Simpan Maklumat?</span>').text())">
                                                    <i class="fas fa-save" style="color: #fff;"></i> Simpan
                                                </button>
                                                <button id="btnSubmit" type="submit" name="action" value="submit" disabled class="btn btn-sm" style="background-color: #28a745; color: #fff; border: none; border-radius: 8px; padding: 8px 16px; font-weight: bold; box-shadow: 0 2px 8px rgba(40,167,69,0.3);" onclick="return confirm($('<span>Hantar Permohonan?</span>').text())">
