                                        ...
                                        @if (!empty($applications) && !$applications->isEmpty())
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $a->name }}</td>
                                                    <td>{{ $a->vessel_id != null ? optional(App\Models\Vessel::withTrashed()->find($a->vessel_id))->no_pendaftaran : '' }}</td>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-primary" href="{{ route('pembatalanpenggunaankrubukanwarganegara.keputusandaerah.show', $a->id) }}">
