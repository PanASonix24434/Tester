                    ...
                    <div class="col-md-3">
                        <div class="text-right">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('pembatalanpenggunaankrubukanwarganegara.permohonan.index') }}">Permohonan Kebenaran Penggunaan Kru Bukan Warganegara Untuk Bekerja Di Atas Vesel Penangkapan Ikan Tempatan</a></li>
                                ...
                                <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 text-lg-center mt-3">
                                            ...
                                            @if ($app->kru_application_status_id == $statusIncompleteId)
                                                <a href="{{ route('pembatalanpenggunaankrubukanwarganegara.permohonan.edit',$id) }}" class="btn btn-secondary btn-sm"><i class="fas fa-edit"></i> Kemaskini</a>
                                            @endif
                                            {{--
                                            @if ($app->is_approved)
                                                <a href="{{ route('pembatalanpenggunaankrubukanwarganegara.permohonan.exportPermissionLetter',$id) }}" target="_blank" class="btn btn-warning btn-sm"><i class="fas fa-print"></i> Surat Kebenaran</a>
                                            @endif
                                            --}}
                                        </div>
                                    </div>
