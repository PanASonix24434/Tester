                        ...
                        <div class="mb-5">
                            <h3 class="mb-0">
                                @if (auth()->user()->user_type == 6)
                                    Daftar Sebagai Pewaris
                                @else
                                    Daftar Sebagai Pentadbir Harta
                                @endif
                            </h3>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <ul class="nav nav-line-bottom" id="pills-tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" id="pills-card-info-tab" data-bs-toggle="pill" href="#pills-card-info" role="tab" aria-controls="pills-card-info" aria-selected="true">Maklumat Profil</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content p-4" id="pills-tabContent">
                                        <div class="tab-pane fade active show" id="pills-card-info" role="tabpanel" aria-labelledby="pills-card-info-tab">
                                           ...
                                           <div class="row">
                                                @php
                                                    $defaultStatus = auth()->user()->user_type == 6 ? 'waris' : 'pentadbir_harta';
                                                    $selectedStatus = old('user_status', $defaultStatus);
                                                @endphp

                                                {{-- KOLUMN 1: user_status + relationship --}}
                                                <div class="col-lg-6">
                                                    {{-- Status Pengguna --}}
                                                    <div class="mb-5">
                                                        ...
                                                        <select id="user_status" class="form-control" name="user_status" required>
                                                            <option value="waris"{{ $selectedStatus === 'waris' ? ' selected' : '' }}>Waris</option>
                                                            <option value="pentadbir_harta"{{ $selectedStatus === 'pentadbir_harta' ? ' selected' : '' }}>Pentadbir Harta</option>
                                                        </select>
                                                        @error('user_status')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                    ...
                                                    <div id="div_relationship" class="mb-5 mt-n2">
                                                        <label for="relationship" class="form-label">Hubungan Dengan Pemilik Vesel</label>
                                                        <select id="relationship" class="form-control" name="relationship" required>
                                                            ...
                                                            <option value="suami_isteri"{{ strcasecmp(old('relationship'), 'suami_isteri') === 0 ? ' selected' : '' }}>Suami / Isteri</option>
                                                            <option value="datuk_nenek"{{ strcasecmp(old('relationship'), 'datuk_nenek') === 0 ? ' selected' : '' }}>Datuk / Nenek</option>
                                                            <option value="bapa_saudara"{{ strcasecmp(old('relationship'), 'bapa_saudara') === 0 ? ' selected' : '' }}>Bapa Saudara</option>
                                                            <option value="anak_saudara"{{ strcasecmp(old('relationship'), 'anak_saudara') === 0 ? ' selected' : '' }}>Anak Saudara</option>
                                                        </select>
                                                        @error('relationship')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-5">
                                                        ...
                                                        <div class="form-text mb-2" style="margin-top: 0px; color:red;">
                                                            Sila pilih satu atau lebih vesel yang terlibat.
                                                        </div>
