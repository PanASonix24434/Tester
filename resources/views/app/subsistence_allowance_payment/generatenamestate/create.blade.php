        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <!-- Page header -->
                    <div class="mb-5">
                        <h3 class="mb-0">Senarai Nama ESHND Negeri</h3>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card mb-4">
                            ...
                            <h6><i class="fas fa-list"></i> Janaan Senarai Nama ESHND Negeri:</h6>
                            ...
                            <div class="card-body">
                                <form action="{{ route('subsistenceallowancepayment.generatenamestate.store') }}" method="POST">
                                    @csrf
