        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <!-- Page header -->
                    <div class="mb-8">
                        <h3 class="mb-0">Semakan Negeri</h3>
                    </div>
                </div>
                <div class="col-md-4">
                </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-header bg-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" enctype="multipart/form-data" action="{{ route('subsistenceallowancepayment.generatenamestate.storeListName') }}">
                                    @csrf
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                <a href="{{ route('subsistenceallowancepayment.generatenamestate.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                                <!-- <a href="#" class="btn btn-success btn-sm"> <i class="fas fa-arrow-right"></i> {{ __('app.submit') }}</a> -->
                                                <button type="submit" class="btn btn-primary btn-sm"  onclick="return confirm($('<span>Sokong Senarai?</span>').text())">
