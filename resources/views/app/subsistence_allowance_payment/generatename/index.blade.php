            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h6><i class="fas fa-list"></i> Janaan Senarai Nama Daerah:</h6>
                                <form method="get" action="{{ route('subsistenceallowancepayment.generatenamedistrict.create',$entity_id) }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-6">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($data->status == 'Dijana')
                                                            ...
                                                            <a class="btn btn-sm btn-warning" href="{{ route('subsistenceallowancepayment.generatenamedistrict.edit', $data->id) }}">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            <form action="{{ route('subsistenceallowancepayment.generatenamedistrict.destroy', $data->id) }}" method="POST" style="display:inline;">
                                                                @csrf
                                                                @method('DELETE')
