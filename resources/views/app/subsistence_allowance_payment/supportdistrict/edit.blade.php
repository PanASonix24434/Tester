                                    ...
                                    <div class="container mt-4">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                ...
                                                                <!-- <a href="{{ route('subsistence-allowance.showformdetails', $data->user_id) }}" class="btn btn-sm btn-primary" target="_blank"><i class="fas fa-search"></i></a> -->
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-lg-center">
                                                Senarai Disemak untuk Sokongan
                                            </div>
                                        </div>
                                    </div>
                                   
                                    
                                    <form method="POST" enctype="multipart/form-data" action="{{ route('subsistenceallowancepayment.supportdistrict.storeListName') }}">
                                    @csrf
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                <a href="{{ route('subsistenceallowancepayment.supportdistrict.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
