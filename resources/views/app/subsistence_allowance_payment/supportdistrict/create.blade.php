        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <!-- Page header -->
                    <div class="mb-5">
                        <h3 class="mb-0">Senarai Nama ESH Aktif</h3>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card mb-4">
                            ...
                            <h6><i class="fas fa-list"></i> Janaan Senarai Nama ESH Aktif:</h6>
                            <form action="{{ route('subsistenceallowancepayment.generatenamedistrict.store') }}" method="POST">
                                @csrf
                                <input type="hidden" name="entity_id" value="{{$entity_id}}">
                                <button type="submit" class="btn btn-primary mt-2">Simpan Janaan Senarai Nama</button> 
                            </form>
