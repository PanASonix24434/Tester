                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-4">
                            <div class="card-header bg-primary">
								<h4 class="mb-0" style="color:white;">Kelulusan Negeri</h4>
                            </div>
                                    ...
                                    <div class="container mt-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-lg-center">
                                                Senarai Disemak untuk Kelulusan
                                            </div>
                                        </div>
                                    </div>
                                   
                                    
                                    <form method="POST" enctype="multipart/form-data" action="{{ route('subsistenceallowancepayment.approvalstate.storeListName') }}">
                                    @csrf
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                <a href="{{ route('subsistenceallowancepayment.approvalstate.index') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
