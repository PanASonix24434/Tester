                            ...
                            <div class="card-header bg-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs mt-4">
                                        <li class="nav-item"><a class="nav-link active" href="#">Butiran Pemohon</a></li>
                                    ...
                                    <div class="card p-4 mt-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control"  id="selStateBaru" name="state_bank_id" autocomplete="off" disabled>
                                                <option value="">-- Sila Pilih --</option>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                    <a href="{{ route('subsistence-allowance.formlist') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                                    ...
                                                    <a href="{{ route('subsistence-allowance.kdpdetailswork', $subApplication->id) }}" class="btn btn-dark btn-sm">{{ __('app.next') }} <i class="fas fa-arrow-right"></i> </a>
