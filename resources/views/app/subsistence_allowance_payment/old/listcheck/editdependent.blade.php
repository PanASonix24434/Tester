...
@section('content')
    ...
    <div id="app-content">
        ...
        <div class="container-fluid">
            ...
            <div>
                <form method="POST" enctype="multipart/form-data" action="{{ route('application.storekru') }}">
                    @csrf
                <!-- row -->
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-header bg-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs mt-4">
                                        ...
                                        <li class="nav-item"><a class="nav-link active" href="#">Butiran Tanggungan</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex">
                                            <input type="text" class="form-control" name="fishing_income" id="fishing_income" value="{{$subApplication->tot_child}}" readonly>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex">
                                            <input type="text" class="form-control" name="other_income" id="other_income" value="{{$subApplication->tot_otherchild}}" readonly>
                                            <span class="input-group-text">Orang</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex">
                                            <input type="text" class="form-control fw-bold" name="total_income" id="total_income" value="{{$subApplication->tot_allchild}}" readonly>
                                            <span class="input-group-text">Orang</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                    <a href="{{ route('subsistence-allowance.kdpdetailswork',  $subApplication->id) }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                                    ...
                                                    <a href="{{ route('subsistence-allowance.kdpdetailseducation',  $subApplication->id) }}" class="btn btn-dark btn-sm">{{ __('app.next') }} <i class="fas fa-arrow-right"></i> </a>
