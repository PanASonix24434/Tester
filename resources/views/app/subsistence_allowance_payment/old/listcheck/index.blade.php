                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card mb-4">
                            ...
                            <form method="GET" id="search-form" action="{{ route('subsistence-allowance.formlist') }}">
                                <div class="row">
                                    ...
                                    <table class="table text-nowrap mb-0 table-centered table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($subApplication as $a)
                                                    <tr>
                                                    <td>    
                                                        <a href="{{ route('subsistence-allowance.kdpdetails',  $a->id ) }}" class="btn btn-primary btn-sm audit-view" ><i class="fa fa-edit"></i></a>
                                                    </td>
                                                        <td>{{ $a->created_at }}</td>
