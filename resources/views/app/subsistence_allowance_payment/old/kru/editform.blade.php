...
@section('content')
    ...
    <div id="app-content">
        ...
        <div class="container-fluid">
            ...
            <br />
            <div>
                <form method="POST" enctype="multipart/form-data" action="{{ route('subsistence-allowance.updateform') }}">
                    @csrf
                <!-- row -->
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="AppNoAkaun" name="no_account" value="{{$subApplication->no_account ?? ''}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                ...
                                                <a href="{{ route('subsistence-allowance.formwork' ,  $subApplication->id) }}" class="btn btn-dark btn-sm"> <i class="fas fa-arrow-right"></i> {{ __('app.next') }}</a>
