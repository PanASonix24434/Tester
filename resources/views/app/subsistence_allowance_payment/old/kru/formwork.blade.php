...
@section('content')
    ...
    <div id="app-content">
        ...
        <div class="container-fluid">
            ...
            <br />
            <div>
                <form method="POST" enctype="multipart/form-data" action="{{ route('subsistence-allowance.storeWork') }}">
                    @csrf
                <!-- row -->
                <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="col-form-label">13. Status Nelayan :</label>
                                                <input type="text" class="form-control" id="StatusNelayan" value="Auto" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="col-form-label">14. Bilangan Hari Menangkap Ikan sebulan:</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex">
                                            ...
                                            <input type="number" class="form-control" name="fishing_income" id="fishing_income" value="{{ $subApplication->tot_incomefish ?? '0' }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex">
                                            <span class="input-group-text">RM</span>
                                            <input type="number" class="form-control" name="other_income" id="other_income" value="{{ $subApplication->tot_incomeother ?? '0' }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                <a href="{{ route('subsistence-allowance.editformdetails',  $subApplication->id) }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                                ...
                                                <!-- <a href="{{ route('subsistence-allowance.formdependent',  $subApplication->id) }}" class="btn btn-dark btn-sm"> <i class="fas fa-arrow-right"></i> {{ __('app.next') }}</a> -->
