        ...
        <div class="container-fluid">
            ...
            <div>
                <div class="card">
                    ...
                    </div> <form id="submitPermohonan" method="POST" enctype="multipart/form-data" action="{{ route('lesenTahunan.permohonan-02.store') }}">
                        @csrf
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-xl modal-fullscreen-md-down">
                                                <div class="modal-content p-3">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <img src="{{ route('lesenTahunan.permohonan-02.viewDocument', $requiredDoc->id) }}" class="img-fluid rounded" style="max-height: 85vh;">
                                                        @elseif($extension === 'pdf')
                                                        <iframe src="{{ route('lesenTahunan.permohonan-02.viewDocument', $requiredDoc->id) }}" width="100%" height="700px" frameborder="0"></iframe>
                                                        @else
                                                        <a href="{{ route('lesenTahunan.permohonan-02.viewDocument', $requiredDoc->id) }}" target="_blank" class="btn btn-outline-primary">Buka Dokumen</a>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
