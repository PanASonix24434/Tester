                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center">
                                    ...
                                    <div class="d-flex justify-content-center gap-3">
                                        <a href="{{ route('pindahPangkalan.permohonan-03.create', ['jenis' => 'dalam']) }}"
                                            class="btn btn-primary col-md">
                                            Dalam Daerah
                                        </a>

                                        <a href="{{ route('pindahPangkalan.permohonan-03.create2', ['jenis' => 'antara']) }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-warning col-md"
                                                    onclick="window.location.href='{{ route('pindahPangkalan.permohonan-03.create', $application->id) }}'">
                                                    <i class="far fa-edit pr-1"></i>
                                                </button>
                                                @elseif (in_array($application->applicationStatus->code,
                                                $draftFeedback))
                                                <button class="btn btn-warning col-md"
                                                    onclick="window.location.href='{{ route('pindahPangkalan.permohonan-03.negativeFeedback', $application->id) }}'">
                                                ...
                                                <button class="btn btn-danger col-md"
                                                    onclick="window.location.href='{{ route('pindahPangkalan.permohonan-03.appealFeedback', $application->id) }}'">
