                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="content-tab3" role="tabpanel" aria-labelledby="tab3-link">
                                {{-- <form id="store_tab3" method="POST" enctype="multipart/form-data"
                                    ...
                                    @csrf --}}
                                <form method="POST" id="store_tab3"  enctype="multipart/form-data" action="{{ route('pindahPangkalan.permohonan-03.store_tab3') }}?jenisPindah=antara">
                            @csrf
                                    <section>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">Negeri <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control"
                                                    value="{{ $states[$selectedState] ?? '-' }}" readonly>
