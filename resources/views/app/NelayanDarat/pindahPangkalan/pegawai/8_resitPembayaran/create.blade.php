...
<div id="app-content">
                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/pindahPangkalan/resitBayaran-03">{{
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe src="{{ route('pindahPangkalan.resitBayaran-03.viewDocument', [
                                                                                                    'index' => $index,
                                                                                ...
                                                                                <div class="row g-3">
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        ...
                                                                                        <div class="border p-2 bg-light"
                                                                                            ...
                                                                                            <iframe
                                                                                                src="{{ route('pindahPangkalan.resitBayaran-03.viewInspectionDocument',['id' => $ins->id, 'field' => $field]) }}"
                                            ...
                                            <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                                ...
                                                {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <form method="POST"
                                                            action="{{ route('pindahPangkalan.resitBayaran-03.updateFault', ['application_id' => $application->id]) }}"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body"
                                                                                    style="height: 80vh;">
                                                                                    <iframe
                                                                                        src="{{ route('pindahPangkalan.resitBayaran-03.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                        style="width: 100%; height: 100%;"
 ...
 @forelse ($declarations as $declaration)
                          		...
                          		<hr>
                                    ...
                                    @endforelse
                                            ...
                                            <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="storePermohonan" action="{{ route('pindahPangkalan.resitBayaran-03.store',
                                                    ...
                                                    <div class="mb-4">
                                                        <label for="receipt_file" class="form-label">Muat Naik
                                                            Resit</label>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <!-- File Input -->
                                                            <input type="file" class="form-control" name="receipt_file"
                                                                id="receipt_file" accept=".jpg,.jpeg,.png,.pdf">
                                                        ...
                                                        <small class="form-text text-muted">
                                                            Muat naik fail dalam format JPG, PNG, atau PDF (maksimum
                                                            2MB).
                                                        </small>
        ...
        <div class="text-success small">
            Fail telah dimuat naik: <strong>{{ basename($receipt->uploaded_file_path) }}</strong>
        </div>
...
@endif
                                                        ...
                                                        <div class="modal fade" id="receiptPreviewModal" tabindex="-1"
                                                            aria-labelledby="receiptPreviewLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="receiptPreviewLabel">
                                                                            Paparan Fail Resit
                                                                        </h5>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                    ...
                                                                    <div class="modal-body" style="height: 80vh;">
                                                                        <iframe
                                                                            src="{{ route('pindahPangkalan.resitBayaran-03.viewReceipt', ['receipt_id' => $receipt->id]) }}"
                                                                            style="width: 100%; height: 100%;"
                                                                            frameborder="0"></iframe>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <table class="table" id="receiptItemTable">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <button type="button"
                                                                        class="btn btn-danger btn-sm remove-item-btn d-none">
                                                                        <i class="fa fa-trash"></i>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                        ...
                                        <form method="POST" id="submitPermohonan" onsubmit="sessionStorage.removeItem('hasSaved')"
                                            action="{{ route('pindahPangkalan.resitBayaran-03.submit', $application->id) }}"
    ...
    const switchTab = (direction) => {
        ...
        document.getElementById('skipTabBtn').style.display = isLastTab ? 'inline-block' : 'none';
    };
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        document.getElementById('skipTabBtn').style.display = 'none';

        // Persist save flag in sessionStorage
        document.getElementById("saveBtn").addEventListener("click", () => {
            sessionStorage.setItem("hasSaved", "true");
        });

        // Prevent submission unless saved
        document.getElementById("submitBtn").addEventListener("click", (e) => {
            const saved = sessionStorage.getItem("hasSaved") === "true";
            if (!saved) {
                e.preventDefault();
                alert("Sila klik butang 'Simpan' terlebih dahulu sebelum menghantar.");
            }
        });
    });
</script>
