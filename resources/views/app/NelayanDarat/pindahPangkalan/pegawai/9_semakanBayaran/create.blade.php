                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/pindahPangkalan/semakanBayaran-03">{{
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe src="{{ route('pindahPangkalan.semakanBayaran-03.viewDocument', [
                                                                                                    'index' => $index,
                                                                                ...
                                                                                <div class="row g-3">
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        ...
                                                                                        <div class="border p-2 bg-light"
                                                                                            ...
                                                                                            <iframe
                                                                                                src="{{ route('pindahPangkalan.semakanBayaran-03.viewInspectionDocument',['id' => $ins->id, 'field' => $field]) }}"
                                            ...
                                            <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                                ...
                                                {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <form method="POST"
                                                            action="{{ route('pindahPangkalan.semakanBayaran-03.updateFault', ['application_id' => $application->id]) }}"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body"
                                                                                    style="height: 80vh;">
                                                                                    <iframe
                                                                                        src="{{ route('pindahPangkalan.semakanBayaran-03.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                        style="width: 100%; height: 100%;"
                                    ...
                                    @endforelse
                                            ...
                                            <div class="tab-pane fade  " id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="submitPermohonan"
                                                    action="{{ route('pindahPangkalan.semakanBayaran-03.store', $application->id) }}"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="modal-content p-3">
                                                                    ...
                                                                    <div class="modal-body p-0" style="height: 80vh;">
                                                                        <iframe
                                                                            src="{{ route('pindahPangkalan.semakanBayaran-03.viewReceipt', ['receipt_id' => $receipt->id]) }}"
                                                                            style="width: 100%; height: 100%;"
                                                                            frameborder="0"></iframe>
                                                                    </div>
                                                                </div>
