                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button class="btn btn-warning col-md" onclick="window.location.href='{{ route('tukarEnjin.laporanLpi-05.create', $application->id) }}'">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    @else
                                                    @if ($application->owns_transportation == 0)
                                                    <button class="btn btn-success col-md" onclick="window.location.href='{{ route('tukarEnjin.laporanLpi-05.create', $application->id) }}'">
