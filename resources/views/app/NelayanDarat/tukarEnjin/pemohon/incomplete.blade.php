        ...
        <div class="container-fluid">
            ...
            <div>
                <div class="card">
                    ...
                    <form id="submitPermohonan" method="POST" enctype="multipart/form-data" action="{{ route('tukarEnjin.permohonan-05.storeAppeal') }}">
                        @csrf
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{ old('phone_number', $userDetail->phone_number ?? '') }}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="identity_card_number" name="identity_card_number" value="{{ old('identity_card_number', $userDetail->identity_card_number ?? '') }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="postcode" name="postcode" value="{{ old('postcode', $userDetail->postcode ?? '') }}" readonly>
                                            </div>
                                            <div class="col-md-4 mb-3">
