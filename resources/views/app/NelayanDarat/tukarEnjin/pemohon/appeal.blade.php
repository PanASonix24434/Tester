        ...
        <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex   justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item">
                                <a href="http://127.0.0.1:8000/tukarEnjin/permohonan-05">{{
            ...
            <div>
                <div class="card">
                    ...
                    </div> <form id="submitPermohonan" method="POST" enctype="multipart/form-data" action="{{ route('tukarEnjin.permohonan-05.store') }}">
                        @csrf
                ...
                <div class="card card-primary card-tabs">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="tab-content " id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="content-tab1" role="tabpanel" aria-labelledby="tab1-link">
                                <form id="store_tab1" method="POST" action="{{ route('tukarEnjin.permohonan-05.store_tab1') }}">
                                    @csrf
                            ...
                            <div class="tab-pane fade" id="content-tab2" role="tabpanel" aria-labelledby="tab1-link">
                                <form id="store_tab2" method="POST" action="{{ route('tukarEnjin.permohonan-05.store_tab2') }}">
                                    @csrf
                            ...
                            <div class="tab-pane fade" id="content-tab3" role="tabpanel" aria-labelledby="tab3-link">
                                <form id="store_tab3" method="POST" enctype="multipart/form-data" action="{{ route('tukarEnjin.permohonan-05.store_tab3') }}">
                                    @csrf
                            ...
                            <div class="tab-pane fade" id="content-tab4" role="tabpanel" aria-labelledby="tab4-link">
                                <form id="store_tab4" method="POST" enctype="multipart/form-data" action="{{ route('tukarEnjin.permohonan-05.store_tab4') }}">
                                    @csrf
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-xl">
                                    <div class="modal-content p-3">
                                        ...
                                        <div class="modal-body text-center">
                                            <img src="{{ route('tukarEnjin.permohonan-05.viewEquipmentPhoto', $equipmentSet->id) }}" alt="Gambar Peralatan" class="img-fluid rounded" style="max-height: 80vh;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="content-tab5" role="tabpanel" aria-labelledby="tab5-link">
                            <form id="store_tab5" method="POST" enctype="multipart/form-data" action="{{ route('tukarEnjin.permohonan-05.store_tab5') }}">
                                @csrf
                    ...
                    <div class="tab-pane fade" id="content-tab6" role="tabpanel" aria-labelledby="tab6-link">
                        <form method="POST" id="store_tab6" action="{{ route('tukarEnjin.permohonan-05.store_tab6') }}" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-xl modal-fullscreen-md-down">
                                                <div class="modal-content p-3">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <img src="{{ route('tukarEnjin.permohonan-05.viewDocument', $requiredDoc->id) }}" class="img-fluid rounded" style="max-height: 85vh;">
                                                        @elseif($extension === 'pdf')
                                                        <iframe src="{{ route('tukarEnjin.permohonan-05.viewDocument', $requiredDoc->id) }}" width="100%" height="700px" frameborder="0"></iframe>
                                                        @else
                                                        <a href="{{ route('tukarEnjin.permohonan-05.viewDocument', $requiredDoc->id) }}" target="_blank" class="btn btn-outline-primary">Buka Dokumen</a>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-xl">
                                            <div class="modal-content p-3">
                                                ...
                                                <div class="modal-body text-center">
                                                    ...
                                                    <img src="{{ route('tukarEnjin.permohonan-05.viewDocument', $doc->id) }}" class="img-fluid rounded" style="max-height: 85vh;">
                                                    @elseif(strtolower($extension) === 'pdf')
                                                    <iframe src="{{ route('tukarEnjin.permohonan-05.viewDocument', $doc->id) }}" width="100%" height="700px" frameborder="0"></iframe>
                                                    @else
                                                    <a href="{{ route('tukarEnjin.permohonan-05.viewDocument', $doc->id) }}" target="_blank" class="btn btn-outline-primary">Buka Dokumen</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card-footer pr-0">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <form id="submitPermohonan" method="POST" enctype="multipart/form-data" action="{{ route('tukarEnjin.permohonan-05.store') }}">
                                @csrf
                            </form>
