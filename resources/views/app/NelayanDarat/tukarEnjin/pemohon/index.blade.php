        ...
        <div class="container-fluid">
            <div class="row">
                <div class="d-flex justify-content-between align-items-center mb-5">
                    ...
                    <button class="btn btn-success col-md-1" onclick="window.location.href='{{ route('tukarEnjin.permohonan-05.create') }}'">MOHON
                    </button>
                </div>
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $application->created_at->format('d/m/Y') }}</td> <!-- Updated Date Format -->
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-warning col-md" onclick="window.location.href='{{ route('tukarEnjin.permohonan-05.create', $application->id) }}'">
                                                    <i class="far fa-edit pr-1"></i>
                                                </button>
                                                @elseif (in_array($application->applicationStatus->code, $draftFeedback))
                                                <button class="btn btn-warning col-md" onclick="window.location.href='{{ route('tukarEnjin.permohonan-05.negativeFeedback', $application->id) }}'">
                                                ...
                                                <button class="btn btn-danger col-md" onclick="window.location.href='{{ route('tukarEnjin.permohonan-05.appealFeedback', $application->id) }}'">
