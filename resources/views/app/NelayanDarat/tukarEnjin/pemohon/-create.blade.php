                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="content-tab1" role="tabpanel"
                                ...
                                <form id="store_tab1" method="POST"
                                    action="{{ route('tukarEnjin.permohonan-05.store_tab1') }}">
                                    @csrf --}}
                            ...
                            <div class="tab-pane fade" id="content-tab2" role="tabpanel" aria-labelledby="tab1-link">
                                {{-- <form id="store_tab2" method="POST"
                                    action="{{ route('tukarEnjin.permohonan-05.store_tab2') }}">
                                    @csrf --}}
                            ...
                            <div class="tab-pane fade" id="content-tab3" role="tabpanel" aria-labelledby="tab3-link">
                                {{-- <form id="store_tab3" method="POST" enctype="multipart/form-data"
                                    action="{{ route('tukarEnjin.permohonan-05.store_tab3') }}">
                                    @csrf --}}

                                    <div class="mb-3">
                                        <h4 class="fw-bold">Maklumat Jeti / Pangkalan</h4>
                                        <small class="text-muted m-0">Lokasi atau kawasan jeti tempat
                                            beroperasi</small>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="content-tab4" role="tabpanel" aria-labelledby="tab4-link">
                                {{-- <form id="store_tab4" method="POST" enctype="multipart/form-data"
                                    action="{{ route('tukarEnjin.permohonan-05.store_tab4') }}">
                                    @csrf --}}

                                    <div class="mb-3">
                                        <h4 class="fw-bold mb-0">Peralatan Semasa</h4>
                                        <small class="text-muted">Maklumat peralatan menangkap ikan yang
                                            digunakan</small>
                                    </div>
                                                        ...
                                                        <div class="modal-dialog modal-xl modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body" style="height: 80vh;">
                                                                    <iframe
                                                                        src="{{ route('tukarEnjin.permohonan-05.viewEquipmentFile', ['equipment_id' => $equipment->id]) }}"
                            ...
                            <div class="tab-pane fade" id="content-tab5" role="tabpanel" aria-labelledby="tab5-link">
                                <form id="store_tab5" method="POST" enctype="multipart/form-data"
                                    action="{{ route('tukarEnjin.permohonan-05.store_tab5') }}">
                                    @csrf
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div id="engine_section">
                                            <div class="mb-3">
                                                ...
                                                <small class="text-muted">Maklumat enjin yang telah dilesenkan</small>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md mb-3">
                                                    <label for="engine_model" class="form-label">Model Enjin <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $vesselInfoOff->engine->model ?? '-' }}" readonly>
                                                </div>
                                                ...
                                                <div class="col-md mb-3">
                                                    <label for="engine_power" class="form-label">Kuasa Kuda (KK) <span
                                                            class="text-danger">*</span></label>
                                                    <input type="number" class="form-control"
                                                        value="{{ $vesselInfoOff->engine->horsepower ?? '-' }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            </from>
                                        ...
                                        <div class="mt-4 p-3 border rounded bg-light">
                                            <h4 class="fw-bold">Kemaskini Maklumat Enjin</h4>
                                            <small class="text-muted">Sila masukkan maklumat berkaitan enjin</small>

                                            <div class="row mt-3">
                                                <div class="col-md mb-3">
                                                    <label for="engine_model" class="form-label">Model Enjin Baharu
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="engine_model" id="engine_model"
                                                        class="form-control"
                                                        value="{{ old('engine_model', $vesselInfo['engine_model'] ?? '') }}"
                                                        required>
                                                </div>

                                                <div class="col-md mb-3">
                                                    <label for="engine_power" class="form-label">Kuasa Kuda Baharu (KK)
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="engine_power" id="engine_power"
                                                        class="form-control"
                                                        value="{{ old('horsepower', $vesselInfo['horsepower'] ?? '') }}"
                                                        required>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="content-tab6" role="tabpanel" aria-labelledby="tab6-link">
                                <form method="POST" id="store_tab6"
                                    action="{{ route('tukarEnjin.permohonan-05.store_tab6') }}"
                                    enctype="multipart/form-data">
                                    @csrf

                                    @php
                                    $requiredDocs = collect($documents)->where('type', 'required')->values();
                                    @endphp

                                    <div class="mb-4">
                                        <h4 class="fw-bold mb-0">Muat Naik Dokumen Permohonan Bertandatangan</h4>
                                        <small class="text-muted">
                                            Sila muat naik dua dokumen berikut: Resit pembayaran dan gambar enjin
                                            terkini.
                                        </small>

                                        <div class="alert alert-warning mt-3">
                                            <strong>Perhatian:</strong> Kedua-dua dokumen ini wajib dimuat naik dan
                                            perlu
                                            jelas serta sah.
                                        </div>

                                        <!-- Resit Pembayaran Row -->
                                        <div class="row mb-3">
                                            <!-- Left Column: Input + Info + Upload Notice -->
                                            <div class="col-md-11">
                                                <label for="payment_receipt" class="form-label">
                                                    Resit Pembayaran <span class="text-danger">*</span>
                                                </label>

                                                <div class="d-flex align-items-end">
                                                    <!-- File input -->
                                                    <input type="file" name="payment_receipt" id="payment_receipt"
                                                        class="form-control me-2" accept=".jpg,.jpeg,.png,.pdf"
                                                        required>

                                                    <!-- View Button -->
                                                    @if (!empty($requiredDocs[0]['file_path']))
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#requiredDocumentModal0" title="Lihat Fail">
                                                ...
                                                <small class="text-muted d-block mt-1">
                                                    Format dibenarkan: JPG, JPEG, PNG, PDF sahaja. Saiz maksima: 2MB.
                                                </small>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-11">
                                                <label for="engine_picture" class="form-label">
                                                    Gambar Enjin <span class="text-danger">*</span>
                                                </label>

                                                <div class="d-flex align-items-end">
                                                    <!-- File Input -->
                                                    <input type="file" name="engine_picture" id="engine_picture"
                                                        class="form-control me-2" accept=".jpg,.jpeg,.png" required>

                                                    <!-- View Button -->
                                                    @if (!empty($requiredDocs[1]['file_path']))
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#requiredDocumentModal1" title="Lihat Fail">
                                                        <i class="fa fa-search p-1"></i>
                                                    </button>
                                                    @endif
                                                </div>
                                                ...
                                                <small class="form-text text-muted mt-1">
                                                    Format dibenarkan: JPG, JPEG, PNG sahaja. Saiz maksima: 2MB.
                                                </small>
                                        ...
                                        <div class="modal fade" id="requiredDocumentModal{{ $index }}" tabindex="-1"
                                            aria-labelledby="requiredDocumentModalLabel{{ $index }}" aria-hidden="true">
                                            <div class="modal-dialog modal-xl modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="requiredDocumentModalLabel{{ $index }}">
                                                            Dokumen: {{ $doc['title'] ?? 'Dokumen' }}
                                                        </h5>
                                                    ...
                                                    <div class="modal-body" style="height: 80vh;">
                                                        <iframe
                                                            src="{{ route('tukarEnjin.permohonan-05.viewDocument', ['index' => $index]) }}"
                                                ...
                                                <div class="modal fade" id="documentModal{{ $index }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" style="height: 80vh;">
                                                                <iframe
                                                                    src="{{ route('tukarEnjin.permohonan-05.viewDocument', ['type' => 'additional', 'index' => $index]) }}"
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap">
                                ...
                                <div class="m-0 mb-2">
                                    {{-- <div id="printButtonContainer" style="display: none;">
                                        <a href="{{ route('tukarEnjin.permohonan-05.printApplication') }}"
                                ...
                                <div class="d-flex justify-content-end mb-2 flex-wrap gap-2">
                                    ...
                                    <form id="submitPermohonan" method="POST" enctype="multipart/form-data"
                                        action="{{ route('tukarEnjin.permohonan-05.store') }}">
                                        @csrf
                                    </form>
