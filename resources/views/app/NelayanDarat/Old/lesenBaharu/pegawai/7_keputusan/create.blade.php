...
<div id="app-content">
   ...
   href="{{ route('lesenBaharu.keputusan-01.viewEquipment', ['id' => $equipment->id]) }}"
   target="_blank">
         ...
         <td>{{ strtoupper($doc['title'] ?? 'Tidak Diketahui') }}</td>
            ...
            <td>
                @if (!empty($doc['file_path']))
                    <a class="btn btn-primary"
                        href="{{ route('lesenBaharu.keputusan-01.viewTempDocument', [
                            'index' => $index,
            ...
            <tr>
                ...
                <td>
                    @if (!empty($rekod->document_path))
                        <a class="btn btn-primary"
                            href="{{ route('lesenBaharu.keputusan-01.viewFaultRecord', ['id' => $rekod->id]) }}"
