...
<div id="app-content">
   ...
   href="{{ route('lesenBaharu.resitBayaran-01.viewEquipment', ['id' => $equipment->id]) }}"
   target="_blank">
         ...
         <td>{{ strtoupper($doc['title'] ?? 'Tidak Diketahui') }}</td>
            ...
            <td>
                @if (!empty($doc['file_path']))
                    <a class="btn btn-primary"
                        href="{{ route('lesenBaharu.resitBayaran-01.viewTempDocument', [
                            'index' => $index,
...
<table class="table table-borderless">
            ...
            <tr>
                ...
                <td>
                    @if (!empty($rekod->document_path))
                        <a class="btn btn-primary"
                            href="{{ route('lesenBaharu.resitBayaran-01.viewFaultRecord', ['id' => $rekod->id]) }}"
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        @if (!empty($receipt->uploaded_file_path))
            <button type="button" class="btn btn-primary"
                onclick="window.open('{{ route('lesenBaharu.resitBayaran-01.viewReceipt', ['receipt_id' => $receipt->id]) }}', 'receiptWindow{{ $receipt->id }}', 'width=1200,height=800,scrollbars=yes,resizable=yes')">
                <i class="fa fa-search"></i>
            </button>
        @endif
    </div>
