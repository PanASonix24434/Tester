        ...
        <div class="container-fluid">
            <div class="row">
                <div class="d-flex justify-content-between align-items-center mb-5">
                    ...
                    <!-- Trigger Modal -->
                    <button type="button" class="btn btn-success col-md-1" data-bs-toggle="modal"
                        data-bs-target="#pangkalanModal">
                        MOHON
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="pangkalanModal" tabindex="-1" aria-labelledby="pangkalanModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">

                                <div class="modal-header">
                                    <h5 class="modal-title" id="pangkalanModalLabel">Pilih Jenis Permohonan</h5>
                                ...
                                <div class="modal-body text-center">
                                    ...
                                    <div class="d-flex justify-content-center gap-3">
                                        <a href="{{ route('gantiKulit.permohonan-06.create', ['jenis' => 'lupus']) }}"
                                            class="btn btn-primary col-md">
                                            Lupus Vesel
                                        </a>

                                        <a href="{{ route('gantiKulit.permohonan-06.create2', ['jenis' => 'gantiKulit']) }}"
                                            class="btn btn-secondary col-md">
                                          Ganti Kulit
                                        </a>
                                    </div>
                                </div>
                                ...
                                <table class="table table-borderless">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th scope="col">Tarikh Permohonan</th><th scope="col">No. Kad Pengenalan</th>                                            <th scope="col">Jenis Permohonan</th>
...
<td>{{ $application->user->username }}</td>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-warning col-md"
                                                    onclick="window.location.href='{{ route('gantiKulit.permohonan-06.create', $application->id) }}'">
                                                    <i class="far fa-edit pr-1"></i>
                                                </button>
                                                @elseif (in_array($application->applicationStatus->code,
                                                $draftFeedback))
                                                <button class="btn btn-warning col-md"
                                                    onclick="window.location.href='{{ route('gantiKulit.permohonan-06.negativeFeedback', $application->id) }}'">
                                                ...
                                                <button class="btn btn-danger col-md"
                                                    onclick="window.location.href='{{ route('gantiKulit.permohonan-06.appealFeedback', $application->id) }}'">
