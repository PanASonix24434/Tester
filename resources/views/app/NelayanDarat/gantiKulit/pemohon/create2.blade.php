    ...
    <div class="app-content-area">
        <div class="container-fluid">
            ...
            <div>
                ...
                <div class="card card-primary card-tabs">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            @php
                            $oldVesselDoc = collect($documentsTemp)->firstWhere('title', 'Gambar Vesel Asal');
                            $newVesselDoc = collect($documentsTemp)->firstWhere('title', 'Gambar Vesel Baharu');
                            @endphp
                                ...
                                <form method="POST" id="store_tab6"
                                    ...
                                    <section>
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted d-block mb-3">Sila muat naik gambar vesel asal dan
                                                gambar vesel baharu.</small>
                                            <hr>
                                        </div>

                                        {{-- Gambar Vesel Asal --}}
                                        <div class="mb-4">
                                            <label for="vesselOld" class="form-label">Gambar Vesel Asal <span
                                                    class="text-danger">*</span></label>
                                            <div class="d-flex align-items-center gap-2">
                                                <div style="flex-grow: 1;">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="vesselOld"
                                                            name="vesselOld" accept=".jpg,.jpeg,.png,.pdf" required>
                                                        <label class="custom-file-label" for="vesselOld">
                                                            {{ isset($oldVesselDoc['file_path']) ?
                                                            basename($oldVesselDoc['file_path']) : 'Pilih Fail' }}
                                                        </label>
                                                    </div>
                                                    @error('vesselOld')
                                                ...
                                                @if (!empty($oldVesselDoc['file_path']))
                                                <a class="btn btn-primary"
                                                    href="{{ route('gantiKulit.permohonan-06.viewDocument', ['type' => 'required', 'index' => array_search($oldVesselDoc, $documentsTemp)]) }}"
                                                    target="_blank">
                                                    <i class="fa fa-search p-1"></i>
                                                </a>
                                                @endif
                                            </div>
                                            <small class="text-muted">Format dibenarkan: JPG, JPEG, PNG, PDF. Saiz
                                                maksimum: 2MB.</small>
                                        </div>

                                        {{-- Gambar Vesel Baharu --}}
                                        <div class="mb-4">
                                            <label for="vesselNew" class="form-label">Gambar Vesel Baharu <span
                                                    class="text-danger">*</span></label>
                                            <div class="d-flex align-items-center gap-2">
                                                <div style="flex-grow: 1;">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="vesselNew"
                                                            name="vesselNew" accept=".jpg,.jpeg,.png,.pdf" required>
                                                        <label class="custom-file-label" for="vesselNew">
                                                            {{ isset($newVesselDoc['file_path']) ?
                                                            basename($newVesselDoc['file_path']) : 'Pilih Fail' }}
                                                        </label>
                                                    </div>
                                                    @error('vesselNew')
                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                ...
                                                @if (!empty($newVesselDoc['file_path']))
                                                <a class="btn btn-primary"
                                                    href="{{ route('gantiKulit.permohonan-06.viewDocument', ['type' => 'required', 'index' => array_search($newVesselDoc, $documentsTemp)]) }}"
                                                    target="_blank">
                                                    <i class="fa fa-search p-1"></i>
                                                </a>
                                                @endif
                ...
                ['vesselOld', 'vesselNew'].forEach(function (id) {
