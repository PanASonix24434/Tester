...
<div id="app-content">
                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/gantiKulit/semakanDokumenLupus-06">{{
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" style="height: 80vh;">
                                                                            <iframe src="{{ route('gantiKulit.semakanDokumenLupus-06.viewDocument', [
                                                                                                    'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('gantiKulit.semakanDokumenLupus-06.viewInspectionDocument', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('gantiKulit.semakanDokumenLupus-06.updateFault', ['application_id' => $application->id]) }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe
                                                                                    src="{{ route('gantiKulit.semakanDokumenLupus-06.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                    style="width: 100%; height: 100%;"
    ...
    <h4 class="fw-bold mb-3">Maklumat Pelupusan Vesel</h4>
    ...
    @endif
                                        ...
                                        <!---->
                                          ...
                                          <div class="tab-pane fade" id="content-tab10" role="tabpanel" aria-labelledby="tab10-link">
                                            <form method="POST" id="submitsemakanDokumenLupus"
                                                action="{{ route('gantiKulit.semakanDokumenLupus-06.store', $application->id) }}">
                                                @csrf
                                        ...
                                        <script>
                                            document.addEventListener('DOMContentLoaded', function () {
                                                function toggleInspectionSection() {
                                                    const selected = $('input[name="review_flag"]:checked').val();
                                                    if (selected === '1') {
                                                ...
                                                // On change
                                                $('input[name="review_flag"]').on('change', toggleInspectionSection);
                                    ...
                                    <div class="card-footer">
                                        <div class="d-flex justify-content-end gap-3">
                                            ...
                                            <div class="d-flex gap-3">
                                                ...
                                                <!-- Hantar Button -->
                                                <button id="submitBtn" type="submit" form="submitsemakanDokumenLupus"
