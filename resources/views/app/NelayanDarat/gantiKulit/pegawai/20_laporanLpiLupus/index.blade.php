                                    ...
                                    <table class="table table-borderless">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th scope="col">Tarikh Permohonan</th><th scope="col">No. Kad Pengenalan</th>                                                <th scope="col">No. Kad Pengenalan</th>
...
<td>{{ $application->user->username }}</td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button class="btn btn-warning col-md" onclick="window.location.href='{{ route('gantiKulit.laporanLpiLupus-06.create', $application->id) }}'">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    @else
                                                    @if ($application->owns_transportation == 0)
                                                    <button class="btn btn-success col-md" onclick="window.location.href='{{ route('gantiKulit.laporanLpiLupus-06.create', $application->id) }}'">
