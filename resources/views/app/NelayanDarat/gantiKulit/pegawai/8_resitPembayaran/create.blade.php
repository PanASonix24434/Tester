                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/gantiKulit/resitBayaran-06">{{
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" style="height: 80vh;">
                                                                            <iframe src="{{ route('gantiKulit.resitBayaran-06.viewDocument', [
                                                                                                    'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('gantiKulit.resitBayaran-06.viewInspectionDocument', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    {{-- <form method="POST"
                                                        action="{{ route('gantiKulit.resitBayaran-06.updateFault', ['application_id' => $application->id]) }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe
                                                                                    src="{{ route('gantiKulit.resitBayaran-06.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                    style="width: 100%; height: 100%;"
        ...
        <table class="table table-borderless">
            ...
            @foreach ([
                ...
                @php
                    ...
                    $fileUrl = route('gantiKulit.resitBayaran-06.viewInspectionDisposal', [
                        'id' => $disposeInfo->id,
                        'field' => $field
                    ]);
    ...
    @endif
                                        ...
                                        <!---->
                                           ...
                                           <div class="tab-pane fade" id="content-tab10" role="tabpanel"
                                                ...
                                                <form method="POST" id="storePermohonan" action="{{ route('gantiKulit.resitBayaran-06.store',
        ...
        <div class="modal fade" id="receiptPreviewModal" tabindex="-1" aria-labelledby="receiptPreviewLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="height: 80vh;">
                        <iframe src="{{ route('gantiKulit.resitBayaran-06.viewReceipt', ['receipt_id' => $receipt->id]) }}"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      onsubmit="sessionStorage.removeItem('hasSaved'); sessionStorage.removeItem('currentTab'); return true;"
      action="{{ route('gantiKulit.resitBayaran-06.submit', $application->id) }}"
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // If session storage is set and valid, use it
        if (savedTab && !isNaN(savedTab) && savedTab >= 1 && savedTab <= totalTabs) {
            currentTab = parseInt(savedTab);
        } else {
            currentTab = 1; // fallback to first tab
        }
    ...
    const updateButtonVisibility = () => {
        ...
        document.getElementById('saveBtn').style.display = isLastTab ? 'inline-block' : 'none';
        document.getElementById('submitBtn').style.display = isLastTab ? 'inline-block' : 'none';
        document.getElementById('nextTabBtn').style.display = isLastTab ? 'none' : 'inline-block';
    ...
    const showTab = (tabNumber) => {
        ...
        document.getElementById(`tab${tabNumber}-link`)?.classList.add("active");
        document.getElementById(`content-tab${tabNumber}`)?.classList.add("show", "active");
    ...
    const switchTab = (direction) => {
        ...
        currentTab = newTab;
        sessionStorage.setItem("currentTab", currentTab); // Save to session storage
        showTab(currentTab);
    };
</script>
