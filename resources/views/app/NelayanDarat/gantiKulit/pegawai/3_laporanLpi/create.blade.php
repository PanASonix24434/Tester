                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="content-tab1" role="tabpanel"
                                                ...
                                                <form id="form-tab1"
                                                    action="{{ route('gantiKulit.laporanLpi-06.storeMaklumatVesel', $application->id) }}"
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="d-flex align-items-center gap-3">
                                                            ...
                                                            <a class="btn btn-primary"
                                                                href="{{ route('gantiKulit.laporanLpi-06.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'overall_image_path']) }}"
                                                                target="_blank">
        ...
        input?.addEventListener('change', function () {
            ...
            if (label) label.textContent = fileName;
                                            ...
                                            <div class="tab-pane fade" id="content-tab2" role="tabpanel"
                                                ...
                                                <form id="form-tab2"
                                                    action="{{ route('gantiKulit.laporanLpi-06.storeMaklumatEnjin', $application->id) }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="mb-4">
                                                            ...
                                                            <div class="d-flex align-items-center gap-3">
                                                                ...
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('gantiKulit.laporanLpi-06.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_image_path']) }}"
                                                                    target="_blank">
                                                                    <i class="fa fa-search"></i>
                                                                </a>
                                                                @endif
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <div class="d-flex align-items-center gap-3">
                                                                ...
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('gantiKulit.laporanLpi-06.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_number_image_path']) }}"
                                                                    target="_blank">
                                                                    <i class="fa fa-search"></i>
                                                                </a>
                                                                @endif
                                            ...
                                            <div class="tab-pane fade" id="content-tab3" role="tabpanel"
                                                ...
                                                <form id="form-tab3"
                                                    action="{{ route('gantiKulit.laporanLpi-06.storePeralatanKeselamatan', $application->id) }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="d-flex align-items-center gap-3">
                                                            ...
                                                            <a class="btn btn-primary"
                                                                href="{{ route('gantiKulit.laporanLpi-06.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'safety_jacket_image_path']) }}"
                                                                target="_blank">
                                                                <i class="fa fa-search"></i>
                                                            </a>
                                                            @endif
        ...
        input?.addEventListener('change', function () {
            ...
            if (label) label.textContent = fileName;
                                            ...
                                            <div class="tab-pane fade" id="content-tab4" role="tabpanel"
                                                ...
                                                <form id="form-tab4"
                                                    action="{{ route('gantiKulit.laporanLpi-06.storePeralatanMenangkapIkan', $application->id) }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
...
<section>
    ...
    <div class="col-md-auto text-center">
        ...
        <button type="button" class="btn btn-primary"
            onclick="window.open('{{ route('gantiKulit.laporanLpi-06.viewEquipmentFile', ['id' => $mainInspectionEquipment[0]->id, 'type' => 'UTAMA']) }}', '_blank')">
...
@if (!empty($item->file_path ?? null))
    <div class="col-md-auto text-center">
        <label class="form-label d-none d-md-block">&nbsp;</label>
        <button type="button" class="btn btn-primary"
            onclick="window.open('{{ route('gantiKulit.laporanLpi-06.viewEquipmentFile', ['id' => $item->id, 'type' => 'TAMBAHAN']) }}', '_blank')">
            <i class="fa fa-search p-1"></i>
        </button>
    </div>
@endif
                ...
                if (e.target.closest('.remove-item-btn')) {
                    e.target.closest('.row').remove();
                                        ...
                                        <div class="tab-pane fade" id="content-tab5" role="tabpanel"
                                            ...
                                            <form id="form-tab5"
                                                action="{{ route('gantiKulit.laporanLpi-06.storePengesahanPemeriksaan', $application->id) }}"
                                                method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <a class="btn btn-primary"
                                                            href="{{ route('gantiKulit.laporanLpi-06.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'attendance_form_path']) }}"
                                                            target="_blank">
                                                            <i class="fa fa-search"></i>
                                                        </a>
                                                        @endif
            ...
            if (label) label.textContent = fileName;
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <a class="btn btn-primary"
                                                            href="{{ route('gantiKulit.laporanLpi-06.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'vessel_image_path']) }}"
                                                            target="_blank">
                                                            <i class="fa fa-search"></i>
                                                        </a>
            ...
            if (label) label.textContent = fileName;
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <a class="btn btn-primary"
                                                            href="{{ route('gantiKulit.laporanLpi-06.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'inspector_owner_image_path']) }}"
                                                            target="_blank">
                                                            <i class="fa fa-search"></i>
                                                        </a>
                                                        @endif
                            ...
                            <div class="d-flex justify-content-end gap-3">
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <form id="form-submit-final" onsubmit="sessionStorage.removeItem('lastSavedTab')"
                                        action="{{ route('gantiKulit.laporanLpi-06.store', $application->id) }}"
                                        method="POST">
                                        @csrf
                                    </form>
