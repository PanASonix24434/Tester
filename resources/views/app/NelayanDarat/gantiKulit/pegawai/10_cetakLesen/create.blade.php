...
<div id="app-content">
                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/gantiKulit/cetakLesen-06">{{
                                        ...
                                        <ul class="nav nav-tabs" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link custom-nav-link" id="tab9-link"
                                                    aria-disabled="true">Maklumat Pelupusan </a>
                                            </li>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" style="height: 80vh;">
                                                                            <iframe src="{{ route('gantiKulit.cetakLesen-06.viewDocument', [
                                                                                                    'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('gantiKulit.cetakLesen-06.viewInspectionDocument', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    {{-- <form method="POST"
                                                        action="{{ route('gantiKulit.cetakLesen-06.updateFault', ['application_id' => $application->id]) }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe
                                                                                    src="{{ route('gantiKulit.cetakLesen-06.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                    style="width: 100%; height: 100%;"
    ...
    <table class="table table-borderless">
        <tbody>
            <tr>
                ...
                <td class="col-md-1 text-center">:</td>
                <td>
                    {{ $disposeTemp['main_disposal_action'] === 'lupus' ? 'Lupus' : 'Ganti Kulit' }}
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="col-md-1 text-center">:</td>
                <td>
                    {{ $disposeTemp['main_disposal_action'] === 'jual' ? 'Jual Vesel' : 'Lupus & Tamat Lesen' }}
                </td>
            </tr>

            @if($disposeTemp['main_disposal_action'] === 'jual')
            <tr>
                <td>Jenis Jualan</td>
                <td class="text-center">:</td>
                <td>
                    {{ $disposeTemp['disposal_type'] === 'dalam_industri' ? 'Dalam Industri' : 'Luar Industri' }}
                </td>
            </tr>
            <tr>
                <td>Nama Pemilik Baharu</td>
                <td class="text-center">:</td>
                <td>{{ $disposeTemp['new_owner_name'] ?? '-' }}</td>
            </tr>
            <tr>
                <td>No. Telefon Pemilik Baharu</td>
                <td class="text-center">:</td>
                <td>{{ $disposeTemp['new_owner_phone'] ?? '-' }}</td>
            </tr>
            <tr>
                <td>No. Kad Pengenalan Pemilik Baharu</td>
                <td class="text-center">:</td>
                <td>{{ $disposeTemp['new_owner_ic'] ?? '-' }}</td>
            </tr>
            @endif
        </tbody>
    </table>
    ...
    <section>
    <div class="mb-3">
        <h5>Maklumat Pemeriksaan Pelupusan</h5>
        <small>Bahagian ini menunjukkan butiran pelupusan vesel</small>
        <hr>
    </div>
    ...
    @if ($disposeInfo)
        <table class="table table-borderless">
            <tr>
                ...
                <td class="col-md-1">:</td>
                <td>{{ \Carbon\Carbon::parse($disposeInfo->disposal_time)->format('d/m/Y') }}</td>
            </tr>
            <tr>
                <td class="col-md-4">Lokasi Pelupusan</td>
                <td class="col-md-1">:</td>
                <td>{{ $disposeInfo->disposal_location }}</td>
            </tr>
            <tr>
                <td class="col-md-4">Kaedah Pelupusan</td>
                <td class="col-md-1">:</td>
                <td>{{ $disposeInfo->disposal_method }}</td>
            </tr>

            {{-- File preview buttons with modals --}}
            @foreach ([
                'before_disposal_image' => 'Gambar Sebelum Pelupusan',
                'after_disposal_image' => 'Gambar Selepas Pelupusan',
                'attendance_form_image' => 'Borang Kehadiran'
            ] as $field => $label)
                @php
                    $filePath = $disposeInfo->$field ?? null;
                    $modalId = 'modal_' . $field;
                    $fileUrl = route('gantiKulit.cetakLesen-06.viewInspectionDisposal', [
                        'id' => $disposeInfo->id,
                        'field' => $field
                    ]);
                    $isImage = $filePath && preg_match('/\.(jpg|jpeg|png)$/i', $filePath);
                        ...
                        <div class="modal-dialog modal-xl modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center" style="height: 80vh;">
                                    @if ($isImage)
                                        <img src="{{ $fileUrl }}" class="img-fluid h-100" alt="{{ $label }}">
                                    @elseif ($isPdf)
                                        <iframe src="{{ $fileUrl }}" style="width: 100%; height: 100%; border: none;"></iframe>
                                    @else
                                        <div class="alert alert-warning">Format fail tidak disokong untuk pratonton.</div>
                                    @endif
                                </div>
                            </div>
                        </div>
    ...
    @else
        <div class="alert alert-warning">Tiada maklumat pelupusan direkodkan.</div>
    @endif
</section>
                                        ...
                                        <!---->
                                            ...
                                            <div class="tab-pane fade" id="content-tab10" role="tabpanel"
                                                aria-labelledby="tab10-link">

                                                <form method="POST" id="submitPermohonan"
                                                    action="{{ route('gantiKulit.cetakLesen-06.store', $application->id) }}">
                                                    @csrf

                                                    <!-- Section Header -->
                                                    <div class="card-header mb-3 pl-0">
                                                        <h4 class="fw-bold mb-0">Cetak Lesen</h4>
                                                        <small class="text-muted">Masukkan nombor PIN untuk semakan dan
                                                            cetakan lesen pendaftaran.</small>
                                                    </div>

                                                    <!-- PIN Entry and Semak Button in one row -->

                                                    <div class="row mb-3 align-items-end">
                                                        <label for="noPin" class="form-label">No. PIN</label>
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" name="pin_number"
                                                                id="noPin" placeholder="Masukkan No. PIN" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <button class="btn btn-primary" type="button"
                                                                id="semakPinButton">Semak</button>
                                                        </div>
                                                        <small id="pinMessage" class="mt-2 d-block"></small>

                                                    </div>

                                                    <!-- Print Button -->
                                                    <div class="row mb-4 d-none" id="printButtonRow">
                                                        <div class="col-md-6">
                                                            <a target="_blank" class="btn btn-success w-100"
                                                                id="printButton">Cetak Lesen</a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="hiddenContent" class="d-none">
                                                        ...
                                                        <div class="alert alert-danger mb-4" role="alert">
                                                            <label class="form-label fw-bold"><i
                                                                    class="fas fa-exclamation-triangle"></i>&ensp;Perhatian</label>
                                                            <p class="mb-0">Pastikan cetakan lesen yang dikeluarkan
                                                                adalah betul sebelum memasukkan No. SSD baharu.</p>
                                                        </div>

                                                        <!-- No. SSD Input -->
                                                        <div class="mb-3 col-md-6">
                                                            <label for="noSSD" class="form-label">No. SSD</label>
                                                            <input type="text" class="form-control" name="no_ssd"
                                                                id="noSSD" placeholder="Contoh: SSD-001" required>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
...
<script>
    ...
    <script>
        document.getElementById("semakPinButton").addEventListener("click", function () {
    let pinNumber = document.getElementById("noPin").value;
    let pinMessage = document.getElementById("pinMessage");
    let printButtonRow = document.getElementById("printButtonRow");
    let hiddenContent = document.getElementById("hiddenContent");

    // Reset messages and hide elements
    pinMessage.textContent = "";
    pinMessage.classList.remove("text-success", "text-danger");
    printButtonRow.classList.add("d-none");
    hiddenContent.classList.add("d-none");

    fetch("{{ route('gantiKulit.cetakLesen-06.semakPin', $application->id) }}", {
        method: "POST",
        headers: {
        ...
        .then(data => {
            ...
            pinMessage.classList.add(data.success ? "text-success" : "text-danger");

            if (data.success) {
                printButtonRow.classList.remove("d-none");
                hiddenContent.classList.remove("d-none");
            }
        })
        .catch(error => {
            pinMessage.textContent = "Terjadi ralat! Sila cuba lagi.";
