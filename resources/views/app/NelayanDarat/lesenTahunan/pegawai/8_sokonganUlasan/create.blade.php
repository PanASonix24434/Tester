...
<div id="app-content">
                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/lesenTahunan/sokonganUlasanR-02">{{
   ...
   onclick="window.open('{{ route('lesenTahunan.sokonganUlasanR-02.viewEquipment', ['id' => $equipment->id]) }}', 'popupWindow', 'width=1200,height=800,scrollbars=yes'); return false;">
   <i class="fa fa-search"></i>
    ...
    onclick="window.open(
        '{{ route('lesenTahunan.sokonganUlasanR-02.viewTempDocument', [
            'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('lesenTahunan.sokonganUlasanR-02.viewInspection', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('lesenTahunan.sokonganUlasanR-02.createFaultRecord', ['application_id' => $application->id]) }}"
            ...
            <tr>
                ...
                <td>
                    @if (!empty($rekod->document_path))
                      <a href="#" class="btn btn-primary"
   onclick="window.open('{{ route('lesenTahunan.sokonganUlasanR-02.viewFaultRecord', ['id' => $rekod->id]) }}', 'faultRecordWindow', 'width=1200,height=800,scrollbars=yes'); return false;"
   title="Lihat dokumen">
    <i class="fa fa-search"></i>
</a>
        ...
        @endforelse
                                        ...
                                        <!---->
                                                ...
                                                <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                    ...
                                                    action="{{ route('lesenTahunan.sokonganUlasanR-02.store', $application->id) }}">
                                                    @csrf
                                                    <!-- Semakan -->
                                                    <div class="card-header mb-3 pl-0">
