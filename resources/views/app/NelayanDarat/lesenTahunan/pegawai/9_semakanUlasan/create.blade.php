        ...
        @endforelse
                                        ...
                                        <!---->
                                                ...
                                                <form method="POST" id="submitSemakan"
                                                    action="{{ route('lesenTahunan.semakanUlasanR-02.store', $application->id) }}">
                                                    @csrf
                                                ...
                                                <div class="d-flex gap-3">
                                                    ...
                                                    <!-- Hantar Button -->
                                                    <button id="submitBtn" type="submit" form="submitSemakan" class="btn btn-success" style="width:120px; display:none;">
                                                        Hantar
                                                    </button>
                                                </div>
                                            </div>
