                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex   justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/kadPendaftaran/cetakLesen-08">{{ \Illuminate\Support\Str::ucfirst(strtolower($applicationType->name)) }}</a></li>
            ...
            <div>
                <div class="row">
                    <div class="col-12">
                        ...
                        <form method="POST" id="submitPermohonan" action="{{ route('kadPendaftaran.cetakLesen-08.store', $application->id) }}" enctype="multipart/form-data">
                            @csrf
                                                ...
                                                <table class="table table-borderless">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="col-md-1">:</td>
                                                            <td><input type="text" class="form-control" value="{{ $application->applicationType->name_ms ?? 'Tidak Diketahui' }}" readonly></td>
                                                        </tr>
                                                        <tr>
                                                            <td>No. Rujukan</td>
                                                            <td>:</td>
                                                    ...
                                                    <table class="table table-borderless">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>Poskod</td>
                                                                <td>:</td>
                                                                <td>{{ $user->poskod ?? 'Tidak Diketahui' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Daerah</td>
                                                                <td>:</td>
                                                        ...
                                                        <table class="table table-borderless">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a class="btn btn-primary col-md" href="{{ route('kadPendaftaran.cetakLesen-08.viewFile', $file->id) }}">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @if ($vessel && $vessel->owns_vessel == 1)
                                                                            <a class="btn btn-primary col-md" href="{{ route('kadPendaftaran.cetakLesen-08.showLpi', $application->id) }}">
                                                                                <i class="fa fa-eye"></i> Lihat
                                                                            </a>
                                                                        @else
                                                                            <a class="btn btn-primary col-md" href="{{ route('kadPendaftaran.cetakLesen-08.showLpi2', $application->id) }}">
                                                                                <i class="fa fa-eye"></i> Lihat
                                                                            </a>
                                                                        @endif
                                                                    </td>
                                                            ...
                                                            <div class="timeline">
                                                                ...
                                                                <div>
                                                                    <div class="timeline-item border p-3">
                                                                        ...
                                                                        <!-- Header: name_ms -->
                                                                        <h5 class="mb-2 timeline-header">{{ $log->applicationStatus->name_ms ?? 'Tidak Diketahui' }}</h5>
                                                ...
                                                <div class="tab-pane fade" id="content-tab10" role="tabpanel" aria-labelledby="tab10-link">
                                                    ...
                                                    <div class="container d-flex justify-content-center align-items-center  ">
                                                        <div class="text-center">
                                                            ...
                                                            <div class="d-flex gap-3">
                                                                <input class="form-control" id="noPin" name="pin_number" type="text" placeholder="Masukkan No. Pin" required>
                                                                <button class="btn btn-primary" type="button" id="semakPinButton">Semakan</button>
                                                            </div>
                                                            <!-- Conditional Messages (Updated Dynamically) -->
                                                            <small id="pinMessage" class="mt-2 d-block"></small>

                                                            <a {{--
                                                                href="{{ route('kadPendaftaran.cetakLesen-08.printFishermanCard', $application->application_id) }}" --}} target="_blank" class="btn btn-success mt-3 d-none col-md" id="printButton">
                                                                Cetak Lesen
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="hiddenContent" class="d-none">
                                                        ...
                                                        <div class="alert alert-danger mb-3" role="alert">
                                                            <label for="alertReminder"><i class="fas fa-exclamation-triangle"></i>
                                                                &ensp;
                                                                Perhatian</label>
                                                            <p>Pastikan cetakan lesen yang dikeluarkan adalah cetakan yang
                                                                betul sebelum memasukkan
                                                                No. SSD Baharu.</p>
                                                        </div>

                                                        <!-- No. SSD Input -->
                                                        <div class="mb-3">
                                                            <label for="noSSD">No. SSD</label>
                                                            <input class="form-control col-md-3" id="noSSD" name="no_ssd" type="text" placeholder="Input No. SSD" required>
                                                        </div>
                                                    </div>
...
<script>
    document.getElementById("semakPinButton").addEventListener("click", function() {
        ...
        // Reset messages and hide Print button
        ...
        fetch("{{ route('kadPendaftaran.cetakLesen-08.semakPin', $application->id) }}", {
            ...
            .then(data => {
                ...
                // Show Print button only if the PIN is valid
                if (data.success) {
