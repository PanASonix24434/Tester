                                    ...
                                    <section>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a class="btn btn-primary  "
                                                    href="{{ route('lesenTahunan.permohonan-02.viewDocument', ['type' => 'required', 'index' => array_search($vesselDoc, $documentsData)]) }}"
                                                    target="_blank">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a class="btn btn-primary "
                                                    href="{{ route('lesenTahunan.permohonan-02.viewDocument', ['type' => 'required', 'index' => array_search($engineDoc, $documentsData)]) }}"
                                                    target="_blank">
                                                    <i class="fa fa-search p-1"></i>
                                                </a>
                                                @endif
