        ...
        <div class="container-fluid">
            <div class="row">
                <div class="d-flex justify-content-between align-items-center mb-5">
                    ...
                    <button class="btn btn-success col-md-1" onclick="window.location.href='{{ route('lesenTahunan.permohonan-02.create') }}'">MOHON
                    </button>
                </div>
    ...
    @endif
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-warning col-md"
                                                    onclick="window.location.href='{{ route('lesenTahunan.permohonan-02.negativeFeedback', $application->id) }}'">
                                                ...
                                                <button class="btn btn-danger col-md"
                                                    onclick="window.location.href='{{ route('lesenTahunan.permohonan-02.appealFeedback', parameters: $application->id) }}'">
