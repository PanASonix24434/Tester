        ...
        <div class="container-fluid">
            ...
            <div>
                <div class="card">
                    ...
                    </div> <form id="submitPermohonan" method="POST" enctype="multipart/form-data" action="{{ route('tukarPeralatan.permohonan-04.store') }}">
                        @csrf
                ...
                <div class="card card-primary card-tabs">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="tab-content " id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="content-tab1" role="tabpanel" aria-labelledby="tab1-link">
                                <form id="store_tab1" method="POST" action="{{ route('tukarPeralatan.permohonan-04.store_tab1') }}">
                                    @csrf
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Masukkan Nama Penuh" value="{{ old('name', $userDetail->name ?? '') }}" required>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="phone_number" class="form-label">Nombor Telefon</label>
                                                <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="Masukkan Nombor Telefon" value="{{ old('phone_number', $userDetail->phone_number ?? '') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="identity_card_number" class="form-label">Nombor Kad
                                                    Pengenalan</label>
                                                <input type="text" class="form-control" id="identity_card_number" name="identity_card_number" placeholder="Masukkan Nombor Kad Pengenalan" value="{{ old('identity_card_number', $userDetail->identity_card_number ?? '') }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md mb-3">
                                                ...
                                                <input type="text" class="form-control" id="address" name="address" placeholder="Masukkan Alamat Anda" value="{{ old('address', $userDetail->address ?? '') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="postcode" name="postcode" placeholder="Masukkan Poskod" value="{{ old('postcode', $userDetail->postcode ?? '') }}" required>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label for="district" class="form-label">Daerah</label>
                                                <input type="text" class="form-control" id="district" name="district" placeholder="Masukkan Daerah" value="{{ old('district', $userDetail->district ?? '') }}" required>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label for="state" class="form-label">Negeri</label>
                                                <input type="text" class="form-control" id="state" name="state" placeholder="Masukkan Negeri" value="{{ old('state', $userDetail->state ?? '') }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="tab-pane fade" id="content-tab2" role="tabpanel" aria-labelledby="tab1-link">
                                <form id="store_tab2" method="POST" action="{{ route('tukarPeralatan.permohonan-04.store_tab2') }}">
                                    @csrf
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6 mb-3">
                                                <label for="year_become_fisherman" class="form-label">Tahun Menjadi
                                                    Nelayan</label>
                                                <input type="number" class="form-control" id="year_become_fisherman" name="year_become_fisherman" value="{{ old('year_become_fisherman', $fishermanInfo->year_become_fisherman ?? '') }}" placeholder="Masukkan Tahun Menjadi Nelayan" required>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="becoming_fisherman_duration" class="form-label">Tempoh
                                                    Menjadi Nelayan (Tahun)</label>
                                                <input type="number" class="form-control" id="becoming_fisherman_duration" name="becoming_fisherman_duration" value="{{ old('becoming_fisherman_duration', $fishermanInfo->becoming_fisherman_duration ?? '') }}" placeholder="Masukkan Tempoh Menjadi Nelayan" required>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="working_days_fishing_per_month" class="form-label">Hari
                                                    Bekerja Menangkap Ikan Sebulan</label>
                                                <input type="number" class="form-control" id="working_days_fishing_per_month" name="working_days_fishing_per_month" value="{{ old('working_days_fishing_per_month', $fishermanInfo->working_days_fishing_per_month ?? '') }}" placeholder="Masukkan Hari Bekerja Menangkap Ikan Sebulan" required>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="estimated_income_yearly_fishing" class="form-label">Pendapatan Tahunan Dari Menangkap Ikan</label>
                                                <input type="number" class="form-control" id="estimated_income_yearly_fishing" name="estimated_income_yearly_fishing" value="{{ old('estimated_income_yearly_fishing', $fishermanInfo->estimated_income_yearly_fishing ?? '') }}" placeholder="Masukkan Pendapatan Tahunan Dari Menangkap Ikan" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6 mb-3">
                                                <label for="estimated_income_other_job" class="form-label">Pendapatan
                                                    Dari Pekerjaan Lain</label>
                                                <input type="number" class="form-control" id="estimated_income_other_job" name="estimated_income_other_job" value="{{ old('estimated_income_other_job', $fishermanInfo->estimated_income_other_job ?? '') }}" placeholder="Masukkan Pendapatan Dari Pekerjaan Lain" required>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="days_working_other_job_per_month" class="form-label">Hari
                                                    Bekerja Di Pekerjaan Lain Sebulan</label>
                                                <input type="number" class="form-control" id="days_working_other_job_per_month" name="days_working_other_job_per_month" value="{{ old('days_working_other_job_per_month', $fishermanInfo->days_working_other_job_per_month ?? '') }}" placeholder="Masukkan Hari Bekerja Di Pekerjaan Lain Sebulan" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select" id="receive_pension" name="receive_pension" required>
                                                    <option value="1" {{ old('receive_pension', $fishermanInfo->
                                                        receive_pension ?? '') == 1 ? 'selected' : '' }}>Ya</option>
                                                    <option value="0" {{ old('receive_pension', $fishermanInfo->
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="receive_financial_aid" class="form-label">Menerima Bantuan
                                                    Kewangan</label>
                                                <select class="form-select" id="receive_financial_aid" name="receive_financial_aid" required>
                                                    <option value="1" {{ old('receive_financial_aid', $fishermanInfo->
                                                        receive_financial_aid ?? '') == 1 ? 'selected' : '' }}>Ya
                                                    </option>
                                                    <option value="0" {{ old('receive_financial_aid', $fishermanInfo->
                                                        receive_financial_aid ?? '') == 0 ? 'selected' : '' }}>Tidak
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3" id="financial_aid_agency_div">
                                                <label for="financial_aid_agency" class="form-label">Agensi Memberi
                                                    Bantuan Kewangan</label>
                                                <input type="text" class="form-control" id="financial_aid_agency" name="financial_aid_agency" value="{{ old('financial_aid_agency', $fishermanInfo->financial_aid_agency ?? '') }}" placeholder="Masukkan Nama Agensi Penyedia Bantuan Kewangan">
                                            </div>

                                            <div class="col-md-6 mb-3">
                                                <label for="epf_contributor" class="form-label">Pencarum KWSP</label>
                                                <select class="form-select" id="epf_contributor" name="epf_contributor" required>
                                                    <option value="1" {{ old('epf_contributor', $fishermanInfo->
                                                        epf_contributor ?? '') == 1 ? 'selected' : '' }}>Ya</option>
                                                    <option value="0" {{ old('epf_contributor', $fishermanInfo->
                            ...
                            <div class="tab-pane fade" id="content-tab3" role="tabpanel" aria-labelledby="tab3-link">
                                <form id="store_tab3" method="POST" enctype="multipart/form-data" action="{{ route('tukarPeralatan.permohonan-04.store_tab3') }}">
                                    @csrf

                                    <div class="mb-4">
                                        <h4 class="fw-bold mb-0">Maklumat Jeti / Pangkalan</h4>
                                        <small class="text-muted">Sila isikan lokasi atau kawasan jeti tempat
                                            beroperasi</small>

                                        <div class="row mt-3">
                                            <div class="col-md-6 mb-3">
                                                <label for="state" class="form-label">Negeri</label>
                                                <input type="text" class="form-control" id="state" name="state" value="{{ old('state', $jettyInfo->state ?? '') }}" placeholder="Masukkan nama negeri" required>
                                            </div>

                                            <div class="col-md-6 mb-3">
                                                <label for="district" class="form-label">Daerah</label>
                                                <input type="text" class="form-control" id="district" name="district" value="{{ old('district', $jettyInfo->district ?? '') }}" placeholder="Masukkan nama daerah" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="jetty_name" name="jetty_name" value="{{ old('jetty_name', $jettyInfo->jetty_name ?? '') }}" placeholder="Masukkan nama jeti atau pangkalan" required>
                                            </div>

                                            <div class="col-md-6 mb-3">
                                                <label for="river" class="form-label">Sungai</label>
                                                <input type="text" class="form-control" id="river" name="river" value="{{ old('river', $jettyInfo->river ?? '') }}" placeholder="Masukkan nama sungai" required>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="tab-pane fade" id="content-tab4" role="tabpanel" aria-labelledby="tab4-link">
                                <form id="store_tab4" method="POST" enctype="multipart/form-data" action="{{ route('tukarPeralatan.permohonan-04.store_tab4') }}">
                                    @csrf
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 mb-3">
                                                <input type="text" name="main[name]" id="main_name" class="form-control" placeholder="Masukkan Peralatan" value="{{ old('main.name', $mainEquipment->name ?? '') }}" required>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <input type="number" name="main[quantity]" id="main_quantity" class="form-control" placeholder="Masukkan Kuantiti" min="1" value="{{ old('main.quantity', $mainEquipment->quantity ?? '') }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        @for($i = 0; $i < 5; $i++) @php $additional=$additionalEquipments[$i] ?? null; @endphp <div class="mb-3">
                                            <label class="form-label">Peralatan {{ $i + 1 }}</label>
                                            <div class="row">
                                                <div class="col-md-8 mb-3">
                                                    <input type="text" name="additional[{{ $i }}][name]" class="form-control" placeholder="Masukkan Peralatan" value="{{ old(" additional.$i.name", $additional->name ?? '')
                                                    }}">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <input type="number" name="additional[{{ $i }}][quantity]" class="form-control" placeholder="Masukkan Kuantiti" min="1" value="{{ old(" additional.$i.quantity", $additional->quantity
                                                    ?? '') }}">
                                                </div>
                                            </div>
                                    </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-xl">
                                    <div class="modal-content p-3">
                                        ...
                                        <div class="modal-body text-center">
                                            <img src="{{ route('tukarPeralatan.permohonan-04.viewEquipmentPhoto', $equipmentSet->id) }}" alt="Gambar Peralatan" class="img-fluid rounded" style="max-height: 80vh;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="content-tab5" role="tabpanel" aria-labelledby="tab5-link">
                            <form id="store_tab5" method="POST" enctype="multipart/form-data" action="{{ route('tukarPeralatan.permohonan-04.store_tab5') }}">
                                @csrf
                    ...
                    <div class="tab-pane fade" id="content-tab6" role="tabpanel" aria-labelledby="tab6-link">
                        <form method="POST" id="store_tab6" action="{{ route('tukarPeralatan.permohonan-04.store_tab6') }}" enctype="multipart/form-data">
                            @csrf

                            <div class="mb-4">
                                <h4 class="fw-bold mb-0">Dokumen Diperlukan</h4>
                                <small class="text-muted">Sila muat naik dokumen yang diperlukan</small>

                                <div class="row mt-3">
                                    <div class="col-md mb-3">
                                        <label for="required_doc_1" class="form-label">
                                            Surat Sokongan MyKP/Penghulu/Ketua Kampung/JKKK/JKOA <span class="text-danger">*</span>
                                        </label>
                                        <input type="file" name="required_documents[]" id="required_doc_1" class="form-control" accept=".pdf,.jpg,.jpeg,.png" required>
                                        <input type="hidden" name="required_titles[]" value="Surat Sokongan MyKP/Penghulu/Ketua Kempung/JKKK/JKOA">

                                        @if(isset($documents))
                                        @php
                                        $requiredDoc = $documents->firstWhere('title', 'Surat Sokongan MyKP/Penghulu/Ketua Kempung/JKKK/JKOA');
                                        @endphp
                                        ...
                                        <div class="d-flex align-items-center gap-2 mt-2">
                                            ...
                                            <div>
                                                <button type="button" class="btn  btn-primary" data-bs-toggle="modal" data-bs-target="#docModal_{{ $requiredDoc->id }}">
                                                    <i class="fa fa-search"></i>
                                                </button>
                                            </div>
                                        </div>

                                        <div class="modal fade" id="docModal_{{ $requiredDoc->id }}" tabindex="-1" aria-labelledby="docModalLabel_{{ $requiredDoc->id }}" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-xl modal-fullscreen-md-down">
                                                <div class="modal-content p-3">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="docModalLabel_{{ $requiredDoc->id }}">{{ $requiredDoc->title }}</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                                                    </div>
                                                    <div class="modal-body text-center">
                                                        @php
                                                        $extension = pathinfo($requiredDoc->file_path, PATHINFO_EXTENSION);
                                                        @endphp

                                                        @if(in_array($extension, ['jpg', 'jpeg', 'png']))
                                                        <img src="{{ route('tukarPeralatan.permohonan-04.viewDocument', $requiredDoc->id) }}" class="img-fluid rounded" style="max-height: 85vh;">
                                                        @elseif($extension === 'pdf')
                                                        <iframe src="{{ route('tukarPeralatan.permohonan-04.viewDocument', $requiredDoc->id) }}" width="100%" height="700px" frameborder="0"></iframe>
                                                        @else
                                                        <a href="{{ route('tukarPeralatan.permohonan-04.viewDocument', $requiredDoc->id) }}" target="_blank" class="btn btn-outline-primary">Buka Dokumen</a>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            @if(isset($documents))
                            @php
                            $additionalDocs = $documents->filter(fn($doc) => $doc->title !== 'Surat Sokongan MyKP/Penghulu/Ketua Kempung/JKKK/JKOA');
                            @endphp
                                ...
                                <div class="list-group mt-3">
                                    ...
                                    <div class="modal fade" id="docModal_{{ $doc->id }}" tabindex="-1" aria-labelledby="docModalLabel_{{ $doc->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-xl">
                                            <div class="modal-content p-3">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="docModalLabel_{{ $doc->id }}">{{ $doc->title }}</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                                                </div>
                                                <div class="modal-body text-center">
                                                    @php
                                                    ...
                                                    <img src="{{ route('tukarPeralatan.permohonan-04.viewDocument', $doc->id) }}" class="img-fluid rounded" style="max-height: 85vh;">
                                                    @elseif(strtolower($extension) === 'pdf')
                                                    <iframe src="{{ route('tukarPeralatan.permohonan-04.viewDocument', $doc->id) }}" width="100%" height="700px" frameborder="0"></iframe>
                                                    @else
                                                    <a href="{{ route('tukarPeralatan.permohonan-04.viewDocument', $doc->id) }}" target="_blank" class="btn btn-outline-primary">Buka Dokumen</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card-footer pr-0">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <form id="submitPermohonan" method="POST" enctype="multipart/form-data" action="{{ route('tukarPeralatan.permohonan-04.store') }}">
                                @csrf
                            </form>
