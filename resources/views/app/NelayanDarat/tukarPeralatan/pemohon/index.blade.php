        ...
        <div class="container-fluid">
            <div class="row">
                <div class="d-flex justify-content-between align-items-center mb-5">
                    ...
                    <button class="btn btn-success col-md-1" onclick="window.location.href='{{ route('tukarPeralatan.permohonan-04.create') }}'">MOHON
                    </button>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $application->created_at->format('d/m/Y') }}</td>
                                                <td>{{ $application->user->username }}</td>  <!-- Updated Date Format -->
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-warning col-md" onclick="window.location.href='{{ route('tukarPeralatan.permohonan-04.create', $application->id) }}'">
                                                    <i class="far fa-edit pr-1"></i>
                                                </button>
                                                @elseif (in_array($application->applicationStatus->code, $draftFeedback))
                                                <button class="btn btn-warning col-md" onclick="window.location.href='{{ route('tukarPeralatan.permohonan-04.negativeFeedback', $application->id) }}'">
                                                    <i class="fa fa-search pr-1"></i>
                                                </button>
                                                @elseif (in_array($application->applicationStatus->code, $appealFeedback))
                                                <!-- Uncomment this section if you want to show the appeal button -->
                                                <button class="btn btn-danger col-md" onclick="window.location.href='{{ route('tukarPeralatan.permohonan-04.appealFeedback', $application->id) }}'">
