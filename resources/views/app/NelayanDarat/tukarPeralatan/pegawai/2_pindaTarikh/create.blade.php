                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/tukarPeralatan/pindaLpi-04">{{
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" style="height: 80vh;">
                                                                            <iframe src="{{ route('tukarPeralatan.pindaLpi-04.viewDocument', [
                                                                                                    'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('tukarPeralatan.pindaLpi-04.viewInspectionDocument', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('tukarPeralatan.pindaLpi-04.updateFault', ['application_id' => $application->id]) }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe
                                                                                    src="{{ route('tukarPeralatan.pindaLpi-04.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                    style="width: 100%; height: 100%;"
                                            ...
                                            <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                ...
                                                <div class="p-4">
                                                    <form method="POST" id="submitPermohonan"
                                                        action="{{ route('tukarPeralatan.pindaLpi-04.store', $application->id) }}">
                                                        @csrf
                                                    ...
                                                    <div class="card-header mb-3 pl-0">
                                                        ...
                                                        <small class="text-muted">
                                                            Bahagian ini membolehkan pemohon mencadangkan tarikh baharu,
                                                            memilih daripada tarikh yang telah dicadangkan, dan
                                                            memberikan ulasan berkaitan tindakan lanjut.
                                                        </small>
                                                    </div>
                                                    ...
                                                    <div class="d-flex gap-4 mb-3">
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label" for="sahkan">Sahkan</label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="confirmation_flag" id="pinda" value="0">
                                                            <label class="form-check-label" for="pinda">Pinda</label>
                                                        </div>
                                                    </div>
