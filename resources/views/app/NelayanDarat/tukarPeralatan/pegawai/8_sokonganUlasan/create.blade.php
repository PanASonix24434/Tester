                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex   justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/tukarPeralatan/sokonganUlasanR-04">{{ \Illuminate\Support\Str::ucfirst(strtolower($applicationType->name)) }}</a></li>
            ...
            <div>
                <div class="row">
                    <div class="col-12">
                        ...
                        <form method="POST" id="submitPermohonan" action="{{ route('tukarPeralatan.sokonganUlasanR-04.store', $application->id) }}">
                            @csrf
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered modal-xl modal-fullscreen-md-down">
                                                                        <div class="modal-content p-3">
                                                                            ...
                                                                            <div class="modal-body text-center">
                                                                                ...
                                                                                <img src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewDocument', $file->id) }}" class="img-fluid rounded" style="max-height: 85vh;">
                                                                                @elseif(strtolower($extension) === 'pdf')
                                                                                <iframe src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewDocument', $file->id) }}" width="100%" height="700px" frameborder="0"></iframe>
                                                                                @else
                                                                                <a href="{{ route('tukarPeralatan.sokonganUlasanR-04.viewDocument', $file->id) }}" target="_blank" class="btn btn-outline-primary">Buka Dokumen</a>
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                                            ...
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        @if(in_array(strtolower($extension), ['jpg', 'jpeg', 'png']))
                                                                                                        <img src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'attendance_form_path']) }}" class="img-fluid rounded" style="max-height: 300px;">
                                                                                                        @elseif(strtolower($extension) === 'pdf')
                                                                                                        <iframe src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'attendance_form_path']) }}" width="100%" height="400px" frameborder="0"></iframe>
                                                                                                        @else
                                                                                                        <a href="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'attendance_form_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Fail</a>
                                                                                                        @endif
                                                                                                        @else
                                                                                                        Tiada
                                                                                                        @endif
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        @if(in_array(strtolower($extension), ['jpg', 'jpeg', 'png']))
                                                                                                        <img src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'vessel_image_path']) }}" class="img-fluid rounded" style="max-height: 300px;">
                                                                                                        @elseif(strtolower($extension) === 'pdf')
                                                                                                        <iframe src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'vessel_image_path']) }}" width="100%" height="400px" frameborder="0"></iframe>
                                                                                                        @else
                                                                                                        <a href="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'vessel_image_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Fail</a>
                                                                                                        @endif
                                                                                                        @else
                                                                                                        Tiada
                                                                                                        @endif
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        @if(in_array(strtolower($extension), ['jpg', 'jpeg', 'png']))
                                                                                                        <img src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'inspector_owner_image_path']) }}" class="img-fluid rounded" style="max-height: 300px;">
                                                                                                        @elseif(strtolower($extension) === 'pdf')
                                                                                                        <iframe src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'inspector_owner_image_path']) }}" width="100%" height="400px" frameborder="0"></iframe>
                                                                                                        @else
                                                                                                        <a href="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'inspector_owner_image_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Fail</a>
                                                                                                        @endif
                                                                                                        @else
                                                                                                        Tiada
                                                                                                        @endif
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        @if(in_array(strtolower($extension), ['jpg', 'jpeg', 'png']))
                                                                                                        <img src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'overall_image_path']) }}" class="img-fluid rounded" style="max-height: 300px;">
                                                                                                        @elseif(strtolower($extension) === 'pdf')
                                                                                                        <iframe src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'overall_image_path']) }}" width="100%" height="400px" frameborder="0"></iframe>
                                                                                                        @else
                                                                                                        <a href="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'overall_image_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Fail</a>
                                                                                                        @endif
                                                                                                        @else
                                                                                                        Tiada
                                                                                                        @endif
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        <img src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_image_path']) }}" class="img-fluid rounded" style="max-height: 300px;">
                                                                                                        @elseif(strtolower($engineImgExt) === 'pdf')
                                                                                                        <iframe src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_image_path']) }}" width="100%" height="400px" frameborder="0"></iframe>
                                                                                                        @else
                                                                                                        <a href="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_image_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Fail</a>
                                                                                                        @endif
                                                                                                        @else
                                                                                                        Tiada
                                                                                                        @endif
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        <img src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_number_image_path']) }}" class="img-fluid rounded" style="max-height: 300px;">
                                                                                                        @elseif(strtolower($engineNumExt) === 'pdf')
                                                                                                        <iframe src="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_number_image_path']) }}" width="100%" height="400px" frameborder="0"></iframe>
                                                                                                        @else
                                                                                                        <a href="{{ route('tukarPeralatan.sokonganUlasanR-04.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_number_image_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Fail</a>
                                                                                                        @endif
                                                                                                        @else
                                                                                                        Tiada
                                                                                                        @endif
                                                ...
                                                <div class="tab-pane fade" id="content-tab9" role="tabpanel" aria-labelledby="tab10-link">
                                                    ...
                                                    <div id="sokonganSection" style="display: none;">
                                                        <div class="card-header mb-3 pl-0">
                                                            ...
                                                            <small class="text-muted">Sila nyatakan sokongan terhadap permohonan ini</small>
                                                        </div>
                                                        <div class="d-flex gap-4 mb-4">
                                                            <div class="form-check">
                                                            ...
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-label" for="tidak_sokong">Tidak Sokong</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-header mb-3 pl-0">
                                                        ...
                                                        <small class="text-muted">Sila berikan ulasan terhadap semakan dan sokongan ini</small>
                                                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#searchButton').click(function(e) {
                ...
                if (year && month) {
                    $.ajax({
                        url: '{{ route('tukarPeralatan.sokonganUlasanR-04.fetchData', ['id'=> $application->id]) }}'
                        , method: 'GET'
                        , data: {
                            year: year
                            , month: month
