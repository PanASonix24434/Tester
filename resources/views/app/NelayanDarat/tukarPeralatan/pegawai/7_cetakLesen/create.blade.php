                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/tukarPeralatan/cetakLesen-04">{{
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab3" role="tabpanel" aria-labelledby="tab3-link">
                                            ...
                                            <section>
                                                  <div class="mb-3">
            <!--  New Equipment -->
            <h5 class="fw-bold mb-0">Peralatan Menangkap Ikan Baharu</h5>
            <small class="text-muted">
                Bahagian ini memaparkan senarai peralatan menangkap ikan yang
                dimohon oleh pemohon seperti yang dinyatakan dalam permohonan
                semasa.
            </small>
            <hr>
        </div>
<section>
    <div class="mb-3">
        <h6 class="fw-bold mb-0">Peralatan Utama</h6>
        <small class="text-muted">Senarai peralatan utama yang dimohon.</small>

    </div>

    @if ($mainTempt && count($mainTempt))
    <div class="table-responsive">
        <table class="table   align-middle">
            ...
            <tbody>
                @foreach ($mainTempt as $index => $item)
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td>{{ $item['name'] ?? '-' }}</td>
                    <td>{{ $item['quantity'] ?? '-' }}</td>
                    ...
                    <td class="text-center">
                        ...
                        <a href="{{ route('tukarPeralatan.permohonan-04.viewTempEquipment', ['type' => 'UTAMA', 'index' => $index]) }}"
    ...
    @else
    <p class="text-muted">Tiada peralatan utama dimuat naik.</p>
    @endif
</section>
<br>
...
<section>
    <div class="mb-3">
        <h6 class="fw-bold mb-0">Peralatan Tambahan</h6>
        <small class="text-muted">Senarai peralatan tambahan yang telah dimuat naik (jika ada).</small>

    </div>

    @if (!empty($additionalTempt) && count($additionalTempt))
    <div class="table-responsive">
        <table class="table  align-middle">
            <thead class="table-light">
                <tr>
            ...
            <tbody>
                @foreach ($additionalTempt as $index => $item)
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td>{{ $item['name'] ?? '-' }}</td>
                    <td>{{ $item['quantity'] ?? '-' }}</td>
                    ...
                    <td class="text-center">
                        @if (!empty($item['file_path']))
                        <a href="{{ route('tukarPeralatan.permohonan-04.viewTempEquipment', ['type' => 'TAMBAHAN', 'index' => $index]) }}"
                            target="_blank" class="btn   btn-primary">
                            <i class="fa fa-search"></i>
                        </a>
                        @else
    ...
    @else
    <p class="text-muted">Tiada peralatan tambahan dimuat naik.</p>
    @endif
</section>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" style="height: 80vh;">
                                                                            <iframe src="{{ route('tukarPeralatan.cetakLesen-04.viewDocument', [
                                                                                                    'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('tukarPeralatan.cetakLesen-04.viewInspectionDocument', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('tukarPeralatan.cetakLesen-04.updateFault', ['application_id' => $application->id]) }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe
                                                                                    src="{{ route('tukarPeralatan.cetakLesen-04.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                    style="width: 100%; height: 100%;"
                                        ...
                                        <!---->
                                            <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="submitPermohonan"
                                                    action="{{ route('tukarPeralatan.cetakLesen-04.store', $application->id) }}">
                                                    @csrf
   ...
   <script>
    ...
    fetch("{{ route('tukarPeralatan.cetakLesen-04.semakPin', $application->id) }}", {
        method: "POST",
        headers: {
