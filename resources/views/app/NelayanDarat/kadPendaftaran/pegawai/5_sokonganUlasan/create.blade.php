                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a
                                    href="http://127.0.0.1:8000/kadPendaftaran/sokonganUlasan-08">{{
                            ...
                            {{-- <li class="breadcrumb-item active" aria-current="page">sokonganUlasan</a></li> --}}
...
<table class="table-borderless table">
   ...
   onclick="window.open('{{ route('kadPendaftaran.sokonganUlasan-08.viewTempEquipment', [
       'type' => $equipment['type'],
       'index' => $index,
    ...
    @if (!empty($doc['file_path']))
        <a href="#" class="btn btn-primary"
           onclick="window.open('{{ route('kadPendaftaran.sokonganUlasan-08.viewTempDocument', [
               'index' => $index,
               'application_id' => $application->id
...
<table class="table table-borderless">
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('kadPendaftaran.sokonganUlasan-08.viewInspection', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                            ...
                                            <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                                ...
                                                {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <form method="POST"
                                                            action="{{ route('kadPendaftaran.sokonganUlasan-08.updateFault', ['application_id' => $application->id]) }}"
    ...
    @if (!empty($rekod->document_path))
        <a href="#" class="btn btn-primary"
           onclick="window.open('{{ route('kadPendaftaran.sokonganUlasan-08.viewFaultRecord', [
               'application_id' => $application->id,
               'record_id' => $rekod->id
...
@if ($pendaratanDoc && !empty($pendaratanDoc['file_path']))
    <div class="mb-4 text-center">
        ...
        <div class="d-flex justify-content-center">
            <iframe
                src="{{ route('kadPendaftaran.sokonganUlasan-08.viewTempDocument', [
...
@endif
                                            ...
                                            <!---->
                                                ...
                                                <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                    ...
                                                    action="{{ route('kadPendaftaran.sokonganUlasan-08.store', $application->id) }}">
                                                    @csrf
   <!-- Semakan -->
                                                    <div class="card-header mb-3 pl-0">
