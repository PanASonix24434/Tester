...
<div id="app-content">
                     ...
                     <nav aria-label="breadcrumb" class="d-flex   justify-content-end">
                        <ol class="breadcrumb text-center">
                            {{-- <li class="breadcrumb-item">
                                <a href="http://127.0.0.1:8000/kadPendaftaran/cetakLesen-08">{{ \Illuminate\Support\Str::ucfirst(strtolower($applicationType->name)) }}</a>
                            </li> --}}
    ...
    <tbody>
                    ...
                    <td>
                        @if (in_array($application->applicationStatus->code, $negativeFeedback))
                            <button class="btn btn-warning col-md"
                                onclick="window.location.href='{{ route('kadPendaftaran.cetakLesen-08.tidakLengkap', $application->id) }}'">
                        ...
                        @elseif (in_array($application->applicationStatus->code, $positiveFeedback))
                            <button class="btn btn-success col-md"
                                onclick="window.location.href='{{ route('kadPendaftaran.cetakLesen-08.create', $application->id) }}'">
        ...
        @else
            <tr>
                <td class="text-center" colspan="8">Tiada permohonan ditemui.</td>
            </tr>
        @endif
    </tbody>
</table>
