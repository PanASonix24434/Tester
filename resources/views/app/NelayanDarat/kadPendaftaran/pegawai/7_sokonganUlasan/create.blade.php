                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('kadPendaftaran.sokonganUlasan-1-08.viewInspection', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                            ...
                                            <!---->
                                                ...
                                                <div class="tab-pane fade" id="content-tab9" role="tabpanel" aria-labelledby="tab10-link">
                                                    ...
                                                    <form method="POST" id="submitSemakan"
                                                        action="{{ route('kadPendaftaran.sokonganUlasan-1-08.store', $application->id) }}">
                                                        @csrf
