                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('kadPendaftaran.keputusan-08.viewInspection', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                            ...
                                            <!---->
                                                ...
                                                <div class="tab-pane fade" id="content-tab9" role="tabpanel" aria-labelledby="tab10-link">
                                                    ...
                                                    <form method="POST" id="submitSemakan"
                                                        action="{{ route('kadPendaftaran.keputusan-08.store', $application->id) }}">
                                                        @csrf
                                                        ...
                                                        <div class=" mb-3 pl-0">
                                                            <label class="fw-bold mb-0">Jenis Nelayan</label> <br>
                                                            <small class="text-muted">Sila pilih kategori nelayan bagi pemohon ini</small>
                                                        </div>

                                                        <div class="d-flex mb-4 flex-wrap gap-4">
                                                            @foreach ($fishermanType as $name => $id)
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="fisherman_type" id="fisherman_type_{{ $id }}"
                                                                    value="{{ $id }}" {{ old('fisherman_type', $jettyData['fisherman_type'] ?? '' )==$id ? 'checked'
                                                                    : '' }}>
                                                                <label class="form-check-label" for="fisherman_type_{{ $id }}">
                                                                    {{ $name }}
                                                                </label>
                                                            </div>
                                                            @endforeach
