...
<div id="app-content">
                ...
                <div class="col-md-3 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/kadPendaftaran/laporanLpi-08">{{
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="tab-pane fade    " id="content-tab1" role="tabpanel"
                                                ...
                                                <form id="form-tab1"
                                                    action="{{ route('kadPendaftaran.laporanLpi-08.storeMaklumatVesel', $application->id) }}"
   ...
   onclick="window.open('{{ route('kadPendaftaran.laporanLpi-08.viewInspection', [
       'id' => $inspection->id,
        ...
        input?.addEventListener('change', function () {
            ...
            if (label) label.textContent = fileName;
                                            ...
                                            <div class="tab-pane fade" id="content-tab2" role="tabpanel"
                                                ...
                                                <form id="form-tab2"
                                                    action="{{ route('kadPendaftaran.laporanLpi-08.storeMaklumatEnjin', $application->id) }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
   ...
   onclick="window.open('{{ route('kadPendaftaran.laporanLpi-08.viewInspection', [
    ...
    <i class="fa fa-search"></i>
                                            ...
                                            <div class="tab-pane fade" id="content-tab3" role="tabpanel"
                                                ...
                                                <form id="form-tab3"
                                                    action="{{ route('kadPendaftaran.laporanLpi-08.storePeralatanKeselamatan', $application->id) }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
        ...
        input?.addEventListener('change', function () {
            ...
            if (label) label.textContent = fileName;
                                            ...
                                            <div class="tab-pane fade" id="content-tab4" role="tabpanel"
                                                ...
                                                <form id="form-tab4"
                                                    action="{{ route('kadPendaftaran.laporanLpi-08.storePeralatanMenangkapIkan', $application->id) }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
...
<section>
    ...
    <button type="button" class="btn btn-primary"
        onclick="window.open(`{{ route('kadPendaftaran.laporanLpi-08.viewEquipment', [
...
@if (!empty($item->file_path ?? null))
    <div class="col-md-auto text-center">
        <label class="form-label d-none d-md-block">&nbsp;</label>
        <button type="button" class="btn btn-primary"
    onclick="window.open('{{ route('kadPendaftaran.laporanLpi-08.viewEquipment', ['id' => $item->id, 'type' => 'TAMBAHAN']) }}', 'tambahEquipmentWindow{{ $item->id }}', 'width=1200,height=800,scrollbars=yes,resizable=yes'); return false;">
    <i class="fa fa-search p-1"></i>
</button>
                ...
                if (e.target.closest('.remove-item-btn')) {
                    e.target.closest('.row').remove();
                                        ...
                                        <div class="tab-pane fade" id="content-tab5" role="tabpanel"
                                            ...
                                            <form id="form-tab5"
                                                action="{{ route('kadPendaftaran.laporanLpi-08.storePengesahanPemeriksaan', $application->id) }}"
                                                method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="d-flex align-items-center gap-3">
                                                      ...
                                                      <button type="button" class="btn btn-primary"
    onclick="window.open('{{ route('kadPendaftaran.laporanLpi-08.viewInspection', ['id' => $inspection->id, 'field' => 'attendance_form_path']) }}', 'attendanceFormWindow{{ $inspection->id }}', 'width=1200,height=800,scrollbars=yes,resizable=yes'); return false;">
    <i class="fa fa-search"></i>
</button>
            ...
            if (label) label.textContent = fileName;
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="d-flex align-items-center gap-3">
                                                       ...
                                                       <button type="button" class="btn btn-primary"
    onclick="window.open('{{ route('kadPendaftaran.laporanLpi-08.viewInspection', ['id' => $inspection->id, 'field' => 'vessel_image_path']) }}', 'vesselImageWindow{{ $inspection->id }}', 'width=1200,height=800,scrollbars=yes,resizable=yes'); return false;">
    <i class="fa fa-search"></i>
</button>
            ...
            if (label) label.textContent = fileName;
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <button type="button" class="btn btn-primary"
    onclick="window.open('{{ route('kadPendaftaran.laporanLpi-08.viewInspection', ['id' => $inspection->id, 'field' => 'inspector_owner_image_path']) }}', 'ownerInspectorWindow{{ $inspection->id }}', 'width=1200,height=800,scrollbars=yes,resizable=yes'); return false;">
    <i class="fa fa-search"></i>
</button>
                            ...
                            <div class="d-flex justify-content-end gap-3">
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <form id="form-submit-final" onsubmit="sessionStorage.removeItem('lastSavedTab')"
                                        action="{{ route('kadPendaftaran.laporanLpi-08.store', $application->id) }}"
                                        method="POST">
                                        @csrf
                                    </form>
