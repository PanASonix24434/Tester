                ...
                <div class="col-md-3 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex   justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/kadPendaftaran/laporanLpi-08">{{ \Illuminate\Support\Str::ucfirst(strtolower($applicationType->name)) }}</a></li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-primary card-tabs">
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="content-tab1" role="tabpanel" aria-labelledby="tab1-link">
                                        <form id="form-tab1" action="{{ route('kadPendaftaran.laporanLpi-08.storeMaklumatVesel', $application->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-xl modal-fullscreen-md-down">
                                                    <div class="modal-content p-3">
                                                        ...
                                                        <div class="modal-body text-center">
                                                            ...
                                                            <img src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'overall_image_path']) }}" class="img-fluid rounded" style="max-height: 85vh;">
                                                            @elseif(strtolower($extension) === 'pdf')
                                                            <iframe src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'overall_image_path']) }}" width="100%" height="700px" frameborder="0"></iframe>
                                                            @else
                                                            <a href="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'overall_image_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Dokumen</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="content-tab2" role="tabpanel" aria-labelledby="tab2-link">
                                        <form id="form-tab2" action="{{ route('kadPendaftaran.laporanLpi-08.storeMaklumatEnjin', $application->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-xl modal-fullscreen-md-down">
                                                    <div class="modal-content p-3">
                                                        ...
                                                        <div class="modal-body text-center">
                                                            ...
                                                            <img src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_image_path']) }}" class="img-fluid rounded" style="max-height: 85vh;">
                                                            @elseif(strtolower($ext) === 'pdf')
                                                            <iframe src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_image_path']) }}" width="100%" height="700px" frameborder="0"></iframe>
                                                            @else
                                                            <a href="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_image_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Fail</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-xl modal-fullscreen-md-down">
                                                    <div class="modal-content p-3">
                                                        ...
                                                        <div class="modal-body text-center">
                                                            ...
                                                            @if(in_array(strtolower($ext), ['jpg', 'jpeg', 'png']))
                                                            <img src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_number_image_path']) }}" class="img-fluid rounded" style="max-height: 85vh;">
                                                            @elseif(strtolower($ext) === 'pdf')
                                                            <iframe src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_number_image_path']) }}" width="100%" height="700px" frameborder="0"></iframe>
                                                            @else
                                                            <a href="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_number_image_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Fail</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="tab-pane fade" id="content-tab3" role="tabpanel" aria-labelledby="tab3-link">
                                <form id="form-tab3" action="{{ route('kadPendaftaran.laporanLpi-08.storePeralatanKeselamatan', $application->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-center">
                                                            ...
                                                            @if(in_array(strtolower($ext), ['jpg', 'jpeg', 'png']))
                                                            <img src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'safety_jacket_image_path']) }}" class="img-fluid rounded" style="max-height: 600px;">
                                                            @elseif(strtolower($ext) === 'pdf')
                                                            <iframe src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'safety_jacket_image_path']) }}" width="100%" height="600px" frameborder="0"></iframe>
                                                            @else
                                                            <a href="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'safety_jacket_image_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Fail</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="tab-pane fade" id="content-tab4" role="tabpanel" aria-labelledby="tab4-link">
                                <form id="form-tab4" action="{{ route('kadPendaftaran.laporanLpi-08.storePeralatanMenangkapIkan', $application->id) }}" method="POST">
                                    @csrf
                            ...
                            <div class="tab-pane fade" id="content-tab5" role="tabpanel" aria-labelledby="tab5-link">
                                <form id="form-tab5" action="{{ route('kadPendaftaran.laporanLpi-08.storePengesahanPemeriksaan', $application->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-center">
                                                            ...
                                                            @if(in_array(strtolower($ext), ['jpg', 'jpeg', 'png']))
                                                            <img src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'attendance_form_path']) }}" class="img-fluid rounded" style="max-height: 600px;">
                                                            @elseif(strtolower($ext) === 'pdf')
                                                            <iframe src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'attendance_form_path']) }}" width="100%" height="600px" frameborder="0"></iframe>
                                                            @else
                                                            <a href="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'attendance_form_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Fail</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-center">
                                                            ...
                                                            @if(in_array(strtolower($ext), ['jpg', 'jpeg', 'png']))
                                                            <img src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'vessel_image_path']) }}" class="img-fluid rounded" style="max-height: 600px;">
                                                            @elseif(strtolower($ext) === 'pdf')
                                                            <iframe src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'vessel_image_path']) }}" width="100%" height="600px" frameborder="0"></iframe>
                                                            @else
                                                            <a href="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'vessel_image_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Fail</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-center">
                                                            ...
                                                            @if(in_array(strtolower($ext), ['jpg', 'jpeg', 'png']))
                                                            <img src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'inspector_owner_image_path']) }}" class="img-fluid rounded" style="max-height: 600px;">
                                                            @elseif(strtolower($ext) === 'pdf')
                                                            <iframe src="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'inspector_owner_image_path']) }}" width="100%" height="600px" frameborder="0"></iframe>
                                                            @else
                                                            <a href="{{ route('kadPendaftaran.laporanLpi-08.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'inspector_owner_image_path']) }}" target="_blank" class="btn btn-outline-primary">Buka Fail</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-end gap-3">
                            ...
                            <div class="d-flex gap-3">
                                ...
                                <form id="form-submit-final" action="{{ route('kadPendaftaran.laporanLpi-08.store', $application->id) }}" method="POST">
                                    @csrf
                                </form>
