...
<style>
    ...
    .btn-primary {
        ...
        /* Set background color to #008bff */
        border-color: #008bff !important;
        /* Set border color to #008bff */
                                                ...
                                                <table class="table-borderless table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Daerah</td>
                                                            <td class="text-center">:</td>
                                                            <td>{{ $userDetail->district_name ?? 'TIDAK DIKETAHUI' }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Negeri</td>
                                            ...
                                            <table class="table-borderless table">
                                                <tbody>
                                                    ...
                                                    @if (($vesselInfo['has_vessel'] ?? '') === 'yes')
                                                        <tr>
                                                            <td class="col-md-4 fw-bold table-light" colspan="3">Maklumat Vesel</td>
                                                        </tr>
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('kadPendaftaran.semakanDokumen-08.viewInspection', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                            ...
                                            <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                                ...
                                                <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <form method="POST"
                                                            action="{{ route('kadPendaftaran.semakanDokumen-08.createFaultRecord', ['application_id' => $application->id]) }}"
...
@endif
                                            ...
                                            <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="submitSemakan"
                                                    action="{{ route('kadPendaftaran.semakanDokumen-08.store', $application->id) }}">
                                                    @csrf
  <!-- Semakan -->
                                                <div class="card-header mb-3 pl-0">
