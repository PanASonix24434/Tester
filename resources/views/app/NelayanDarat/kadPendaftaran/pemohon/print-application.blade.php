...
<body>
    ...
    <table style="width: 100%; border: none; margin-bottom: 10px;">
        <tr>
            ...
            <td style="width: 60%; text-align: center; border: none;">
                <div style="font-size:14px; font-weight: bold;">Jabatan Perikanan Malaysia</div>
                <div style="font-size:12px; font-weight: bold;">Kementerian Keterjaminan Makanan Dan Asas Tani</div>
                <div style="font-size:10x;">Borang Permohonan Pendaftaran Nelayan Darat</div>
            </td>
    ...
    <table class="">
        ...
        <tr class="no-border">
            ...
            <td class="no-border">: {{ isset($personalInfo['name']) ? strtoupper($personalInfo['name']) : '-' }}</td>

        </tr>
        <tr class="no-border">
            <td class="no-border">Nombor Kad Pengenalan</td>
            <td class="no-border">: {{ $personalInfo['identity_card_number'] ?? '-' }}</td>
        </tr>
        <tr class="no-border">
        ...
        <tr class="no-border">
            ...
            <td class="no-border">: {{ isset($personalInfo['address']) ? strtoupper($personalInfo['address']) : '-' }}
            </td>
        </tr>
        <tr class="no-border">
            <td class="no-border">Poskod</td>
            <td class="no-border">: {{ isset($personalInfo['postcode']) ? strtoupper($personalInfo['postcode']) : '-' }}
            </td>
        </tr>
        <tr class="no-border">
            <td class="no-border">Daerah</td>
            <td class="no-border">: {{ isset($personalInfo['district']) ? strtoupper($personalInfo['district']) : '-' }}
            </td>
        </tr>
        <tr class="no-border">
            <td class="no-border">Negeri</td>
            <td class="no-border">: {{ isset($personalInfo['state']) ? strtoupper($personalInfo['state']) : '-' }}</td>
        </tr>
        ...
        <tr class="no-border">
            ...
            <td class="no-border">: {{ strtoupper($jettyData['state'] ?? '-') }}</td>
        </tr>
        <tr class="no-border">
            <td class="no-border">Daerah</td>
            <td class="no-border">: {{ strtoupper($jettyData['district'] ?? '-') }}</td>
        </tr>
        <tr class="no-border">
            <td class="no-border">Nama Jeti</td>
            <td class="no-border">: {{ strtoupper($jettyData['jetty_name'] ?? '-') }}</td>
        </tr>
        <tr class="no-border">
            <td class="no-border">Sungai</td>
            <td class="no-border">: {{ strtoupper($jettyData['river'] ?? '-') }}</td>
        </tr>
        ...
        {{-- <tr class="no-border">
            ...
            <td class="no-border">: {{ ($vesselData['has_vessel'] ?? '-') == 'yes' ? '' : 'Tidak' }}</td>
        </tr> --}}
