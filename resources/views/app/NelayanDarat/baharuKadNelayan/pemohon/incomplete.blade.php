        ...
        <div class="container-fluid">
            ...
            <div>
                <div class="card">
                    ...
                    <form id="submitPermohonan" method="POST" enctype="multipart/form-data" action="{{ route('baharuKadNelayan.permohonan-09.storeAppeal') }}">
                        @csrf
                ...
                <div class="card card-primary card-tabs">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="tab-content " id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="content-tab1" role="tabpanel" aria-labelledby="tab1-link">
                                <form id="store_tab1" method="POST" action="{{ route('baharuKadNelayan.permohonan-09.store_tab1') }}">
                                    @csrf
                            ...
                            <div class="tab-pane fade" id="content-tab2" role="tabpanel" aria-labelledby="tab1-link">
                                <form id="store_tab2" method="POST" action="{{ route('baharuKadNelayan.permohonan-09.store_tab2') }}">
                                    @csrf
                            ...
                            <div class="tab-pane fade" id="content-tab3" role="tabpanel" aria-labelledby="tab3-link">
                                <form id="store_tab3" method="POST" enctype="multipart/form-data" action="{{ route('baharuKadNelayan.permohonan-09.store_tab3') }}">
                                    @csrf
                            ...
                            <div class="tab-pane fade" id="content-tab4" role="tabpanel" aria-labelledby="tab4-link">
                                <form id="store_tab4" method="POST" enctype="multipart/form-data" action="{{ route('baharuKadNelayan.permohonan-09.store_tab4') }}">
                                    @csrf
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-xl">
                                            <div class="modal-content p-3">
                                                ...
                                                <div class="modal-body text-center">
                                                    <img src="{{ route('baharuKadNelayan.permohonan-09.viewEquipmentPhoto', $equipmentSet->id) }}" alt="Gambar Peralatan" class="img-fluid rounded" style="max-height: 80vh;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="content-tab5" role="tabpanel" aria-labelledby="tab5-link">
                            <form id="store_tab5" method="POST" enctype="multipart/form-data" action="{{ route('baharuKadNelayan.permohonan-09.store_tab5') }}">
                                @csrf
                    ...
                    <div class="card-footer pr-0">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <form id="submitPermohonan" method="POST" enctype="multipart/form-data" action="{{ route('baharuKadNelayan.permohonan-09.store') }}">
                                @csrf
                            </form>
