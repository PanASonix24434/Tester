                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/baharuKadNelayan/semakanUlasanR-09">{{
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe src="{{ route('baharuKadNelayan.semakanUlasanR-09.viewDocument', [
                                                                                                    'index' => $index,
        ...
        @if (!empty($ins->$field))
            <div class="col-12">
                ...
                <div class="border p-2 bg-light text-center">
                    <img
                        src="{{ route('baharuKadNelayan.semakanUlasanR-09.viewInspectionDocument', ['id' => $ins->id, 'field' => $field]) }}"
                        alt="{{ $label }}"
                                            ...
                                            <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                                ...
                                                {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <form method="POST"
                                                            action="{{ route('baharuKadNelayan.semakanUlasanR-09.updateFault', ['application_id' => $application->id]) }}"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body"
                                                                                    style="height: 80vh;">
                                                                                    <iframe
                                                                                        src="{{ route('baharuKadNelayan.semakanUlasanR-09.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                        style="width: 100%; height: 100%;"
                                    ...
                                    @endforelse
                                           ...
                                           <div class="tab-pane fade" id="content-tab9" role="tabpanel" aria-labelledby="tab10-link">
                                                ...
                                                <form method="POST" id="submitSemakan"
                                                    action="{{ route('baharuKadNelayan.semakanUlasanR-09.store', $application->id) }}">
                                                    @csrf


                                                      <!-- Semakan -->
                                                    <div class="card-header mb-3 pl-0">
                                                    <h4 class="fw-bold mb-0">Tindakan</h4>
                                                    <small class="text-muted">
                                                        Bahagian ini membolehkan pegawai menandakan status semakan borang sama ada lengkap atau tidak lengkap.
                                                    </small>
                                                </div>
                                                    ...
                                                    <div class="d-flex gap-4 mb-4">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="review_flag" id="lengkap" value="1">
                                                            <label class="form-check-label"
                                                                for="lengkap">Lengkap</label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="review_flag" id="tidak_lengkap" value="0">
