                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/baharuKadNelayan/resitBayaran-09">{{
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" style="height: 80vh;">
                                                                            <iframe src="{{ route('baharuKadNelayan.resitBayaran-09.viewDocument', [
                                                                                                    'index' => $index,
    ...
    @endforeach
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('baharuKadNelayan.resitBayaran-09.updateFault', ['application_id' => $application->id]) }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe
                                                                                    src="{{ route('baharuKadNelayan.resitBayaran-09.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                    style="width: 100%; height: 100%;"
                                        ...
                                        <!---->
                                           ...
                                           <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="storePermohonan" action="{{ route('baharuKadNelayan.resitBayaran-09.store',
        ...
        <div class="modal fade" id="receiptPreviewModal" tabindex="-1" aria-labelledby="receiptPreviewLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="height: 80vh;">
                        <iframe src="{{ route('baharuKadNelayan.resitBayaran-09.viewReceipt', ['receipt_id' => $receipt->id]) }}"
        ...
        input.addEventListener('change', function () {
            ...
            label.textContent = fileName;
                                       ...
                                       <form method="POST" id="submitPermohonan" onsubmit="sessionStorage.removeItem('hasSaved')"
                                            action="{{ route('baharuKadNelayan.resitBayaran-09.submit', $application->id) }}"
