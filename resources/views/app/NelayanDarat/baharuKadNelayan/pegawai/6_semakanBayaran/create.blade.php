                                        ...
                                        <!---->
                                            ...
                                            <div class="tab-pane fade  " id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="submitSemakan"
                                                    action="{{ route('baharuKadNelayan.semakanBayaran-09.store', $application->id) }}"
                                                    ...
                                                    <div class="mb-4">
                                                        <label class="form-label  ">Resit Pembayaran</label>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="modal-content p-3">
                                                                    ...
                                                                    <div class="modal-body p-0" style="height: 80vh;">
                                                                        <iframe
                                                                            src="{{ route('baharuKadNelayan.semakanBayaran-09.viewReceiptDocument', ['receipt_id' => $receipt->id]) }}"
                                                                            style="width: 100%; height: 100%;"
                                                                            frameborder="0"></iframe>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <!-- Senarai Item Resit -->
                                                    <div class="card-header mb-3 pl-0">
                                                        <label class="form-label fw-bold mb-0">Item Dalam Resit</label><br>
                                                    ...
                                                    <div class="card-header mb-3 pl-0 mt-4">
                                                        <label class="form-label fw-bold mb-0">Semakan</label> <br>
                                                    ...
                                                    <div id="pengesahanSection" style="display: none;">
                                                        <div class="card-header mb-3 pl-0">
                                                            <label class="form-label fw-bold mb-0">Pengesahan</label> br
                                                    ...
                                                    <!-- Ulasan -->
                                                    <div class="card-header mb-3 pl-0">
                                                        <label class="form-label mb-0">Ulasan</label> <br>
