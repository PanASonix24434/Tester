                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/baharuKadNelayan/semakanBayaran-09">{{
    ...
    <table class="table-borderless table">
        <tbody>
            <tr>
                ...
                <td class="col-md-1 text-center">:</td>
                <td>{{ Str::upper($jettyOff->state->name ?? 'Tidak Diketahui') }}</td>
            </tr>
            <tr>
                <td class="col-md-4">Daerah</td>
                <td class="col-md-1 text-center">:</td>
                <td>{{ Str::upper($jettyOff->district->name ?? 'Tidak Diketahui') }}</td>
            </tr>
            <tr>
                <td class="col-md-4">Nama Sungai/Tasik</td>
                <td class="col-md-1 text-center">:</td>
                <td>{{ Str::upper($jettyOff->river->name ?? 'Tidak Diketahui') }}</td>
            </tr>
            <tr>
                <td class="col-md-4">Pangkalan</td>
                <td class="col-md-1 text-center">:</td>
                <td>{{ Str::upper($jettyOff->jetty->name ?? 'Tidak Diketahui') }}</td>
            </tr>
        </tbody>
    </table>
</div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" style="height: 80vh;">
                                                                            <iframe src="{{ route('baharuKadNelayan.semakanBayaran-09.viewDocument', [
                                                                                                    'index' => $index,
...
<table class="table table-borderless">
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('baharuKadNelayan.semakanDokumen-09.viewInspectionDocument', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('baharuKadNelayan.semakanBayaran-09.updateFault', ['application_id' => $application->id]) }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe
                                                                                    src="{{ route('baharuKadNelayan.semakanBayaran-09.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                    style="width: 100%; height: 100%;"
                                        ...
                                        <!---->
                                            ...
                                            <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="submitSemakan"
                                                    action="{{ route('baharuKadNelayan.cetakLesen-09.store', $application->id) }}">
                                                    @csrf
  ...
  <script>
    ...
    fetch("{{ route('baharuKadNelayan.cetakLesen-09.semakPin', $application->id) }}", {
        method: "POST",
        headers: {
