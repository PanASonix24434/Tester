                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/baharuKadNelayan/sokonganUlasanR-09">{{
...
<table class="table-borderless table">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="form-control"
                    value="{{ Str::upper($userDetail->name ?? 'TIDAK DIKETAHUI') }}"
                    readonly>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" class="form-control"
                    value="{{ Str::upper($userDetail->icno ?? 'TIDAK DIKETAHUI') }}"
                    readonly>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" class="form-control"
                    value="{{ Str::upper($jetty->jetty_name ?? 'TIDAK DIKETAHUI') }}"
                    readonly>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" class="form-control"
                    value="{{ Str::upper($vessel->vessel_registration_number ?? 'TIADA VESEL') }}"
                    readonly>
            </td>
        </tr>
    </tbody>
    ...
    <tbody>
        <tr>
            ...
            <td>{{ Str::upper($userDetail->name ?? 'TIDAK DIKETAHUI') }}</td>
        </tr>
        <tr>
            <td>No. I/C</td>
            <td class="text-center">:</td>
            <td>{{ Str::upper($userDetail->icno ?? 'TIDAK DIKETAHUI') }}</td>
        </tr>
        <tr>
            <td>No. Telefon</td>
            <td class="text-center">:</td>
            <td>{{ Str::upper($userDetail->no_phone ?? 'TIDAK DIKETAHUI') }}</td>
        </tr>
        <tr>
            <td>No. Telefon (Kedua)</td>
            <td class="text-center">:</td>
            <td>{{ Str::upper($userDetail->secondary_phone_number ?? '-') }}</td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        ...
        <tr>
            <td>Poskod</td>
            <td class="text-center">:</td>
            <td>{{ Str::upper($userDetail->poskod ?? 'TIDAK DIKETAHUI') }}</td>
        </tr>
        <tr>
            <td>Daerah</td>
            <td class="text-center">:</td>
            <td>{{ Str::upper($userDetail->district ?? 'TIDAK DIKETAHUI') }}</td>
        </tr>
        <tr>
            <td>Negeri</td>
            <td class="text-center">:</td>
            <td>{{ Str::upper($userDetail->state ?? 'TIDAK DIKETAHUI') }}</td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        ...
        <tr>
            <td>Poskod</td>
            <td class="text-center">:</td>
            <td>{{ Str::upper($userDetail->secondary_postcode ?? 'TIDAK DIKETAHUI') }}</td>
        </tr>
        <tr>
            <td>Daerah</td>
            <td class="text-center">:</td>
            <td>{{ Str::upper($userDetail->secondary_district ?? 'TIDAK DIKETAHUI') }}</td>
        </tr>
        <tr>
            <td>Negeri</td>
            <td class="text-center">:</td>
            <td>{{ Str::upper($userDetail->secondary_state ?? 'TIDAK DIKETAHUI') }}</td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        <tr>
            ...
            <td class="col-md-1 text-center">:</td>
            <td>{{ Str::upper($useOff ? ($fishermanInfoOff->year_become_fisherman ?? 'TIDAK DIKETAHUI') : ($fishermanInfo['year_become_fisherman'] ?? 'TIDAK DIKETAHUI')) }}</td>
        </tr>
        <tr>
            <td class="col-md-4">Tempoh Menjadi Nelayan</td>
            <td class="col-md-1 text-center">:</td>
            <td>{{ Str::upper($useOff ? ($fishermanInfoOff->becoming_fisherman_duration ?? 'TIDAK DIKETAHUI') : ($fishermanInfo['becoming_fisherman_duration'] ?? 'TIDAK DIKETAHUI')) }} TAHUN</td>
        </tr>
        <tr>
            <td class="col-md-4">Hari Bekerja Menangkap Ikan Sebulan</td>
            <td class="col-md-1 text-center">:</td>
            <td>{{ Str::upper($useOff ? ($fishermanInfoOff->working_days_fishing_per_month ?? 'TIDAK DIKETAHUI') : ($fishermanInfo['working_days_fishing_per_month'] ?? 'TIDAK DIKETAHUI')) }}</td>
        </tr>
        <tr>
            <td class="col-md-4">Pendapatan Tahunan Dari Menangkap Ikan</td>
            <td class="col-md-1 text-center">:</td>
            <td>RM {{ number_format($useOff ? ($fishermanInfoOff->estimated_income_yearly_fishing ?? 0) : ($fishermanInfo['estimated_income_yearly_fishing'] ?? 0), 2) }}</td>
        </tr>
        <tr>
            <td class="col-md-4">Pendapatan Dari Pekerjaan Lain</td>
            <td class="col-md-1 text-center">:</td>
            <td>RM {{ number_format($useOff ? ($fishermanInfoOff->estimated_income_other_job ?? 0) : ($fishermanInfo['estimated_income_other_job'] ?? 0), 2) }}</td>
        </tr>
        <tr>
            <td class="col-md-4">Hari Bekerja Di Pekerjaan Lain</td>
            <td class="col-md-1 text-center">:</td>
            <td>{{ Str::upper($useOff ? ($fishermanInfoOff->days_working_other_job_per_month ?? 'TIDAK DIKETAHUI') : ($fishermanInfo['days_working_other_job_per_month'] ?? 'TIDAK DIKETAHUI')) }}</td>
        </tr>
        <tr>
            <td class="col-md-4">Menerima Pencen</td>
            <td class="col-md-1 text-center">:</td>
            <td>{{ ($useOff ? ($fishermanInfoOff->receive_pension ?? 0) : ($fishermanInfo['receive_pension'] ?? 0)) == 1 ? 'YA' : 'TIDAK' }}</td>
        </tr>
        <tr>
            <td class="col-md-4">Menerima Bantuan Kewangan</td>
            <td class="col-md-1 text-center">:</td>
            <td>{{ ($useOff ? ($fishermanInfoOff->receive_financial_aid ?? 0) : ($fishermanInfo['receive_financial_aid'] ?? 0)) == 1 ? 'YA' : 'TIDAK' }}</td>
        </tr>
        <tr>
            <td class="col-md-4">Pencarum KWSP</td>
            <td class="col-md-1 text-center">:</td>
            <td>{{ ($useOff ? ($fishermanInfoOff->epf_contributor ?? 0) : ($fishermanInfo['epf_contributor'] ?? 0)) == 1 ? 'YA' : 'TIDAK' }}</td>
        </tr>
        <tr>
            ...
            <td>
                @php
                    ...
                    $agencies = is_array($agencies) ? $agencies : json_decode($agencies, true);
                @endphp

                @if (!empty($agencies))
                    <ul class="mb-0 ps-3">
                        @foreach ($agencies as $agency)
                            <li>{{ Str::upper($agency) }}</li>
                        @endforeach
                    </ul>
                @else
                    -
                @endif
                                            ...
                                            <div class="tab-pane fade p-4" id="content-tab2" role="tabpanel"
                                                ...
                                                <small class="text-muted">
                                                    Bahagian ini memaparkan maklumat berkaitan lokasi pangkalan pendaratan atau jeti yang digunakan oleh pemohon, termasuk tempat penyimpanan vesel.
                                                </small>
                                                <hr>
                                                ...
                                                <table class="table-borderless table">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="col-md-1 text-center">:</td>
                                                            <td>
                                                                    {{ $jettyOff->state->name ? Str::upper($jettyOff->state->name) : 'TIDAK DIKETAHUI' }}
                                                                </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="col-md-1 text-center">:</td>
                                                            <td>
    {{ $jettyOff->district->name ? Str::upper($jettyOff->district->name) : 'TIDAK DIKETAHUI' }}
</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="col-md-1 text-center">:</td>
                                                            <td>
    {{ $jettyOff->river->name ? Str::upper($jettyOff->river->name) : 'TIDAK DIKETAHUI' }}
</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="col-md-1 text-center">:</td>
                                                            <td>
    {{ $jettyOff->jetty->name ? Str::upper($jettyOff->jetty->name) : 'TIDAK DIKETAHUI' }}
</td>
                                            ...
                                            <div class="tab-pane fade p-4" id="content-tab3" role="tabpanel"
                                                ...
                                                <small class="text-muted">
                                                    Bahagian ini memaparkan senarai peralatan menangkap ikan yang digunakan oleh pemohon seperti yang dinyatakan dalam permohonan semasa.
                                                </small>
                                                <hr>
                                                ...
                                                <h5 class="fw-bold mb-0">Rekod Peralatan Menangkap Ikan</h5>
                                            ...
                                            {{--  <div class="tab-pane fade p-4" id="content-tab4" role="tabpanel" aria-labelledby="tab4-link">
                                               <div class="mb-4">
                                                    ...
                                                    <small class="text-muted">
                                                        Bahagian ini memaparkan maklumat berkaitan enjin dan vesel yang dimiliki atau digunakan oleh pemohon,
                                                        seperti dinyatakan dalam permohonan semasa.
                                                    </small>
                                                    <hr>
                                                    ...
                                                    <table class="table table-borderless">
                                                        <tbody>
                                                            @php
                                                            $hasVessel = $useVesselOff
                                                            ? ($vesselInfoOff?->own_vessel ?? 'no')
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="col-md-1 text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff?->transportation ?? '-') : ($vesselInfo['transport_type'] ??
                                                                    '-') }}</td>
                                                            </tr>
                                                            @else
                                                            <!-- Maklumat Vesel -->
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="col-md-1 text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff?->vessel_registration_number ?? '-') :
                                                                    ($vesselInfo['vessel_registration_number'] ?? '-') }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Jenis Kulit Vesel</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff?->hull?->hull_type ?? '-') : ($vesselInfo['hull_type'] ??
                                                                    '-') }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Panjang (m)</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff?->hull?->length ?? '-') : ($vesselInfo['length'] ?? '-') }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Lebar (m)</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff?->hull?->width ?? '-') : ($vesselInfo['width'] ?? '-') }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Kedalaman (m)</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff?->hull?->depth ?? '-') : ($vesselInfo['depth'] ?? '-') }}
                                                                </td>
                                                            </tr>

                                                            <!-- Maklumat Enjin Tambahan -->
                                                            @php
                                                            $hasEngine = $useVesselOff ? ($vesselInfoOff?->engine ? true : false) : (($vesselInfo['has_engine'] ??
                                                            'no') === 'yes');
                                                            @endphp
                                                            ...
                                                            <tr>
                                                                <td>Model Enjin</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff->engine->model ?? '-') : ($vesselInfo['engine_model'] ?? '-')
                                                                    }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Kuasa Kuda (KK)</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff->engine->horsepower ?? '-') : ($vesselInfo['horsepower'] ??
                                                                    '-') }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Jenama Enjin</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff->engine->engine_brand ?? '-') : ($vesselInfo['engine_brand']
                                                                    ?? '-') }}</td>
                                                            </tr>
                                                            @endif
                                                </div>
    ...
    <div class="mb-4">
        <h5 class="fw-bold mb-0">Maklumat Enjin Dan Vesel Semasa</h5>
        <small class="text-muted">
            Bahagian ini memaparkan maklumat berkaitan enjin dan vesel yang dimiliki atau digunakan oleh pemohon, seperti dinyatakan dalam permohonan semasa.
        </small>
        <hr>
        ...
        <table class="table table-borderless">
            <tbody>
                ...
                <tr>
                    <td class="col-md-4">Jenis Pengangkutan Digunakan</td>
                    <td class="col-md-1 text-center">:</td>
                    <td>{{ $vessel->transport_type ?? 'Maklumat tidak diketahui' }}</td>
                </tr>
                @else
                <tr>
                    <td class="col-md-4">Nombor Pendaftaran Vesel</td>
                    <td class="col-md-1 text-center">:</td>
                    <td>{{ $vessel->registration_number ?? 'Maklumat tidak diketahui' }}</td>
                </tr>
                @endif
                ...
                <tr class="fw-bold">
                    <td colspan="3">Maklumat Kulit Vesel</td>
                </tr>
                <tr>
                    <td>Jenis Kulit Vesel</td>
                    <td class="text-center">:</td>
                    <td>{{ $hull->hull_type ?? 'Maklumat tidak diketahui' }}</td>
                </tr>
                <tr>
                    <td>Panjang (m)</td>
                    <td class="text-center">:</td>
                ...
                <tr class="fw-bold">
                    <td colspan="3">Maklumat Enjin</td>
                </tr>
                <tr>
                    <td>Model Enjin</td>
                    <td class="text-center">:</td>
                ...
                <tr>
                    <td>Kuasa Kuda (KK)</td>
                    <td class="text-center">:</td>
                    <td>{{ $engine->horsepower ?? 'Maklumat tidak diketahui' }}</td>
                </tr>
                <tr>
                    <td>Jenama Enjin</td>
                    <td class="text-center">:</td>
                ...
                @endif
                                            ...
                                            <div class="tab-pane fade p-4" id="content-tab5" role="tabpanel"
                                               ...
                                               <h5 class="fw-bold mb-0">Dokumen Permohonan</h5>
                                                <small class="text-muted">
                                                    Bahagian ini memaparkan senarai dokumen yang telah dimuat naik sebagai sokongan kepada permohonan ini.
                                                </small>
                                                <hr>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe src="{{ route('baharuKadNelayan.sokonganUlasanR-09.viewDocument', [
                                                                                                    'index' => $index,
                                                ...
                                                @else
                                                <p class="text-muted">TIADA DOKUMEN DIMUATNAIK.</p>
                                                @endif
                                               ...
                                               <h5 class="fw-bold mb-0">Rekod Laporan LPI</h5>
                                                <small class="text-muted">
                                                    Senarai Laporan Pemeriksaan LPI (Lesen Perikanan Individu) yang telah direkodkan bagi vesel ini.
                                                </small>
                                                <hr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="modal fade"
                                                                 ...
                                                                 <hr>
<h5 class="fw-bold">Peralatan Diperiksa</h5>
...
<table class="table table-borderless">
    ...
    <tbody>
        @php
            $equipmentList = $item->inspection_equipments ?? collect();
        @endphp

        @forelse ($equipmentList as $eqIndex => $equipment)
            <tr>
                <td>{{ $eqIndex + 1 }}</td>
...
<hr>
<h5 class="fw-bold">Peralatan Dijumpai</h5>
...
<table class="table table-borderless">
    ...
    <tbody>
        @php
            $foundItems = $item->foundItem ?? collect();
        @endphp

        @forelse ($foundItems as $fiIndex => $found)
            <tr>
                <td>{{ $fiIndex + 1 }}</td>
                <td>{{ e($found->item ?? '-') }}</td>
        ...
        @empty
            <tr>
                <td colspan="4" class="text-center text-muted">Tiada barang dijumpai direkodkan.</td>
            </tr>
        @endforelse
    </tbody>
</table>
                                                                                ...
                                                                                <div class="row g-3">
    @foreach ([
        'attendance_form_path' => 'Borang Kehadiran',
        'vessel_image_path' => 'Vesel',
        'inspector_owner_image_path' => 'Pemeriksa & Pemilik',
        'overall_image_path' => 'Gambar Menyeluruh',
        'safety_jacket_image_path' => 'Jaket Keselamatan',
        'engine_image_path' => 'Enjin',
        'engine_number_image_path' => 'No Enjin',
    ] as $field => $label)
        @if (!empty($ins->$field))
            <div class="col-12">
                ...
                <div class="border p-2 bg-light text-center">
                    <img
                        src="{{ route('baharuKadNelayan.sokonganUlasanR-09.viewInspectionDocument', ['id' => $ins->id, 'field' => $field]) }}"
                        alt="{{ $label }}"
    ...
    @endforeach
                                                        ...
                                                        @empty
                                                        <tr>
                                                            <td colspan="5" class="text-center text-muted">TIADA REKOD PEMERIKSAAN LPI TERSEDIA.</td>
                                                        </tr>
                                                        @endforelse
                                                    </tbody>
                                                </table>
                                            ...
                                            <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                                ...
                                                <div class="w-100 d-flex justify-content-between align-items-start">
                                                    ...
                                                    <small class="text-muted">
                                                        Senarai kesalahan yang telah direkodkan melibatkan pengguna ini berdasarkan rekod terdahulu.
                                                    </small>
                                                </div>
                                                ...
                                                {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <form method="POST"
                                                            action="{{ route('baharuKadNelayan.sokonganUlasanR-09.updateFault', ['application_id' => $application->id]) }}"
                                                ...
                                                <div class="table-responsive mt-3">
                                                    <table class="table-borderless table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                               <td>{{ $index + 1 }}</td>
<td>{{ $rekod->case_number ? Str::upper($rekod->case_number) : '-' }}</td>
<td>{{ $rekod->fault_type ? Str::upper($rekod->fault_type) : '-' }}</td>
<td>
    {{ $rekod->fault_date ? \Carbon\Carbon::parse($rekod->fault_date)->format('d/m/Y') : '-' }}
</td>
<td>{{ $rekod->method ? Str::upper($rekod->method) : '-' }}</td>
<td>{{ $rekod->method_section ? Str::upper($rekod->method_section) : '-' }}</td>
<td>{{ $rekod->decision ? Str::upper($rekod->decision) : '-' }}</td>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body"
                                                                                    style="height: 80vh;">
                                                                                    <iframe
                                                                                        src="{{ route('baharuKadNelayan.sokonganUlasanR-09.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                        style="width: 100%; height: 100%;"
                                            ...
                                            <div class="tab-pane fade" id="content-tab7" role="tabpanel"
                                                ...
                                                <small class="text-muted">
                                                    Bahagian ini memaparkan maklumat berkaitan hasil tangkapan serta lokasi dan kuantiti pendaratan ikan yang telah direkodkan.
                                                </small>
                                    ...
                                    @endforelse
                                            ...
                                            <div class="tab-pane fade" id="content-tab8" role="tabpanel"
                                                ...
                                                <h5 class="fw-bold mb-0">Status Permohonan</h5>
                                                    <small class="text-muted">
                                                        Status semasa permohonan , termasuk tarikh penghantaran, semakan, dan kelulusan.
                                                    </small>
                                           ...
                                           <div class="tab-pane fade" id="content-tab9" role="tabpanel" aria-labelledby="tab10-link">
                                                ...
                                                <form method="POST" id="submitSemakan"
                                                    action="{{ route('baharuKadNelayan.sokonganUlasanR-09.store', $application->id) }}">
                                                    @csrf
                                                      ...
                                                      <!-- Semakan -->
                                                        <div class="card-header mb-3 pl-0">
                                                            ...
                                                            <small class="text-muted">
                                                                Bahagian ini membolehkan pegawai membuat semakan ke atas borang dengan menandakan status sama ada
                                                                lengkap atau tidak lengkap, memberi sokongan atau tidak, serta menambah ulasan bagi tindakan lanjut.
                                                            </small>
                                                        </div>

                                                        <div class="  mb-3 pl-0">
                                                            <label class="fw-bold mb-0">Semakan</label>
                                                            <br>
                                                        ...
                                                        <!-- Sokongan (conditional) -->
                                                        <div id="sokonganSection" style="display: none;">
                                                            <div class="  mb-3 pl-0">
                                                                <label class="fw-bold mb-0">Sokongan</label>
                                                                <br>
                                                                <small class="text-muted">Sila nyatakan sokongan terhadap
                                                                    permohonan ini</small>
                                                            </div>
                                                            <div class="d-flex gap-4 mb-4">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="support_flag" id="sokong" value="1">
                                                                    <label class="form-check-label" for="sokong">Sokong</label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="support_flag" id="tidak_sokong" value="0">
                                                                    <label class="form-check-label" for="tidak_sokong">Tidak
                                                                        Sokong</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <!-- Ulasan -->
                                                        <div class=" mb-3 pl-0">
                                                            <label class="fw-bold mb-0">Ulasan</label>
                                                            <br>
                                                            <small class="text-muted">Sila berikan ulasan terhadap semakan
                                                                dan sokongan ini</small>
                                                        </div>
  ...
  @push('scripts')
                                                <script>
                                                    $(document).ready(function () {
                                                                                                                $('input[name="review_flag"]').on('change', function () {
                                                                                                                    if ($(this).val() === '1') {
                                                                                                                        $('#sokonganSection').slideDown();
                                                                                                                    } else {
                                                                                                                        $('#sokonganSection').slideUp();
                                                                                                                        $('input[name="support_flag"]').prop('checked', false);
                                                                                                                    }
                                                                                                                });
                                                                                                            });
                                                </script>
   ...
   <script>
    ...
    const switchTab = (direction) => {
        ...
        sessionStorage.setItem('lastTab', currentTab); // save tab state
        toggleButtons();
    };
