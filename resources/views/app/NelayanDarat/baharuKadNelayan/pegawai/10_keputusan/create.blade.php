                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/baharuKadNelayan/keputusanR-09">{{
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe src="{{ route('baharuKadNelayan.keputusanR-09.viewDocument', [
                                                                                                    'index' => $index,
        ...
        @if (!empty($ins->$field))
            <div class="col-12">
                ...
                <div class="border p-2 bg-light text-center">
                    <img
                        src="{{ route('baharuKadNelayan.keputusanR-09.viewInspectionDocument', ['id' => $ins->id, 'field' => $field]) }}"
                        alt="{{ $label }}"
                                            ...
                                            <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                                ...
                                                {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <form method="POST"
                                                            action="{{ route('baharuKadNelayan.keputusanR-09.updateFault', ['application_id' => $application->id]) }}"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body"
                                                                                    style="height: 80vh;">
                                                                                    <iframe
                                                                                        src="{{ route('baharuKadNelayan.keputusanR-09.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                        style="width: 100%; height: 100%;"
                                    ...
                                    @endforelse
                                           ...
                                           <div class="tab-pane fade" id="content-tab9" role="tabpanel" aria-labelledby="tab10-link">
                                                ...
                                                <form method="POST" id="submitSemakan"
                                                    action="{{ route('baharuKadNelayan.keputusanR-09.store', $application->id) }}">
                                                    @csrf
                                                        ...
                                                        <div class="  mb-3 ">
                                                            ...
                                                            <small class="text-muted">
                                                                ...
                                                                lengkap atau tidak lengkap, memberi keputusan lulus atau tidak lulus, serta menambah ulasan bagi
                                                                tindakan lanjut.
                                                            </small>
                                                            <hr>
                                                        </div>
                                                        ...
                                                        <!-- Semakan -->
                                                        <div class="  mb-3 pl-0">
                                                            <label class="fw-bold mb-0">Semakan</label> <br>
                                                        ...
                                                        <div id="keputusanSection" style="display: none;">
                                                            <div class=" mb-3 pl-0">
                                                                <label class="fw-bold mb-0">Keputusan</label> <br>
                                                                <small class="text-muted">Sila nyatakan keputusan terhadap
                                                            ...
                                                            <div class="d-flex gap-4 mb-4">
                                                                ...
                                                                <div class="form-check">
                                                                    ...
                                                                    <label class="form-check-label" for="tidak_lulus">Tidak
                                                                        Lulus</label>
                                                                </div>
                                                            </div>
                                                        </div>
