                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item">
                                <a href="http://127.0.0.1:8000/lebihTahun/permohonan-07">{{
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="content-tab6" role="tabpanel" aria-labelledby="tab6-link">
                                <form method="POST" id="store_tab6"
                                    action="{{ route('lebihTahun.permohonan-07.store_tab6') }}"
                                    ...
                                    <section>
                                        ...
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Perhatian:</strong> Hanya dokumen <strong>Tunjuk Sebab</strong> diperlukan
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a class="btn btn-primary"
                                                    href="{{ route('lebihTahun.permohonan-07.viewDocument', ['type' => 'required', 'index' => $justificationIndex]) }}"
                                                    target="_blank">
