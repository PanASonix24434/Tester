                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/lebihTahun/semakanUlasan-07">{{
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" style="height: 80vh;">
                                                                            <iframe src="{{ route('lebihTahun.semakanUlasan-07.viewDocument', [
                                                                                                    'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('lebihTahun.semakanUlasan-07.viewInspectionDocument', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('lebihTahun.semakanUlasan-07.updateFault', ['application_id' => $application->id]) }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe
                                                                                    src="{{ route('lebihTahun.semakanUlasan-07.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                    style="width: 100%; height: 100%;"
                                        ...
                                        <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                            ...
                                            <form method="POST" id="submitsemakanUlasan"
                                                action="{{ route('lebihTahun.semakanUlasan-07.store', $application->id) }}">
                                                @csrf
                                ...
                                <div class="card-footer">
                                    <div class="d-flex justify-content-end gap-3">
                                        ...
                                        <div class="d-flex gap-3">
                                            ...
                                            <!-- Hantar Button -->
                                            <button id="submitBtn" type="submit" form="submitsemakanUlasan"
