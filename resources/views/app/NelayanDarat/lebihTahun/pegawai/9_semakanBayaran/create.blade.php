                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/lebihTahun/semakanBayaran-07">{{
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" style="height: 80vh;">
                                                                            <iframe src="{{ route('lebihTahun.semakanBayaran-07.viewDocument', [
                                                                                                    'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('lebihTahun.semakanBayaran-07.viewInspectionDocument', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('lebihTahun.semakanBayaran-07.updateFault', ['application_id' => $application->id]) }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe
                                                                                    src="{{ route('lebihTahun.semakanBayaran-07.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                    style="width: 100%; height: 100%;"
                                        ...
                                        <!---->
                                            ...
                                            <div class="tab-pane fade  " id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="submitPermohonan"
                                                    action="{{ route('lebihTahun.semakanBayaran-07.store', $application->id) }}"
                                                    ...
                                                    <div class="row mb-4">
                                                        <div class="col-md-4 mb-3">
                                                            <label class="fw-bold">No. Resit</label>
                                                            <input type="text" class="form-control"
                                                                value="{{ $receipt->receipt_number }}" readonly>
                                                        </div>
                                                        <div class="col-md-4 mb-3">
                                                            <label class="fw-bold">Tarikh Resit</label>
                                                            <input type="text" class="form-control"
                                                                value="{{ \Carbon\Carbon::parse($receipt->payment_date)->format('d-m-Y') }}"
                                                                readonly>
                                                        </div>
                                                        <div class="col-md-4 mb-3">
                                                            <label class="fw-bold">Jumlah Bayaran (RM)</label>
                                                            <input type="text" class="form-control"
                                                    ...
                                                    <div class="mb-4">
                                                        <label class="fw-bold">Resit Pembayaran</label>
                                                        ...
                                                        <div class="modal fade" id="receiptModal" tabindex="-1"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="modal-content p-3">
                                                                    <div class="modal-header">
                                                                        <label class="modal-title" id="receiptModalLabel">
                                                                            Resit
                                                                            Pembayaran</label> <br>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                    ...
                                                                    <div class="modal-body p-0" style="height: 80vh;">
                                                                        <iframe
                                                                            src="{{ route('lebihTahun.semakanBayaran-07.viewReceipt', ['receipt_id' => $receipt->id]) }}"
                                                                            style="width: 100%; height: 100%;"
                                                                            frameborder="0"></iframe>
                                                                    </div>
                                                                </div>
