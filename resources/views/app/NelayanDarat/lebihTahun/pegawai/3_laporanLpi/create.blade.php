                ...
                <div class="col-md-3 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/lebihTahun/laporanLpi-07">{{
                                    ...
                                    <div class="row table-responsive">
                                        ...
                                        <div class="col-md-6">
                                            <table class="table-borderless table">
                                                <tbody>
                                                    <tr>
                                                        <td class="col-md-3">Jenis laporanLpii</td>
                                                        <td class="col-md-1">:</td>
                                                        <td>
                                                            <input type="text" class="form-control"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="content-tab1" role="tabpanel"
                                                ...
                                                <form id="form-tab1"
                                                    action="{{ route('lebihTahun.laporanLpi-07.storeMaklumatVesel', $application->id) }}"
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="d-flex align-items-center gap-3">
                                                            ...
                                                            <a class="btn btn-primary"
                                                                href="{{ route('lebihTahun.laporanLpi-07.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'overall_image_path']) }}"
                                                                target="_blank">
        ...
        input?.addEventListener('change', function () {
            ...
            if (label) label.textContent = fileName;
                                            ...
                                            <div class="tab-pane fade" id="content-tab2" role="tabpanel"
                                                ...
                                                <form id="form-tab2"
                                                    action="{{ route('lebihTahun.laporanLpi-07.storeMaklumatEnjin', $application->id) }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="mb-4">
                                                            ...
                                                            <div class="d-flex align-items-center gap-3">
                                                                ...
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('lebihTahun.laporanLpi-07.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_image_path']) }}"
                                                                    target="_blank">
                                                                    <i class="fa fa-search"></i>
                                                                </a>
                                                                @endif
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <div class="d-flex align-items-center gap-3">
                                                                ...
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('lebihTahun.laporanLpi-07.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'engine_number_image_path']) }}"
                                                                    target="_blank">
                                                                    <i class="fa fa-search"></i>
                                                                </a>
                                                                @endif
                                            ...
                                            <div class="tab-pane fade" id="content-tab3" role="tabpanel"
                                                ...
                                                <form id="form-tab3"
                                                    action="{{ route('lebihTahun.laporanLpi-07.storePeralatanKeselamatan', $application->id) }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="d-flex align-items-center gap-3">
                                                            ...
                                                            <a class="btn btn-primary"
                                                                href="{{ route('lebihTahun.laporanLpi-07.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'safety_jacket_image_path']) }}"
                                                                target="_blank">
                                                                <i class="fa fa-search"></i>
                                                            </a>
                                                            @endif
        ...
        input?.addEventListener('change', function () {
            ...
            if (label) label.textContent = fileName;
                                            ...
                                            <div class="tab-pane fade" id="content-tab4" role="tabpanel"
                                                ...
                                                <form id="form-tab4"
                                                    action="{{ route('lebihTahun.laporanLpi-07.storePeralatanMenangkapIkan', $application->id) }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
...
<section>
    ...
    <div class="col-md-auto text-center">
        ...
        <button type="button" class="btn btn-primary"
            onclick="window.open('{{ route('lebihTahun.laporanLpi-07.viewEquipmentFile', ['id' => $mainInspectionEquipment[0]->id, 'type' => 'UTAMA']) }}', '_blank')">
...
@if (!empty($item->file_path ?? null))
    <div class="col-md-auto text-center">
        <label class="form-label d-none d-md-block">&nbsp;</label>
        <button type="button" class="btn btn-primary"
            onclick="window.open('{{ route('lebihTahun.laporanLpi-07.viewEquipmentFile', ['id' => $item->id, 'type' => 'TAMBAHAN']) }}', '_blank')">
            <i class="fa fa-search p-1"></i>
        </button>
    </div>
@endif
                ...
                if (e.target.closest('.remove-item-btn')) {
                    e.target.closest('.row').remove();
                                        ...
                                        <div class="tab-pane fade" id="content-tab5" role="tabpanel"
                                            ...
                                            <form id="form-tab5"
                                                action="{{ route('lebihTahun.laporanLpi-07.storePengesahanPemeriksaan', $application->id) }}"
                                                method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <a class="btn btn-primary"
                                                            href="{{ route('lebihTahun.laporanLpi-07.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'attendance_form_path']) }}"
                                                            target="_blank">
                                                            <i class="fa fa-search"></i>
                                                        </a>
                                                        @endif
            ...
            if (label) label.textContent = fileName;
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <a class="btn btn-primary"
                                                            href="{{ route('lebihTahun.laporanLpi-07.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'vessel_image_path']) }}"
                                                            target="_blank">
                                                            <i class="fa fa-search"></i>
                                                        </a>
            ...
            if (label) label.textContent = fileName;
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <a class="btn btn-primary"
                                                            href="{{ route('lebihTahun.laporanLpi-07.viewInspectionDocument', ['id' => $inspection->id, 'field' => 'inspector_owner_image_path']) }}"
                                                            target="_blank">
                                                            <i class="fa fa-search"></i>
                                                        </a>
                                                        @endif
                            ...
                            <div class="d-flex justify-content-end gap-3">
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <form id="form-submit-final" onsubmit="sessionStorage.removeItem('lastSavedTab')"
                                        action="{{ route('lebihTahun.laporanLpi-07.store', $application->id) }}"
                                        method="POST">
                                        @csrf
                                    </form>
