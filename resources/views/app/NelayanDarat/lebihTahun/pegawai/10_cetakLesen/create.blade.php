...
<div id="app-content">
                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/lebihTahun/cetakLesen-07">{{
                                            ...
                                            {{-- <div class="tab-pane fade p-4" id="content-tab4" role="tabpanel"
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <small class="text-muted">
                                                        ...
                                                        dimiliki atau digunakan oleh pemohon,
                                                    ...
                                                    <table class="table table-borderless">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="col-md-1 text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff?->transportation
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="col-md-1 text-center">:</td>
                                                                <td>{{ $useVesselOff ?
                                                                    ($vesselInfoOff?->vessel_registration_number ?? '-')
                                                                    :
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ?
                                                                    ($vesselInfoOff?->hull?->hull_type ?? '-') :
                                                                    ($vesselInfo['hull_type'] ??
                                                                    '-') }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Panjang (m)</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff?->hull?->length
                                                                    ?? '-') : ($vesselInfo['length'] ?? '-') }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Lebar (m)</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff?->hull?->width ??
                                                                    '-') : ($vesselInfo['width'] ?? '-') }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Kedalaman (m)</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff?->hull?->depth ??
                                                                    '-') : ($vesselInfo['depth'] ?? '-') }}
                                                                </td>
                                                            </tr>
                                                            ...
                                                            @php
                                                            $hasEngine = $useVesselOff ? ($vesselInfoOff?->engine ? true
                                                            : false) : (($vesselInfo['has_engine'] ??
                                                            'no') === 'yes');
                                                            @endphp
                                                            ...
                                                            <tr>
                                                                <td>Model Enjin</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ? ($vesselInfoOff->engine->model ??
                                                                    '-') : ($vesselInfo['engine_model'] ?? '-')
                                                                    }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Kuasa Kuda (KK)</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ?
                                                                    ($vesselInfoOff->engine->horsepower ?? '-') :
                                                                    ($vesselInfo['horsepower'] ??
                                                                    '-') }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Jenama Enjin</td>
                                                                <td class="text-center">:</td>
                                                                <td>{{ $useVesselOff ?
                                                                    ($vesselInfoOff->engine->engine_brand ?? '-') :
                                                                    ($vesselInfo['engine_brand']
                                                                    ?? '-') }}</td>
                                                            </tr>
                                                            @endif
                                                </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body" style="height: 80vh;">
                                                                            <iframe src="{{ route('lebihTahun.cetakLesen-07.viewDocument', [
                                                                                                    'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('lebihTahun.cetakLesen-07.viewInspectionDocument', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('lebihTahun.cetakLesen-07.updateFault', ['application_id' => $application->id]) }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="height: 80vh;">
                                                                                <iframe
                                                                                    src="{{ route('lebihTahun.cetakLesen-07.viewFaultDocument', ['application_id' => $application->id, 'record_id' => $rekod->id]) }}"
                                                                                    style="width: 100%; height: 100%;"
                                        ...
                                        <!---->
                                            ...
                                            <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="submitPermohonan"
                                                    action="{{ route('lebihTahun.cetakLesen-07.store', $application->id) }}">
                                                    @csrf
    ...
    fetch("{{ route('lebihTahun.cetakLesen-07.semakPin', $application->id) }}", {
        method: "POST",
        headers: {
