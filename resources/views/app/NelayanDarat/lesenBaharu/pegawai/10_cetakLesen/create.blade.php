...
<div id="app-content">
                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/lesenBaharu/cetakLesen-01">{{
                                            ...
                                            <table class="table-borderless table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control"
                                                                value="{{ $vessel->registration_number ?? 'TIADA NO. PENDAFTARAN' }}"
                                                                readonly>
                                                        </td>
                                                    </tr>
                                                </tbody>
        ...
        strtoupper(
            ...
            ->implode(', ')
                                                        ...
                                                        <tr>
                                                            <td>Daerah</td>
                                                            <td class="text-center">:</td>
                                                            <td>{{ $userDetail->district_name ?? 'TIDAK DIKETAHUI' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Negeri</td>
                                                            <td class="text-center">:</td>
                                                            <td>{{ $userDetail->state_name?? 'TIDAK DIKETAHUI' }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
        ...
        strtoupper(
            ...
            ->implode(', ')
                                                        ...
                                                        <tr>
                                                            <td>Daerah</td>
                                                            <td class="text-center">:</td>
                                                            <td>{{ strtoupper( $userDetail->secondary_district_name ?? 'TIDAK DIKETAHUI')}}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Negeri</td>
                                                            <td class="text-center">:</td>
                                                            <td>{{  strtoupper($userDetail->secondary_state_name ?? 'TIDAK DIKETAHUI')  }}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
    ...
    <table class="table-borderless table">
        <tbody>
            <tr>
                ...
                <td class="col-md-1 text-center">:</td>
                <td>{{ strtoupper($jettyOff->state->name ?? 'TIDAK DIKETAHUI') }}</td>
            </tr>
            <tr>
                <td class="col-md-4">Daerah</td>
                <td class="col-md-1 text-center">:</td>
                <td>{{ strtoupper($jettyOff->district->name ?? 'TIDAK DIKETAHUI') }}</td>
            </tr>
            <tr>
                <td class="col-md-4">Nama Sungai/Tasik</td>
                <td class="col-md-1 text-center">:</td>
                <td>{{ strtoupper($jettyOff->river->name ?? 'TIDAK DIKETAHUI') }}</td>
            </tr>
            <tr>
                <td class="col-md-4">Pangkalan</td>
                <td class="col-md-1 text-center">:</td>
                <td>{{ strtoupper($jettyOff->jetty->name ?? 'TIDAK DIKETAHUI') }}</td>
            </tr>
        </tbody>
    </table>
    <br>
   ...
   onclick="window.open('{{ route('lesenBaharu.cetakLesen-01.viewEquipment', ['id' => $equipment->id]) }}', 'popupWindow', 'width=1200,height=800,scrollbars=yes'); return false;">
   <i class="fa fa-search"></i>
    ...
    <tbody>
        ...
        <tr>
         ...
         <td>{{ strtoupper($doc['title'] ?? 'TIDAK DIKETAHUI') }}</td>

            <td>
                @if (!empty($doc['file_path']))
                  <a class="btn btn-primary"
    onclick="window.open(
        '{{ route('lesenBaharu.cetakLesen-01.viewTempDocument', [
            'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('lesenBaharu.cetakLesen-01.viewInspection', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('lesenBaharu.cetakLesen-01.createFaultRecord', ['application_id' => $application->id]) }}"
    ...
    <tbody>
        @forelse ($faultRecord as $index => $rekod)
            <tr>
                ...
                <td>{{ strtoupper($rekod->fault_type ?? '-') }}</td>
                <td>{{ optional($rekod->fault_date)->format('d/m/Y') ?? '-' }}</td>
                <td>{{ $rekod->method ?? '-' }}</td>
                ...
                <td>
                    @if (!empty($rekod->document_path))
                      <a href="#" class="btn btn-primary"
   onclick="window.open('{{ route('lesenBaharu.cetakLesen-01.viewFaultRecord', ['id' => $rekod->id]) }}', 'faultRecordWindow', 'width=1200,height=800,scrollbars=yes'); return false;"
   title="Lihat dokumen">
    <i class="fa fa-search"></i>
</a>
        ...
        @empty
            <tr>
                <td class="text-center" colspan="8">Tiada rekod kesalahan direkodkan.</td>
            </tr>
        @endforelse
    </tbody>
</table>
                                        ...
                                        <!---->
                                            ...
                                            <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="submitSemakan"
                                                    action="{{ route('lesenBaharu.cetakLesen-01.store', $application->id) }}">
                                                    @csrf
    ...
    fetch("{{ route('lesenBaharu.cetakLesen-01.semakPin', $application->id) }}", {
        method: "POST",
        headers: {
