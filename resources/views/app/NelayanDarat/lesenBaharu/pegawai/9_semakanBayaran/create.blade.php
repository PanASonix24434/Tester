                                        ...
                                        <!---->
                                            ...
                                            <div class="tab-pane fade  " id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="submitSemakan"
                                                    action="{{ route('lesenBaharu.semakanBayaran-01.store', $application->id) }}"
                                                    enctype="multipart/form-data">
                                                    @csrf

                                                    <!-- Maklumat Resit -->
                                                    <div class="card-header mb-3 pl-0">
                                                        <label class="fw-bold mb-0">Maklumat Resit Pembayaran</label> <br>
                                                        <small class="text-muted">Maklumat resit dan item yang telah
                                                            disimpan</small>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            <label class="form-label">Tarikh Resit</label>
                                                            <input type="text" class="form-control"
                                                                value="{{ \Carbon\Carbon::parse($receipt->payment_date)->format('d-m-Y') }}"
                                                                readonly>
                                                        </div>
                                                        <div class="col-md-4 mb-3">
                                                            <label class="form-label">Jumlah Bayaran (RM)</label>
                                                            <input type="text" class="form-control"
                                                                value="RM {{ number_format($receipt->amount, 2) }}"
                                                                readonly>
                                                        </div>
                                                    </div>

                                                   @if (!empty($receipt) && $receipt->uploaded_file_path)
    <div class="mb-4">
        <label class="form-label d-block">Resit Pembayaran</label>
        <button type="button" class="btn btn-primary col-md"
            onclick="window.open('{{ route('lesenBaharu.semakanBayaran-01.viewReceipt', ['receipt_id' => $receipt->id]) }}',
                                'resitWindow',
                                'width=1000,height=800,scrollbars=yes,resizable=yes')">
            <i class="fa fa-search me-1"></i> Lihat
        </button>
    </div>
@endif
                                                    ...
                                                    <!-- Senarai Item Resit -->
                                                    <div class=" mb-3 pl-0">
                                                        <label class="fw-bold mb-0">Item Dalam Resit</label><br>
                                                        <small class="text-muted">Item yang direkodkan dalam resit
                                                            pembayaran</small>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control"
                                                                value="RM {{ number_format($item->price, 2) }}"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    @endforeach
                                                    @else
                                                    <div class="alert alert-warning">Tiada maklumat resit dijumpai.
                                                    </div>
                                                    @endif
