...
<div id="app-content">
                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/lesenBaharu/keputusan-01">{{
   ...
   onclick="window.open('{{ route('lesenBaharu.keputusan-01.viewEquipment', ['id' => $equipment->id]) }}', 'popupWindow', 'width=1200,height=800,scrollbars=yes'); return false;">
   ...
   onclick="window.open(
        '{{ route('lesenBaharu.keputusan-01.viewTempDocument', [
            'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('lesenBaharu.keputusan-01.viewInspection', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('lesenBaharu.keputusan-01.createFaultRecord', ['application_id' => $application->id]) }}"
            ...
            <tr>
                ...
                <td>
                    @if (!empty($rekod->document_path))
                       <a class="btn btn-primary"
   onclick="window.open(
       '{{ route('lesenBaharu.keputusan-01.viewFaultRecord', ['id' => $rekod->id]) }}',
       'faultRecordWindow', // A unique name for this window/tab
       'width=1200,height=800,scrollbars=yes,resizable=yes' // Customize dimensions and features
   ); return false;"
   href="javascript:void(0);"
   title="Lihat dokumen">
   <i class="fa fa-search"></i>
                                        ...
                                        <!---->
                                            ...
                                            <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="submitPermohonan"
                                                    action="{{ route('lesenBaharu.keputusan-01.store', $application->id) }}">
                                                    @csrf

                                                    <div class="card-header mb-3 pl-0">
                                                    <h5 class="fw-bold mb-0">Tindakan</h5>
                                                    <small class="text-muted">
                                                        Bahagian ini membolehkan pegawai membuat semakan ke atas borang dengan menandakan status sama ada lengkap atau tidak lengkap, memberi keputusan lulus atau tidak lulus, serta menambah ulasan bagi tindakan lanjut.
                                                    </small>
                                                </div>
                                                    ...
                                                    <div id="keputusanSection" style="display: none;">
                                                        ...
                                                        <div class="d-flex gap-4 mb-4">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="decision_flag" id="lulus" value="1">
                                                                <label class="form-check-label"
                                                                    for="lulus">Lulus</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="decision_flag" id="tidak_lulus" value="0">
