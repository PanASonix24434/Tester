...
<div id="app-content">
                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/lesenBaharu/resitBayaran-01">{{
    ...
    <td>Daerah</td>
    <td class="text-center">:</td>
    <td>{{ Str::upper($userDetail->secondary_district_name ?? 'Tidak Diketahui') }}</td>
</tr>
<tr>
    <td>Negeri</td>
    <td class="text-center">:</td>
    <td>{{ Str::upper($userDetail->secondary_state_name ?? 'Tidak Diketahui') }}</td>
</tr>
                                                    </tbody>
                                                </table>
    ...
    <td>Daerah</td>
    <td class="text-center">:</td>
    <td>{{ Str::upper($userDetail->district_name ?? 'Tidak Diketahui') }}</td>
</tr>
<tr>
    <td>Negeri</td>
    <td class="text-center">:</td>
    <td>{{ Str::upper($userDetail->state_name ?? 'Tidak Diketahui') }}</td>
</tr>
   ...
   onclick="window.open('{{ route('lesenBaharu.resitBayaran-01.viewEquipment', ['id' => $equipment->id]) }}', 'popupWindow', 'width=1200,height=800,scrollbars=yes'); return false;">
   <i class="fa fa-search"></i>
    ...
    onclick="window.open(
        '{{ route('lesenBaharu.resitBayaran-01.viewTempDocument', [
            'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('lesenBaharu.resitBayaran-01.viewInspection', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('lesenBaharu.resitBayaran-01.createFaultRecord', ['application_id' => $application->id]) }}"
            ...
            <tr>
                ...
                <td>
                    @if (!empty($rekod->document_path))
                      <a href="#" class="btn btn-primary"
   onclick="window.open('{{ route('lesenBaharu.resitBayaran-01.viewFaultRecord', ['id' => $rekod->id]) }}', 'faultRecordWindow', 'width=1200,height=800,scrollbars=yes'); return false;"
   title="Lihat dokumen">
    <i class="fa fa-search"></i>
</a>
        ...
        @endforelse
                                        ...
                                        <!---->
                                            ...
                                            <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="storePermohonan" action="{{ route('lesenBaharu.resitBayaran-01.store',
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        <!-- View Button as new window -->
        @if (!empty($receipt->uploaded_file_path))
            <a href="#" class="btn btn-primary"
               onclick="window.open('{{ route('lesenBaharu.resitBayaran-01.viewReceipt', ['receipt_id' => $receipt->id]) }}', 'resitWindow', 'width=1200,height=800,scrollbars=yes'); return false;">
                <i class="fa fa-search"></i>
            </a>
        @endif
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        input.addEventListener('change', function () {
            ...
            label.textContent = fileName;
                                        ...
                                        <!-- Hidden Submit Form -->
                                        <form method="POST" id="submitSemakan" onsubmit="sessionStorage.removeItem('hasSaved')"
                                            action="{{ route('lesenBaharu.resitBayaran-01.submit', $application->id) }}"
                                        ...
                                        <div class="card-footer pl-0 ml-0 pr-0 mr-0 ">
                                            <div class="d-flex justify-content-between align-items-center    ">
                                                ...
                                                <div>
                                                    {{-- <button id="skipTabBtn" type="submit" form="submitSemakan"
    ...
    const switchTab = (direction) => {
        ...
        if (newTab < 1 || newTab > totalTabs) return; // silently stop
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const savedTab = parseInt(sessionStorage.getItem('currentTab'));
        if (savedTab && savedTab >= 1 && savedTab <= totalTabs) {
            currentTab = savedTab;
        }
        ...
        document.getElementById("submitSemakan")?.addEventListener("submit", () => {
