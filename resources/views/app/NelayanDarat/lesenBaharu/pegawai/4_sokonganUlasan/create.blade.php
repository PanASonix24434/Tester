...
<div id="app-content">
                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/lesenBaharu/sokonganUlasan-01">{{
   ...
   onclick="window.open('{{ route('lesenBaharu.sokonganUlasan-01.viewEquipment', ['id' => $equipment->id]) }}', 'popupWindow', 'width=1200,height=800,scrollbars=yes'); return false;">
   <i class="fa fa-search"></i>
    ...
    onclick="window.open(
        '{{ route('lesenBaharu.sokonganUlasan-01.viewTempDocument', [
            'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('lesenBaharu.sokonganUlasan-01.viewInspection', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('lesenBaharu.sokonganUlasan-01.createFaultRecord', ['application_id' => $application->id]) }}"
            ...
            <tr>
                ...
                <td>
                    @if (!empty($rekod->document_path))
                      <a href="#" class="btn btn-primary"
   onclick="window.open('{{ route('lesenBaharu.sokonganUlasan-01.viewFaultRecord', ['id' => $rekod->id]) }}', 'faultRecordWindow', 'width=1200,height=800,scrollbars=yes'); return false;"
   title="Lihat dokumen">
    <i class="fa fa-search"></i>
</a>
                                        ...
                                        <!---->
                                            ...
                                            <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                ...
                                                <form method="POST" id="submitSemakan"
                                                    action="{{ route('lesenBaharu.sokonganUlasan-01.store', $application->id) }}">
                                                    @csrf
