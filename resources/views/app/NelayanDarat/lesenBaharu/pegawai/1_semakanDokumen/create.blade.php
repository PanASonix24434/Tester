...
<div id="app-content">
                ...
                <div class="col-md-6 align-content-center">
                    ...
                    <nav aria-label="breadcrumb" class="d-flex justify-content-end">
                        <ol class="breadcrumb text-center">
                            <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/lesenBaharu/semakanBayaran-01">{{
        ...
        strtoupper(
            ...
            ->implode(', ')
                                                        ...
                                                        <tr>
                                                            <td>Daerah</td>
                                                            <td class="text-center">:</td>
                                                            <td>{{ strtoupper($userDetail->district_name ?? 'TIDAK DIKETAHUI')  }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Negeri</td>
                                                            <td class="text-center">:</td>
                                                            <td>{{ strtoupper($userDetail->state_name?? 'TIDAK DIKETAHUI') }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
   ...
   onclick="window.open('{{ route('lesenBaharu.semakanBayaran-01.viewEquipment', ['id' => $equipment->id]) }}', 'popupWindow', 'width=1200,height=800,scrollbars=yes'); return false;">
   <i class="fa fa-search"></i>
    ...
    onclick="window.open(
        '{{ route('lesenBaharu.semakanBayaran-01.viewTempDocument', [
            'index' => $index,
                                                                            ...
                                                                            <div class="row g-3">
                                                                                ...
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ route('lesenBaharu.semakanBayaran-01.viewInspection', ['id' => $ins->id, 'field' => $field]) }}"
                                                                                            alt="{{ $label }}"
                                                                                            class="img-fluid"
                                        ...
                                        <div class="tab-pane fade p-4" id="content-tab6" role="tabpanel"
                                            ...
                                            {{-- <div class="modal fade" id="rekodKesalahanModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <form method="POST"
                                                        action="{{ route('lesenBaharu.semakanBayaran-01.createFaultRecord', ['application_id' => $application->id]) }}"
            ...
            <tr>
                ...
                <td>
                    @if (!empty($rekod->document_path))
                      <a href="#" class="btn btn-primary"
   onclick="window.open('{{ route('lesenBaharu.semakanBayaran-01.viewFaultRecord', ['id' => $rekod->id]) }}', 'faultRecordWindow', 'width=1200,height=800,scrollbars=yes'); return false;"
   title="Lihat dokumen">
    <i class="fa fa-search"></i>
</a>
        ...
        @endforelse
                                        ...
                                        <!---->
                                            ...
                                            <div class="tab-pane fade" id="content-tab9" role="tabpanel"
                                                aria-labelledby="tab9-link">
                                                <form method="POST" id="submitSemakan"
                                                    action="{{ route('lesenBaharu.semakanDokumen-01.store', $application->id) }}">
                                                    @csrf
                                                    ...
                                                    <small class="text-muted">
                                                        Bahagian ini membolehkan anda memilih dan mengemaskini status semakan dokumen permohonan yang telah diterima.
                                                    </small>

                                                    </div>

                                                    <div class="  mb-3 pl-0">
                                                            <label class="fw-bold mb-0">Semakan <span class="text-danger">*</span></label>
                                                            <br>
                                                            <small class="text-muted">Sila pilih semakan untuk permohonan ini</small>
                                                        </div>

                                                    <div class="d-flex mb-4 gap-4">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="review_flag" id="semakan_1" value="1">
                                                            <label class="form-check-label"
                                                                for="semakan_1">Lengkap</label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                name="review_flag" id="semakan_2" value="0">
                                                            <label class="form-check-label" for="semakan_2">Tidak
                                                                Lengkap</label>
                                                        </div>
                                                    </div>

                                                    <!-- Cadang Tarikh Pemeriksaan Vesel -->
                                                    <div id="inspectionDateSection" style="display: none;">
                                                        <div class="   mb-3 pl-0">
                                                            <label class="fw-bold mb-0">Cadang Tarikh Pemeriksaan Vesel <span class="text-danger">*</span>
                                                            </label>
                                                            <br>
                                                            <small class="text-muted">Masukkan tarikh cadangan untuk
                                                                pemeriksaan vesel</small>
                                                        </div>

                                                        <input type="date" name="inspection_date" id="dateCadang"
                                                            class="form-control mb-4">
                                                    </div>

                                                    <!-- Ulasan -->
                                                    <div class="  mb-3 pl-0">
                                                        <label class="fw-bold mb-0">Ulasan  <span class="text-danger">*</span></label> <br>
                                                        <small class="text-muted">Sila nyatakan ulasan berkaitan dengan
                                                            semakan ini</small>
                                                    </div>
                                            ...
                                            <script>
                                                document.addEventListener('DOMContentLoaded', function () {
                                                    const isStillValid = @json($isStillValid); // e.g. true or false

                                                    // console.log('Inspection Valid:', isStillValid);

                                                    $('input[name="review_flag"]').on('change', function () {
                                                        const selected = $(this).val();

                                                        // If user selects "Lengkap"
                                                        if (selected === '1') {
                                                            // Show only if inspection is EXPIRED
                                                            if (!isStillValid) {
