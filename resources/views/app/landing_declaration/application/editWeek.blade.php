        ...
        <div class="app-content-area">
            <div class="container-fluid">
                ...
                <ul class="nav nav-tabs" id="custom-content-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="custom-content-a-tab" data-toggle="pill" href="#custom-content-a" role="tab" aria-controls="custom-content-a" aria-selected="true">Maklumat Aktiviti</a>
                    </li>
                    <li class="nav-item">
                                ...
                                <div class="card-body">
                                                ...
                                                <tbody>
                                                    @foreach ( $landingInfos as $li )
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if ($row > 0)
                                                                <td>
                                                                    ...
                                                                    <form method="post" action="{{ route('landingdeclaration.application.deleteActivity',$landingActivities[0]->id) }}"> 
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <a href="{{ route('landingdeclaration.application.editWeekEditActivity', $landingActivities[0]->id) }}" class="btn btn-warning btn-sm" title="Kemaskini"><i class="fas fa-edit"></i></a>
                                                                        <button type="submit" onclick="return confirm($('<span>Padam Aktiviti?</span>').text())" class="btn btn-danger btn-sm" title="Padam"><i class="fas fa-trash"></i>
                                                                    </form>
                                                                </td>
                                                            ...
                                                            @else
                                                                <td colspan="7">
                                                                    <a href="{{ route('landingdeclaration.application.editWeekAddActivity', $li->id) }}" class="btn btn-secondary btn-sm" title="tambah"><i class="fas fa-plus"></i></a>
                                                                </td>
                                                            @endif
                                                        </tr>
                                                        @if ($row>0)
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <form method="post" action="{{ route('landingdeclaration.application.deleteActivity',$landingActivities[$i]->id) }}"> 
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <a href="{{ route('landingdeclaration.application.editWeekEditActivity', $landingActivities[$i]->id) }}" class="btn btn-warning btn-sm" title="Kemaskini"><i class="fas fa-edit"></i></a>
                                                                            <button type="submit" onclick="return confirm($('<span>Padam Aktiviti?</span>').text())" class="btn btn-danger btn-sm" title="Padam"><i class="fas fa-trash"></i>
                                                                        </form>
                                                                    </td>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                            <a href="{{ route('landingdeclaration.application.edit',$app->landing_declare_monthly_id) }}" class="btn btn-dark btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                            <a href="{{ route('landingdeclaration.application.editWeekB',$app->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-arrow-right"></i> Seterusnya</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
