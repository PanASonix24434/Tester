                                                ...
                                                <tbody>
                                                    @foreach ( $landingInfos as $li )
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if ($row > 0)
                                                                @php
                                                                    $activitySpecies = $landingSpecies->where('landing_info_activity_id',$landingInfoActivites[0]->id);
                                                                ...
                                                                @if ($row3 > 0)
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="3">
                                                                            <a href="{{ route('landingdeclaration.application.editDAddSpecies', $landingInfoActivites[0]->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                @else
                                                                    <td colspan="3">
                                                        ...
                                                        @if ($row>0)
                                                            @for ( $i=1;$i<$row;$i++ )
                                                                @php
                                                                    $activitySpecies = $landingSpecies->where('landing_info_activity_id',$landingInfoActivites[$i]->id);
                                                                    $row3 = $activitySpecies->count();
                                                                @endphp
                                                                <tr >
                                                                    <td rowspan="{{ $row3 > 0 ? $row3+1 : 1 }}">
                                                                    ...
                                                                    @if ($row3 > 0)
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="3">
                                                                                <a href="{{ route('landingdeclaration.application.editDAddSpecies', $landingInfoActivites[$i]->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                    @else
                                                                        <td colspan="3">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                ...
                                                <a href="{{ route('landingdeclaration.application.editE',$app->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-arrow-right"></i> Seterusnya</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
