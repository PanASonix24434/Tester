        ...
        <div class="app-content-area">
            <div class="container-fluid">
                ...
                <ul class="nav nav-tabs" id="custom-content-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link disabled" href="#" role="tab" aria-selected="false">Maklumat Nelayan Darat</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card mb-4">
                                <div class="card-header bg-primary">
                                    <h4 class="mb-0" style="color:white;">Maklumat Kawasan Penangkapan Ikan</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                                ...
                                                <tbody>
                                                    @foreach ( $landingInfos as $li )
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if ($row > 0)
                                                                <td>
                                                                    ...
                                                                    <form method="post" action="{{ route('landingdeclaration.application.deleteActivity',$landingActivities[0]->id) }}"> 
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <a href="{{ route('landingdeclaration.application.editWeekEditActivity', $landingActivities[0]->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                                            ...
                                                            @else
                                                                <td colspan="7">
                                                                    <a href="{{ route('landingdeclaration.application.editBAddActivity', $li->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i></a>
                                                                </td>
                                                            @endif
                                                        </tr>
                                                        @if ($row>0)
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <form method="post" action="{{ route('landingdeclaration.application.deleteActivity',$landingActivities[$i]->id) }}"> 
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <a href="{{ route('landingdeclaration.application.editWeekEditActivity', $landingActivities[$i]->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                                                            <button type="submit" onclick="return confirm($('<span>Padam Aktiviti?</span>').text())" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>
                                                                        </form>
                                                                    </td>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                ...
                                                <a href="{{ route('landingdeclaration.application.editC',$app->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-arrow-right"></i> Seterusnya</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
