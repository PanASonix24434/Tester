                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form id="form" method="POST" action="{{ route('landingdeclaration.application.updateWeekAdd',$landingInfo->id) }}">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="selEquipment">Peralatan : <span style="color:red;">*</span></label>
                                                    <input class="form-control" type="text" id="selEquipment" name="selEquipment" required>
                                                </div>
                                            </div>
                                            --}}
                                        </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            $('#selDistrict').append('<option value="' + key + '">' + value.toUpperCase() + '</option>');
                        });
