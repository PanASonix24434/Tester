        ...
        <div class="app-content-area">
            <div class="container-fluid">
                ...
                <ul class="nav nav-tabs" id="custom-content-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="pill" href="#" role="tab" aria-selected="true">Maklumat Dokumen</a>
                    </li>
                    <!-- <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data" action="{{ route('landingdeclaration.application.updateD',$app->id) }}">
                                        @csrf
                                        <div class="row">
                                            <div class="col-sm-6">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                    <a href="{{ route('landingdeclaration.application.edit',$app->id) }}" class="btn btn-dark btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
