        ...
        <div class="app-content-area">
            <div class="container-fluid">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="content-b-tab" data-bs-toggle="tab" href="#content-b" role="tab"
                        aria-controls="content-b" aria-selected="false">Ringkasan Maklumat</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="content-c-tab" data-bs-toggle="tab" href="#content-c" role="tab"
                        aria-controls="content-c" aria-selected="false">Maklumat Aktiviti</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content p-4" id="tabContent">
                    <div class="tab-pane fade show active" id="content-b" role="tabpanel" aria-labelledby="content-b-tab">
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                <a href="{{ route('landingdeclaration.application.show', $app->landing_declare_monthly_id) }}" class="btn btn-dark btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
