        ...
        <div class="app-content-area">
            <div class="container-fluid">
                ...
                <ul class="nav nav-tabs" id="custom-content-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link disabled" id="custom-content-b-tab" href="#" role="tab" aria-controls="custom-content-b" aria-selected="false">Waktu Pendaratan</a>
                    </li>
                    <li class="nav-item">
                ...
                <br />
                <div>
                    <form method="POST" action="{{ route('landingdeclaration.application.store') }}">
                        @csrf
                        <!-- row -->
                        <div class="row">
                            <div class="col-12">
