                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @if (!$app->isEmpty())
                                            @foreach ($app as $a)
                                                @php
                                                    $weekCount = App\Models\LandingDeclaration\LandingDeclaration::getNumberOfWeekInMonth($a->year,$a->month);
                                                @endphp
                                                <tr>
                                                    <td>{{ $a->name }}</td>
                                                    <td>{{ $a->username }}</td>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('landinghelper.exportExcel',['userId'=>$a->user_id, 'year'=>$a->year, 'month'=>$a->month]) }}" class="btn btn-sm btn-info" title="Cetak">
                                                            <i class="fas fa-print"></i>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('landingdeclaration.check.show', $a->id) }}" class="btn btn-sm btn-primary" title="Lihat">
