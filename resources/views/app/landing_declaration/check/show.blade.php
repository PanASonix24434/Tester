                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-primary">
                                <h4 class="mb-0" style="color:white;">Semakan Daerah</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="tab-content p-4" id="tabContent">
                                        <div class="tab-pane fade show active" id="application" role="tabpanel" aria-labelledby="application-tab">
                                                            ...
                                                            @if (!$apps->isEmpty())
                                                                @foreach ($apps as $app)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="{{ route('landingdeclaration.check.showWeek',$app->id) }}" class="btn btn-sm btn-primary" title="Lihat">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 text-lg-center mt-3 mt-lg-0">
                                                    <a href="{{ route('landingdeclaration.check.index') }}" class="btn btn-dark btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        ...
                                        <div class="tab-pane fade" id="doc" role="tabpanel" aria-labelledby="doc-tab">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 text-lg-center mt-3 mt-lg-0">
                                                    <a class="btn btn-dark btn-sm next-tab-btn" data-next-tab="summary-tab"><i class="fas fa-arrow-left"></i> Kembali</a>
                                        ...
                                        <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                            <form method="POST" action="{{ route('landingdeclaration.check.update',['id'=>$id,'year'=>$monthly->year,'month'=>$monthly->month]) }}">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="applicationStatus" id="supported" value="supported" {{ old('applicationStatus') == 'supported' ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="supported">Sokong</label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="applicationStatus" id="notSupported" value="notSupported" {{ old('applicationStatus') == 'notSupported' ? 'checked' : '' }}>
                                                            <label class="form-check-label" for="notSupported">Tidak Sokong</label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="applicationStatus" id="incomplete" value="incomplete" {{ old('applicationStatus') == 'incomplete' ? 'checked' : '' }}>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div>
                                                            <label for="remark" class="form-label">Ulasan:</label>
                                                            <textarea class="form-control" id="remark" name = "remark" rows="3" {{--@if(!empty ($app->supported_remarks)) disabled @endif--}}>{{ old('remark') }}{{-- $app->supported_remarks ?? '' --}}</textarea>
                                                        </div>
                                                        @error('remark')
                                                            <span id="remark_error" class="text-danger" role="alert">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                        ...
                                                        <button id="btnSubmit" type="submit" class="btn btn-success btn-sm" onclick="return confirm($('<span>Simpan Sokongan ?</span>').text())" {{ old('applicationStatus') != null ? '' : 'disabled' }}>
