            ...
            <div class="container-fluid">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        ...
                        aria-controls="content-a" aria-selected="true">Ringkasan Maklumat</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" id="content-b-tab" data-bs-toggle="tab" href="#content-b" role="tab"
                        aria-controls="content-b" aria-selected="false">Maklumat Kawasan</a>
                    </li>
                    <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                <a href="{{ route('landingdeclaration.check.show', $app->landing_declare_monthly_id) }}" class="btn btn-dark btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
