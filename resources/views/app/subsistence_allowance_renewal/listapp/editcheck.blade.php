                            ...
                            <div class="card-header bg-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="container">
                                            ...
                                            <!-- Semakan Permohonan -->
                                             <form method="POST" enctype="multipart/form-data" action="{{ route('subsistence-allowance-renewal.storeCheck') }}">
                                                @csrf
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-group">
                                                    <label>Maklumat dan Dokumen Permohonan :</label>
                                                    <div>
                                                        <input type="radio" id="lengkap" name="dokumen" value="lengkap" required {{ $subApplication->status_checked == "Permohonan Disemak (LENGKAP)" ? 'checked' : '' }}  @if(!empty ($subApplication->status_checked)) disabled @endif >
                                                        <label for="lengkap">Lengkap</label>
                                                    </div>
                                                    <div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                    <a href="{{ route('subsistence-allowance-renewal.detailsStatus' , $subApplication->id) }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
