        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <!-- Page header -->
                    <div class="mb-8">
                        <h3 class="mb-0">Semakan Pembaharuan </h3>
                    </div>
                </div>
                <div class="col-md-4">
                </div>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('subsistence-allowance.downloadDoc', $item->id) }}" class="text-primary" target="_blank">{{ $item->title }}</a>
                                                        </td>
                                                        {{--
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <form action="{{ route('subsistence-allowance-renewal.verifyDoc') }}" method="POST" class="d-inline">
                                                                    @csrf
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                    <a href="{{ route('subsistence-allowance-renewal.detailseducation', $subApplication->id) }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                                    ...
                                                    <a href="{{ route('subsistence-allowance-renewal.detailsStatus' , $subApplication->id) }}" class="btn btn-dark btn-sm">{{ __('app.next') }} <i class="fas fa-arrow-right"></i> </a>
