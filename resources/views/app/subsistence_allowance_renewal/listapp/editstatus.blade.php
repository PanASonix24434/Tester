                            ...
                            <div class="card-header bg-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs mt-4">
                                        ...
                                        <li class="nav-item"><a class="nav-link active" href="#">Status Permohonan</a></li>
                                    ...
                                    <div class="card p-4 mt-3">
                                        ...
                                        <div class="timeline">
                                            ...
                                            @foreach ($subAuditLog as $item)
                                            <div class="timeline-item">
                                                <div class="timeline-date">{{ \Carbon\Carbon::parse($item->created_at)->translatedFormat('d F Y') }}</div>
                                                <div class="timeline-content">
                                                    <span class="badge bg-success"><i class="fas fa-check-circle"></i> {{ $item->status }}</span>
                                                    <p><strong>Ulasan :</strong> {!! nl2br(e($item->remark)) !!}</p>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                    <a href="{{ route('subsistence-allowance-renewal.detailsdoc', $subApplication->id) }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                                    ...
                                                    <a href="{{ route('subsistence-allowance-renewal.detailscheck' , $subApplication->id) }}" class="btn btn-dark btn-sm">{{ __('app.next') }} <i class="fas fa-arrow-right"></i> </a>
