...
@section('content')
    ...
    <div id="app-content">
        ...
        <div class="container-fluid">
            ...
            <br />
            <div>
                <form method="POST" enctype="multipart/form-data" action="{{ route('subsistence-allowance-renewal.storeWork') }}">
                    @csrf
                <!-- row -->
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-4">
                            <div class="card-header bg-primary">
								<h4 class="mb-0" style="color:white;">B. Butiran Pekerjaan </h4>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label class="col-form-label">12. Status Nelayan :</label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="col-form-label">13. Bilangan Hari Menangkap Ikan sebulan:</label>
                                                <input type="text" class="form-control" id="StatusNelayan" value="Auto" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="col-form-label">Tangkapan Bulanan </label>
                                                <div class="col-md-11 d-flex">
                                                    <span class="input-group-text">RM</span>
                                                    <input type="number" class="form-control" name="fish_monthly" id="fish_monthly" value="Auto" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                       <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="col-form-label">14. Pendapatan Sebulan:</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex">
                                            <span class="input-group-text">RM</span>
                                            <input type="number" class="form-control" name="fishing_income" id="fishing_income" value="{{ $subApplication->tot_incomefish ?? $previousApp->tot_incomefish }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex">
                                            <span class="input-group-text">RM</span>
                                            <input type="number" class="form-control" name="other_income" id="other_income" value="{{ $subApplication->tot_incomeother ?? $previousApp->tot_incomeother }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex">
                                            <span class="input-group-text">RM</span>
                                            <input type="number" class="form-control fw-bold" name="total_income" id="total_income" value="{{ $subApplication->tot_allincome ?? $previousApp->tot_allincome }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                <a href="{{ route('subsistence-allowance-renewal.editformdetails',  $subApplication->id) }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
