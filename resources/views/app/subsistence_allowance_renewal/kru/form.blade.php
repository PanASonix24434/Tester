...
@section('content')
    ...
    <div id="app-content">
        ...
        <div class="container-fluid">
            ...
            <br />
            <div>
                <form method="POST" enctype="multipart/form-data" action="{{ route('subsistence-allowance-renewal.store') }}">
                    @csrf
                <!-- row -->
                <div class="row">
                    <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <select class="form-control select2" id="selNamaBank" name="bank_id" autocomplete="off">
                                                ...
                                                @foreach($bank as $st2)
                                                    <option value="{{$st2->id}}" {{ $previousApp!=null ? ($previousApp->bank_id == $st2->id ? 'selected' : '' ) : '' }}>{{ strtoupper($st2->name_ms) }}</option>                           
                                                @endforeach	
                                            </select>
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="AppNoAkaun" name="no_account" placeholder="Sila Masukkan" value="{{ $previousApp!=null ? $previousApp->no_account : '' }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <select class="form-control select2" id="selStateBaru" name="state_bank_id" autocomplete="off">
                                                ...
                                                @foreach($states as $st1)
                                                    <option value="{{$st1->id}}" {{ $previousApp!=null ? ($previousApp->state_bank_id == $st1->id ? 'selected' : '' ) : '' }}>{{ strtoupper($st1->name_ms) }}</option>                           
                                                @endforeach		
                                            </select>
                                        </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                <a href="{{ route('subsistence-allowance-renewal.form') }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                                <button type="submit" class="btn btn-primary btn-sm" onclick="return confirm($('<span>Simpan Permohonan Pembaharuan ESH Nelayan?</span>').text())">
