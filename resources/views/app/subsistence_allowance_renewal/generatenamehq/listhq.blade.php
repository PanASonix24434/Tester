        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <!-- Page header -->
                    <div class="mb-8">
                        <h3 class="mb-0">Janaan Nama Pembaharuan ESH (HQ)</h3>
                    </div>
                </div>
                <div class="col-md-4">
                </div>
                                        ...
                                        @if (!$lists->isEmpty())
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-info" href="{{ route('subsistence-allowance-renewal.generate.hq.pdf',  $data->id) }}"  target="_blank"><i class="fas fa-print"></i></a>
                                                        <a class="btn btn-sm btn-warning" href="{{ route('subsistence-allowance-renewal.edithq', $data->id) }}">
