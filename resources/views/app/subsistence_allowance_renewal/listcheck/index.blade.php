        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <!-- Page header -->
                    <div class="mb-5">
                        <h3 class="mb-0">Sokongan Pembaharuan ESH</h3>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card mb-4">
                            ...
                            <form method="GET" id="search-form" action="{{ route('subsistence-allowance-renewal.formlist') }}">
                                <div class="row">
                                    ...
                                    <table class="table text-nowrap mb-0 table-centered table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($subApplication as $a)
                                                    <tr>
                                                    <td>    
                                                        <a href="{{ route('subsistence-allowance-renewal.kdpdetails',  $a->id ) }}" class="btn btn-primary btn-sm audit-view" ><i class="fa fa-search"></i></a>
                                                    </td>
                                                        <td>{{ $a->created_at }}</td>
