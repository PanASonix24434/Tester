                            ...
                            <div class="card-header bg-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card p-4">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <label class="form-label">No. Pendaftaran Vesel</label>
                                    ...
                                    <ul class="nav nav-tabs mt-4">
                                        ...
                                        <li class="nav-item"><a class="nav-link active" href="#">Butiran Kesalahan</a></li>
                                    ...
                                    <div class="card p-4 mt-3">
                                        <h5>Senarai Butiran Record Kesalahan</h5>
                                        <hr>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                    ...
                                                    <a href="{{ route('subsistence-allowance-renewal.kdpdetailsdoc',  $subApplication->id) }}" class="btn btn-dark btn-sm">{{ __('app.next') }} <i class="fas fa-arrow-right"></i> </a>
