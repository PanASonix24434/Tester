...
@section('content')
    ...
    <div id="app-content">
        ...
        <div class="container-fluid">
          <form method="POST" action="{{ route('complaint2.updateSolve', $id) }}">
            @csrf
            <div class="row">
                <div class="col-md-8">
                    <!-- Page header -->
                    <div class="mb-5">
                        <h3 class="mb-0">Selesaikan Aduan</h3>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="text-right">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Selesaikan Aduan</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-12 mb-5 mb-xl-0">
              <div class="card h-100">
                ...
                <div class="card-header d-flex justify-content-between align-items-center bg-primary">
                    <h4 class="mb-0" style="color:white;">SELESAIKAN ADUAN </h4>
                </div>
                <!-- table  -->
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="txtRemark">Catatan Penyelesaian : <span style="color:red;">*</span></label>
                    <textarea name="txtRemark" id="txtRemark" class="form-control" rows="7" placeholder="" required></textarea>
                  </div>
              ...
              <ul class="list-group list-group-unbordered mb-3 w-100" style="margin-top: 20px;">
                  <li class="list-group-item w-100 d-flex justify-content-center align-items-center" style="border-bottom: none;">
                      <div style="display: flex; gap: 10px;">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="return confirm($('<span>Selesaikan Aduan ?</span>').text())">
                          <i class="fas fa-save"></i> Selesaikan
						            </button>
