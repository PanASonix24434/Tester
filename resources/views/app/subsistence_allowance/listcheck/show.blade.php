                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-4">
                            <div class="card-header bg-primary">
                                <h4 class="mb-0" style="color:white;">Semakan KDP</h4>
                            </div>
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                ...
                                <div class="tab-content p-4" id="tabContent">
                                    ...
                                    <div class="tab-pane fade" id="action" role="tabpanel" aria-labelledby="action-tab">
                                        <form method="POST" action="{{ route('subsistence-allowance.kdp-review.store') }}">
                                            @csrf
                                            ...
                                            <div class="row">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-group">
                                                        <div>
                                                            <input type="radio" id="disokong" name="dokumen" value="disokong" required>
                                                            <label for="disokong">Disokong</label>
                                                        </div>
                                                        <div>
                                                            <input type="radio" id="tidak_disokong" name="dokumen" value="tidak_disokong">
                                                            <label for="tidak_disokong">Tidak Disokong</label>
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="form-group mt-3">
                                                        ...
                                                        <textarea id="ulasan" name="ulasan" class="form-control" rows="3">{{ $subApplication->supported_remarks ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <br />
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('input[type=radio][name=dokumen]').change(function() {
            ...
            }else if ($(this).val()=='tidak_disokong'){
