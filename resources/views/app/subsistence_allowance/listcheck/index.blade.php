                    ...
                    <div class="col-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                {{--
                                <form method="GET" id="search-form" action="{{ route('subsistence-allowance.kdp-review.index') }}">
                                    <div class="row">
                                            ...
                                            @if (!$subApplication->isEmpty())
                                                @foreach ($subApplication as $a)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('subsistence-allowance.kdp-review.show',  $a->id ) }}" class="btn btn-primary btn-sm audit-view" ><i class="fa fa-search"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @else
