    ...
    <div id="app-content">
        ...
        <div class="container-fluid">
            ...
            <ul class="nav nav-tabs" id="custom-content-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link disabled" id="custom-content-education-tab" href="#" role="tab" aria-controls="custom-content-education" aria-selected="false">Dokumen</a>
                </li>
                <li class="nav-item">
            ...
            <br />
            <div>
                <form method="POST" action="{{ route('subsistence-allowance.application.storeDeclaration') }}">
                    @csrf
                    <!-- row -->
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                            <a href="{{ route('subsistence-allowance.application.formdoc', $subApplication->id) }}" class="btn btn-dark btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                            @if( $subApplication->sub_application_status != 'Permohonan Disimpan')
                                            <button type="submit" id="btnSubmit" disabled class="btn btn-success btn-sm" name="action" value="send_again" onclick="return confirm($('<span>Hantar Permohonan Semula?</span>').text())">
                                                <i class="fas fa-paper-plane"></i>  Hantar Semula
                                            </button>
                                            @elseif( $subApplication->type_registration == 'Rayuan')
                                            <button type="submit" id="btnSubmit" disabled class="btn btn-success btn-sm" name="action" value="send_appeal" onclick="return confirm($('<span>Hantar Rayuan?</span>').text())">
                                                <i class="fas fa-paper-plane"></i>  Hantar Rayuan
                                            </button>
                                            @else
                                            <button type="submit" id="btnSubmit" disabled class="btn btn-success btn-sm" name="action" value="send" onclick="return confirm($('<span>Hantar Permohonan ?</span>').text())">
