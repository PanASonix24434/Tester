                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="AppName"  name="fullname" value="{{$subApplication->fullname ?? ''}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="AppIC" name="icno" value="{{$subApplication->icno ?? ''}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <!-- Umur -->
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <select class="form-control select2" id="selNamaBank" name="bank_id" autocomplete="off" disabled>
                                                <option value="">-- Sila Pilih --</option>
                                                @foreach($bank as $st2)
                                                    <option value="{{$st2->id}}"  {{$st2->id == $subApplication->bank_id ? ' selected' : '' }}>{{ strtoupper($st2->name_ms) }}</option>                           
                                                @endforeach	
                                            </select>
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="AppNoAkaun" name="no_account" value="{{$subApplication->no_account ?? ''}}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <select class="form-control select2" id="selStateBaru" name="state_bank_id" autocomplete="off" disabled>
                                                <option value="">-- Sila Pilih --</option>
                                                @foreach($states as $st1)
                                                    <option value="{{$st1->id}}" {{$st1->id == $subApplication->state_bank_id ? ' selected' : '' }}>{{ strtoupper($st1->name_ms) }}</option>                           
                                                @endforeach		
                                            </select>
                                        </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                <label for="">1. Keputusan AADK  <small>Maksimum Saiz : 5MB </small><span style="color:red;">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                <label for="">2. Keputusan Surat KWSP berkenaan pengesahan tiada akaun  <small>Maksimum Saiz : 5MB </small><span style="color:red;">*</span></label>
                                                <!-- <div class="input-group">
                                                    <div class="custom-file">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                <label for="">3. Akuan Sumpah  <small>Maksimum Saiz : 5MB </small><span style="color:red;">*</span></label>
                                                <!-- <div class="input-group">
                                                    <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="fileResult" name="fileResult"  >
                                                    <label class="custom-file-label" for="fileResult">Pilih Fail</label>
                                            ...
                                            <!-- Show existing file with download option -->
                                            @if (!empty($documentAkuan->file_detail))
                                                <div class="mt-2">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-lg-center mt-3 mt-lg-0" style="margin-top:-10px;">
                                                <a href="{{ route('subsistence-allowance.form',  $subApplication->id) }}" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                               
                                                <a href="{{ route('subsistence-allowance.showformwork' ,  $subApplication->id) }}" class="btn btn-dark btn-sm"> <i class="fas fa-arrow-right"></i> {{ __('app.next') }}</a>
