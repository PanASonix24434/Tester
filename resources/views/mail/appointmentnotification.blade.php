...
<head>
    ...
    <title>Pemakluman Watikah Pelantikan Kakitangan Telah Diluluskan</title>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td>
                ...
                <p style="margin-left:30px; margin-right:30px;">Dimaklumkan bahawa Watikah Pelantikan kakitangan telah diluluskan.</p>
                <p style="margin-left:30px; margin-right:30px;">Nama : <b>#{{ $name }}</b> </p>
                <p style="margin-left:30px; margin-right:30px;"><a href="{{ Str::replaceFirst('/public', '',asset('/storage/app/' . $watikahPath[0]->file_path)) }}" target="_blank">Lampiran</a></p> 
                <br/>
