...
<head>
    ...
    <title>Profil Gagal Disahkan - E-Lesen Perikanan</title>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td>
                <p style="margin: 20px 30px;">Assalamualaikum & Salam Sejahtera <br> YBhg. Dato/Dr./Tuan/Puan,</p>
                <p style="margin: 0 30px;">Dengan segala hormatnya perkara di atas adalah dirujuk.</p>
                <br>
                <p style="margin: 0 30px;">Adalah dimaklumkan bahawa profil anda <b>GAGAL DISAHKAN</b> dalam Sistem e-Lesen Perikanan.</p><br>
                ...
                <br/>
                <p style="margin: 0 30px;"><b>Ulasan:</b> {{ $ulasan }}</p>
                <br>
                <p style="margin: 0 30px;">Sila log masuk dan kemaskini semula profil anda untuk pengesahan semula:</p>
                <br>
                <p style="margin: 0 30px;"><a href="http://10.19.119.137/elesen2/public/login">Log Masuk ke e-Lesen</a></p>
                <br>
                <p style="margin: 0 30px;">Sekian, Terima Kasih.</p>
                <br>
                <p style="margin: 0 30px;">Daripada,</p>
                <br>
                <p style="margin: 0 30px;">
                Pentadbir Sistem e-Lesen Perikanan, <br>
