    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td>
                ...
                <p style="margin-left:30px; margin-right:30px;">Adalah dimaklumkan bahawa aduan bernombor <b>#{{ $complaintNo }}</b> telah diselesaikan.</p>
                <p style="margin-left:30px; margin-right:30px;">Ulasan Penyelesaian : <b>{{ $complaintRemark }}</b></p>
                <br/>
