    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td>
                ...
                <p style="margin-left:30px; margin-right:30px;">Dengan segala hormatnya perkara di atas adalah dirujuk.</p><br>
                <p style="margin-left:30px; margin-right:30px;">Adalah dimaklumkan bahawa anda telah berdaftar sebagai pentadbir harta / pewaris kepada pemilik vesel berikut:</p><br>
                <p style="margin-left:30px; margin-right:30px;">
                    Nama : <b>{{ $name }}</b><br/>
                    No. Vesel : <b>{{ $vessel_no }}
                </p>
                <br/>

                <p style="margin-left:30px; margin-right:30px;">Sekian, Terima Kasih.</p><br>
