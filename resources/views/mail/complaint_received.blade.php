    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td>
                ...
                <p style="margin-left:30px; margin-right:30px;">Adalah dimaklumkan bahawa aduan bernombor <b>#{{ $complaintNo }}</b> telah diterima oleh Sistem e-Lesen 2.0.</p>
                <p style="margin-left:30px; margin-right:30px;">Pegawai yang bertanggungjawab akan mengambil aduan ini dan maklum balas akan dihantar melalui emel.</p>
                <br/>
