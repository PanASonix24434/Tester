    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td>
                ...
                <p style="margin-left:30px; margin-right:30px;">Adalah dimaklumkan bahawa Penggantian Kad Pendaftaran Nelayan dalam <b>Sistem eLesen Perikanan Jabatan Perikanan Malaysia</b> telah diluluskan.</p>
                ...
                <p style="margin-left:30px; margin-right:30px;">Senarai Keputusan:</a></p>
                    <p style="margin-left:30px; margin-right:30px;">1. Nama : <b>{{ $kru['name'] }} ({{ $kru['ic_number'] }}) | Diluluskan Penggantian Kad</b></p>
                <br/>
