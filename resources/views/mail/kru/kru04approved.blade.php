    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td>
                ...
                <p style="margin-left:30px; margin-right:30px;">Adalah dimaklumkan bahawa Pembatalan Kad Pendaftaran Nelayan dalam <b>Sistem eLesen Perikanan Jabatan Perikanan Malaysia</b> telah diluluskan.</p>
                ...
                @endphp
                @foreach ( $krus as $kru)
                    <p style="margin-left:30px; margin-right:30px;">{{++$count}}. Nama : <b>{{ $kru['name'] }} ({{ $kru['ic_number'] }}) | {{ $kru['selected_for_approval'] ? 'Diluluskan Pembatalan' : 'Tidak Diluluskan Pembatalan' }}</b></p>
                @endforeach
