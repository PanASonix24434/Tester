    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td>
                ...
                <p style="margin-left:30px; margin-right:30px;">Adalah dimaklumkan bahawa Pembaharuan Kad Pendaftaran Nelayan dalam <b>Sistem eLesen Perikanan Jabatan Perikanan Malaysia</b> telah diluluskan.</p>
                ...
                <p style="margin-left:30px; margin-right:30px;">3. Tarikh Diluluskan : <b>{{ $start_date }}</b></p>
                <p style="margin-left:30px; margin-right:30px;">4. Tarikh Tamat : <b>{{ $end_date }}</b></p>
                <br/>
                ...
                @endphp
                @foreach ( $krus as $kru)
                    <p style="margin-left:30px; margin-right:30px;">{{++$count}}. Nama : <b>{{ $kru['name'] }} ({{ $kru['ic_number'] }}) | {{ $kru['selected_for_approval'] ? 'Diluluskan Pembaharuan' : 'Tidak Diluluskan Pembaharuan' }}</b></p>
                @endforeach
                <br/>
