...
<head>
    ...
    <title>Pengesahan Penyahaktifan Kakitangan</title>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td>
                ...
                <p style="margin-left:30px; margin-right:30px;">Disahkan bahawa kakitangan berikut telah dinyahaktifkan.</p>
                <p style="margin-left:30px; margin-right:30px;">Nama : <b>#{{ $name }}</b> </p>
                <p style="margin-left:30px; margin-right:30px;">No. Kad Pengenalan : <b>#{{ $icno }}</b> </p>
                <p style="margin-left:30px; margin-right:30px;">Tarikh Nyahaktif : <b>#{{ $inactive_date }}</b></p>
                <br/>
                ...
                Pentadbir1 Sistem e-Lesen 2.0, <br>
