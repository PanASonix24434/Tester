    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td>
                ...
                <p style="margin-left:30px; margin-right:30px;">Adalah dimaklumkan bahawa anda menerima mesej hebahan ini dari <b>Sistem e-Lesen 2.0 Jabatan Perikanan Malaysia</b>.</p>
                <p style="margin-left:30px; margin-right:30px;">Info hebahan : <b>{{ $content }}</b></p>
                <br/>
