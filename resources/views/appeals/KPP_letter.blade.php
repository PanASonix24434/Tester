...
<body>
    ...
    <div class="download-section">
        <h3>📄 Laporan Permohonan Siap</h3>
        <p>Laporan permohonan telah dijana. Anda boleh memuat turun sebagai PDF atau mencetak terus.</p>
        <a href="{{ route('appeals.KPP_letter_pdf', $appeal->id) }}" class="download-btn">
    ...
    <div class="report-container">
        ...
        <div class="section">
            <div class="section-title">3. Ulasan KPP</div>
        ...
        <div class="section">
            <div class="section-title">4. Tandatangan KPP</div>
