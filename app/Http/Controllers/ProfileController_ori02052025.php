...
class ProfileController extends Controller
{
    ...
    public function storeprofileuser(Request $request)
    {
        ...
        try {
            ...
            $profile->district = $request->daerah;
            $profile->state = $request->negeri;
        ...
        return redirect()->action([ProfileController::class, 'viewprofileuser'], ['id' => $profile->id])
            ->with('alert', 'Profil berjaya dikemaskini.');
    }
    ...
    public function profileCompanyStore(Request $request)
    {
        ...
        try {
            ...
            $comp->company_name = $request->txtCompanyName;
            $comp->company_reg_no = $request->txtCompanyRegNo;
            $comp->company_reg_date = $request->txtCompanyRegDate;
            $comp->lhdn_account_no = $request->txtLhdnAccountNo;
            $comp->current_address1 = $request->txtCurrentAddress1;
            $comp->current_address2 = $request->txtCurrentAddress2;
            $comp->current_address3 = $request->txtCurrentAddress3;
            $comp->current_postcode = $request->txtCurrentPostcode;
            $comp->current_district = $request->txtCurrentCity;
            $comp->current_state_id = $request->selCurrentState;
            $comp->letter_address1 = $request->txtLetterAddress1;
            $comp->letter_address2 = $request->txtLetterAddress2;
            $comp->letter_address3 = $request->txtLetterAddress3;
            $comp->letter_postcode = $request->txtLetterPostcode;
            $comp->letter_district = $request->txtLetterCity;
            $comp->letter_state_id = $request->selLetterState;
            $comp->phone_no = $request->txtPhoneNo;
            $comp->fax_no = $request->txtFaxNo;
            $comp->email = $request->txtEmail;
            $comp->comp_sec = $request->txtSecretary;
            $comp->ownership = $request->txtOwnership;
            $comp->bumiputera_status = $request->bumiputera;
            $comp->modal_allow = $request->txtModalAllow;
            $comp->modal_paid = $request->txtModalPaid;
            $comp->company_business = $request->txtCompanyBusiness;
            $comp->company_exp_fish = $request->txtCompanyExpFish;
            $comp->company_exp_other = $request->txtCompanyExpOther;
