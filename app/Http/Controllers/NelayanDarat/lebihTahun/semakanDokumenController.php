...
class semakanDokumenController extends Controller
{
    ...
    public function index()
    {
        ...
        $positiveFeedback = ['701'];
        $negativeFeedback = ['707'];
        ...
        return view('app.NelayanDarat.lebihTahun.pegawai.1_semakanDokumen.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    //     return view('app.NelayanDarat.lebihTahun.pegawai.1_semakanDokumen.create', compact(
    //         'application',
    //         'roleName',
    //         'applicationType',
    //         'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('lebihTahun.semakanDokumen-07.index')
