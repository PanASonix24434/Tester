...
class laporanLpiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.lebihTahun.pegawai.3_laporanLpi.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        // ===== [8] Return to View =====
        return view('app.NelayanDarat.lebihTahun.pegawai.3_laporanLpi.create', compact(
            'application',
            'user',
            'roleName',
    ...
    public function store($id)
    {
        ...
        try {
            ...
            return redirect()->route('lebihTahun.laporanLpi-07.index')
    ...
    public function viewEquipmentFile(Request $request)
    {
        ...
        $equipmentType = $request->query('type');

        $inspection = darat_inspection_equipment::findOrFail($inspectionId);
