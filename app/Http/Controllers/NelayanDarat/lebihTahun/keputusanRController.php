    ...
    public function index()
{
    ...
    return view('app.NelayanDarat.lebihTahun.pegawai.10_keputusan.index', compact(
        'applications',
        'positiveFeedback',
        'negativeFeedback',
        'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.lebihTahun.pegawai.10_keputusan.create', compact(
            'application',
            'user',
            'vessel',
            'hull',
    ...
    public function store(Request $request, $id)
{
    ...
    try {
        ...
        return redirect()->route('lebihTahun.keputusanR-09.index')
