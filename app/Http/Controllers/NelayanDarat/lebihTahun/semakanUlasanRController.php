    ...
    public function index()
{
    ...
    return view('app.NelayanDarat.lebihTahun.pegawai.9_semakanUlasan.index', compact(
        'applications',
        'positiveFeedback',
        'negativeFeedback',
        'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.lebihTahun.pegawai.9_semakanUlasan.create', compact(
            'application',
            'user',
            'vessel',
            'hull',
    ...
    public function store(Request $request, $id)
{
    ...
    try {
        ...
        return redirect()->route('lebihTahun.semakanUlasanR-09.index')
