...
class sokonganUlasanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.lebihTahun.pegawai.4_sokonganUlasan.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.lebihTahun.pegawai.4_sokonganUlasan.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
