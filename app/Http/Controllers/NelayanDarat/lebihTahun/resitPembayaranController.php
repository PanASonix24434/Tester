...
class resitPembayaranController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.lebihTahun.pegawai.8_resitPembayaran.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
     ...
     public function create($id)
    {
        ...
        return view('app.NelayanDarat.lebihTahun.pegawai.8_resitPembayaran.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function submit($id)
    {
        ...
        try {
            ...
            return redirect()->route('lebihTahun.resitBayaran-07.index')
