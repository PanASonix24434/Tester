...
class semakanBayaranController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.lebihTahun.pegawai.9_semakanBayaran.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    //     return view('app.NelayanDarat.lebihTahun.pegawai.9_semakanBayaran.create', compact(
    //         'application',
    //         'roleName',
    //         'applicationType',
    //         'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            $statusCode = $request->review_flag == '1' ? 718 : 717;
            ...
            return redirect()->route('lebihTahun.semakanBayaran-07.index')
