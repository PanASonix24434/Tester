...
class semakanBayaranController extends Controller
{
    ...
    public function index()
    {
        ...
        $positiveFeedback = ['809'];
        $negativeFeedback = ['0']; // <- This should contain valid codes or be removed
        ...
        return view('app.NelayanDarat.kadPendaftaran.pegawai.10_semakanBayaran.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.kadPendaftaran.pegawai.10_semakanBayaran.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            $statusCode = $request->review_flag == '1' ? '810' : '809-1';
            ...
            return redirect()->route('kadPendaftaran.semakanBayaran-08.index')
