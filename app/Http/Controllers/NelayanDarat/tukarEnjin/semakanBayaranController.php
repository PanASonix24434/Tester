...
class semakanBayaranController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.tukarEnjin.pegawai.6_semakanBayaran.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
      ...
      public function create($id)
    {
        ...
        return view('app.NelayanDarat.tukarEnjin.pegawai.6_semakanBayaran.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            $statusCode = $request->review_flag == '1' ? 511 : 510;
            ...
            return redirect()->route('tukarEnjin.semakanBayaran-05.index')
