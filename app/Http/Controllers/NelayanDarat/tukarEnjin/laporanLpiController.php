...
class laporanLpiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.tukarEnjin.pegawai.3_laporanLpi.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
 ...
 public function create($id)
    {
        ...
        // ===== [8] Return to View =====
        return view('app.NelayanDarat.tukarEnjin.pegawai.3_laporanLpi.create', compact(
            'application',
            'user',
            'roleName',
    ...
    public function store($id)
    {
        ...
        try {
            ...
            return redirect()->route('tukarEnjin.laporanLpi-05.index')
