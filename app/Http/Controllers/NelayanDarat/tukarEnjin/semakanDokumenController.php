...
class semakanDokumenController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.tukarEnjin.pegawai.1_semakanDokumen.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
      ...
      public function create($id)
    {
        ...
        return view('app.NelayanDarat.tukarEnjin.pegawai.1_semakanDokumen.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('tukarEnjin.semakanDokumen-05.index')
