...
class resitPembayaranController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.tukarEnjin.pegawai.5_resitPembayaran.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
   ...
   public function create($id)
    {
        ...
        return view('app.NelayanDarat.tukarEnjin.pegawai.5_resitPembayaran.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
  ...
  public function store(Request $request, $id)
    ...
    public function submit($id)
    {
        ...
        try {
            ...
            return redirect()->route('tukarEnjin.resitBayaran-05.index')
