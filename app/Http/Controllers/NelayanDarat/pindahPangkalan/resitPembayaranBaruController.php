...
class resitPembayaranBaruController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.pindahPangkalan.pegawai.12_resitPembayaranBaru.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.pindahPangkalan.pegawai.12_resitPembayaranBaru.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    //             'receipt_file'   => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:2049',
    ...
    //                 if (!empty($name)) {
    //                     darat_payment_receipt::updateOrCreate(
    //                         [
    ...
    //         return redirect()->route('pindahPangkalan.resitBayaran-09.index')
    //             ->with('success', 'Maklumat resit  disimpan.');
    //     } catch (\Exception $e) {
    //         DB::rollBack();
    ...
    public function submit($id)
    {
        ...
        try {
            ...
            return redirect()->route('pindahPangkalan.resitBayaran-03.index')
