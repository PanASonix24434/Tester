...
class sokonganUlasan2Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.pindahPangkalan.pegawai.6_sokonganUlasan.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    //     return view('app.NelayanDarat.pindahPangkalan.pegawai.6_sokonganUlasan.create', compact(
    //         'application',
    //         'roleName',
    //         'applicationType',
    //         'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            $statusCode = $request->review_flag ? 712 : 711;
            ...
            return redirect()->route('pindahPangkalan.sokonganUlasan-1-03.index')
