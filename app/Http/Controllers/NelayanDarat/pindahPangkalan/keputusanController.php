...
class keputusanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.pindahPangkalan.pegawai.7_keputusan.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.pindahPangkalan.pegawai.7_keputusan.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            // ✅ If both review & decision are '1' AND pindah is antara → override to 312
            ...
            if ($reviewFlag === '1') {
                $resultMessage = match ($statusCode) {
                    ...
                    // 312 => 'PERMOHONAN ANDA TELAH DI LULUSKAN. ',
                    307 => 'PERMOHONAN TIDAK LULUS, SILA LAKUKAN RAYUAN.',
