...
class semakanBayaranController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.pindahPangkalan.pegawai.9_semakanBayaran.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
...
public function create($id)
    {
        ...
        return view('app.NelayanDarat.pindahPangkalan.pegawai.9_semakanBayaran.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            $statusCode = $request->review_flag == '1' ? 316 : 315  ;
            ...
            return redirect()->route('pindahPangkalan.semakanBayaran-03.index')
