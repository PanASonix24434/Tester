...
class cetakLesenController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.pindahPangkalan.pegawai.10_cetakLesen.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.pindahPangkalan.pegawai.10_cetakLesen.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
