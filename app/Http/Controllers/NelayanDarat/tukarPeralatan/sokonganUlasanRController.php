...
class sokonganUlasanRController extends Controller
{
    ...
    public function index()
    {
        ...
        $positiveFeedback = ['915'];
        $negativeFeedback = ['909'];
        ...
        return view('app.NelayanDarat.tukarPeralatan.pegawai.8_sokonganUlasan.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.tukarPeralatan.pegawai.8_sokonganUlasan.create', compact(
            'application',
            'user',
            'vessel',
            'hull',
    ...
    public function store(Request $request, $id)
{
    ...
    try {
        ...
        return redirect()->route('tukarPeralatan.sokonganUlasanR-04.index')
            ->with('success', 'Maklumat semakan berjaya disimpan.');
    } catch (\Exception $e) {
        DB::rollBack();
