...
class laporanLpiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.tukarPeralatan.pegawai.3_laporanLpi.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        // ===== [8] Return to View =====
        return view('app.NelayanDarat.tukarPeralatan.pegawai.3_laporanLpi.create', compact(
            'application',
            'user',
            'roleName',
    ...
    public function storeMaklumatVesel(Request $request, $id)
    {
        ...
        try {
            $request->validate([
                ...
                'overall_image_path'          => 'nullable|image|mimes:jpg,jpeg,png|max:2049',
            ]);
    ...
    public function storeMaklumatEnjin(Request $request, $id)
    {
        ...
        try {
            ...
            $request->validate([
                ...
                'engine_image_path'        => 'nullable|image|mimes:jpg,jpeg,png|max:2049',
                'engine_number_image_path' => 'nullable|image|mimes:jpg,jpeg,png|max:2049',
            ]);
    ...
    public function storePeralatanKeselamatan(Request $request, $id)
    {
        ...
        try {
            ...
            $request->validate([
                ...
                'safety_jacket_image_path' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:2049',
            ]);
    ...
    public function storePengesahanPemeriksaan(Request $request, $id)
    {
        ...
        try {
            ...
            $request->validate([
                ...
                'attendance_form_path'       => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:2049',
                'vessel_image_path'          => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:2049',
                'inspector_owner_image_path' => 'nullable|file|mimes:jpg,jpeg,png,pdf|max:2049',
            ]);
            ...
            darat_vessel_inspection::updateOrCreate(
                ['id' => $inspection->id, 'application_id' => $application->id],
                [
    ...
    public function store($id)
    {
        ...
        try {
            ...
            return redirect()->route('tukarPeralatan.laporanLpi-04.index')
    ...
    public function viewEquipmentFile(Request $request)
    {
        ...
        if ($type === 'main') {
            $mainItems = $equipmentList->where('type', 'main')->values();
            $filePath = $mainItems[$index]['file_path'] ?? null;
        } elseif ($type === 'additional') {
            $additionalItems = $equipmentList->where('type', 'additional')->values();
