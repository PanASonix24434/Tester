...
class semakanUlasanRController extends Controller
{
    ...
    public function index()
    {
        ...
        $positiveFeedback = ['210'];
        $negativeFeedback = ['211-1'];
        ...
        return view('app.NelayanDarat.lesenTahunan.pegawai.9_semakanUlasan.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.lesenTahunan.pegawai.9_semakanUlasan.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('lesenTahunan.semakanUlasanR-02.index')
