...
class resitPembayaranController extends Controller
{
    ...
    public function index()
    {
        ...
        $positiveFeedback = ['205'];
        $negativeFeedback = ['206-1'];
        ...
        return view('app.NelayanDarat.lesenTahunan.pegawai.5_resitPembayaran.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.lesenTahunan.pegawai.5_resitPembayaran.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function submit($id)
    {
        ...
        try {
            ...
            return redirect()->route('lesenTahunan.resitBayaran-02.index')
