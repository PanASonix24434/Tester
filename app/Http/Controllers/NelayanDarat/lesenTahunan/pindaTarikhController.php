...
class pindaTarikhController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.lesenTahunan.pegawai.2_pindaTarikh.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    //     $inspectionOff = darat_vessel_inspection::where('vessel_id', $vessel->id)->where('is_active', 1)->first();

    //     $equipmveentList = darat_equipment_list::where('is_active', true)->pluck('name', 'id');
    ...
    //     return view('app.NelayanDarat.lesenTahunan.pegawai.2_pindaTarikh.create', compact(
    //         'application',
    //         'roleName',
    //         'applicationType',
    //         'moduleName',
    ...
    public function create($id)
    {
        ...
        // dd($vesselHullEngine,$hull,$engine);
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('lesenTahunan.pindaLpi-02.index')
