...
class keputusanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.lesenTahunan.pegawai.4_keputusan.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.lesenTahunan.pegawai.4_keputusan.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
        ...
        try {
            ...
            if ($reviewFlag === '1') {
                $resultMessage = match ($statusCode) {
                    '205' => 'PERMOHONAN ANDA TELAH DI LULUSKAN.',
                    '204-2' => 'PERMOHONAN TIDAK LULUS, SILA LAKUKAN RAYUAN.',
            ...
            return redirect()->route('lesenTahunan.keputusan-02.index')
