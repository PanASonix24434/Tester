    ...
    public function index()
{
    ...
    $positiveFeedback = ['910'];
    $negativeFeedback = ['911-1'];
    ...
    return view('app.NelayanDarat.baharuKadNelayan.pegawai.9_semakanUlasan.index', compact(
        'applications',
        'positiveFeedback',
        'negativeFeedback',
        'applicationType',
     ...
     public function create($id)
    {
        ...
        return view('app.NelayanDarat.baharuKadNelayan.pegawai.9_semakanUlasan.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            $statusCode = $request->review_flag ? '911' : '910-1';
            ...
            return redirect()->route('baharuKadNelayan.semakanUlasanR-09.index')
