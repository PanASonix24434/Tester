...
class semakanBayaranController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.baharuKadNelayan.pegawai.6_semakanBayaran.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
      ...
      public function create($id)
    {
        ...
        return view('app.NelayanDarat.baharuKadNelayan.pegawai.6_semakanBayaran.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            $statusCode = $request->review_flag == '1' ? '907' : '906-1';
            ...
            return redirect()->route('baharuKadNelayan.semakanBayaran-09.index')
    ...
    //== view
    public function viewCrime(Request $request)
    {
