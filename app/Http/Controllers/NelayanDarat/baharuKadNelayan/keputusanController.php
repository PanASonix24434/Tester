...
class keputusanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.baharuKadNelayan.pegawai.4_keputusan.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
     ...
     public function create($id)
    {
        ...
        return view('app.NelayanDarat.baharuKadNelayan.pegawai.4_keputusan.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
        ...
        try {
            ...
            if ($reviewFlag === '1') {
                $resultMessage = match ($statusCode) {
                    ...
                    '904-2' => 'PERMOHONAN TIDAK LULUS, SILA LAKUKAN RAYUAN.',
            ...
            return redirect()->route('baharuKadNelayan.keputusan-09.index')
