...
class resitPembayaranController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.baharuKadNelayan.pegawai.5_resitPembayaran.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
     ...
     public function create($id)
    {
        ...
        return view('app.NelayanDarat.baharuKadNelayan.pegawai.5_resitPembayaran.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function submit($id)
    {
        ...
        try {
            ...
            return redirect()->route('baharuKadNelayan.resitBayaran-09.index')
