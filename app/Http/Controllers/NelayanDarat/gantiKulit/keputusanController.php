...
class keputusanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.gantiKulit.pegawai.7_keputusan.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    //     return view('app.NelayanDarat.gantiKulit.pegawai.7_keputusan.create', compact(
    //         'application',
    //         'roleName',
    //         'applicationType',
    //         'moduleName',
        ...
        try {
            ...
            if ($reviewFlag === '1') {
                $resultMessage = match ($statusCode) {
                    613 => 'PERMOHONAN ANDA TELAH DI LULUSKAN.',
                    608 => 'PERMOHONAN TIDAK LULUS, SILA LAKUKAN RAYUAN.',
            ...
            return redirect()->route('gantiKulit.keputusan-06.index')
