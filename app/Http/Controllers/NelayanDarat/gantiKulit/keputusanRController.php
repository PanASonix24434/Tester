    ...
    public function index()
{
    ...
    return view('app.NelayanDarat.gantiKulit.pegawai.10_keputusan.index', compact(
        'applications',
        'positiveFeedback',
        'negativeFeedback',
        'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.gantiKulit.pegawai.10_keputusan.create', compact(
            'application',
            'user',
            'vessel',
            'hull',
    ...
    public function store(Request $request, $id)
{
    ...
    try {
        ...
        return redirect()->route('gantiKulit.keputusanR-09.index')
