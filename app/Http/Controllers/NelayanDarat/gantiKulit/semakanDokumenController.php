...
class semakanDokumenController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.gantiKulit.pegawai.1_semakanDokumen.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.gantiKulit.pegawai.1_semakanDokumen.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            $statusCode = $request->review_flag ? 603 : 602;
            ...
            return redirect()->route('gantiKulit.semakanDokumen-06.index')
