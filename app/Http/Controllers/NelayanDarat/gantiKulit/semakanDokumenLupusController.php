...
use App\Models\NelayanDaratModels\darat_base_jetty_history;
...
class semakanDokumenLupusController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.gantiKulit.pegawai.19_semakanDokumenLupus.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.gantiKulit.pegawai.19_semakanDokumenLupus.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('gantiKulit.semakanDokumenLupus-06.index')
