...
class sokonganUlasan2Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.lesenBaharu.pegawai.6_sokonganUlasan.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
   ...
   public function create($id)
    {
        ...
        return view('app.NelayanDarat.lesenBaharu.pegawai.6_sokonganUlasan.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            $statusCode = $request->review_flag ? '108' : '107-1';

            $statusCode = ($application->is_appeal == true) ? ($request->review_flag ? '116' : '115-1') : $statusCode;
            ...
            return redirect()->route('lesenBaharu.sokonganUlasan-1-01.index')
