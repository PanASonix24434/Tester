...
class semakanBayaranController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.lesenBaharu.pegawai.9_semakanBayaran.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    //     return view('app.NelayanDarat.lesenBaharu.pegawai.9_semakanBayaran.create', compact(
    //         'application',
    //         'roleName',
    //         'applicationType',
    //         'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            $statusCode = $request->review_flag == '1' ? '111' : '110-1';
            ...
            return redirect()->route('lesenBaharu.semakanBayaran-01.index')
