...
class pindaTarikhController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.lesenBaharu.pegawai.2_pindaTarikh.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
      ...
      public function create($id)
    {
        ...
        return view('app.NelayanDarat.lesenBaharu.pegawai.2_pindaTarikh.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('lesenBaharu.pindaLpi-01.index')
