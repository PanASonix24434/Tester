...
class sokonganUlasanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.NelayanDarat.lesenBaharu.pegawai.4_sokonganUlasan.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.lesenBaharu.pegawai.4_sokonganUlasan.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            $statusCode = $request->review_flag ? '106' : '105-1';

           $statusCode = ($application->is_appeal == true) ? ($request->review_flag ? '114' : '113-1') : $statusCode;
