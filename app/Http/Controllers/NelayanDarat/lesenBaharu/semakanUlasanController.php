...
class semakanUlasanController extends Controller
{
    ...
    public function index()
    {
        ...
        $positiveFeedback = ['106', '114'];
        $negativeFeedback = ['107-1'];
        ...
        return view('app.NelayanDarat.lesenBaharu.pegawai.5_semakanUlasan.index', compact(
            'applications',
            'positiveFeedback',
            'negativeFeedback',
            'applicationType',
    ...
    public function create($id)
    {
        ...
        return view('app.NelayanDarat.lesenBaharu.pegawai.5_semakanUlasan.create', compact(
            'application',
            'roleName',
            'applicationType',
            'moduleName',
    ...
    public function store(Request $request, $id)
    {
        ...
        try {
            ...
            $statusCode = $request->review_flag ? '107' : '106-1';

            $statusCode = ($application->is_appeal == true) ? ($request->review_flag ? '115' : '114-1') : $statusCode;
            ...
            return redirect()->route('lesenBaharu.semakanUlasan-01.index')
