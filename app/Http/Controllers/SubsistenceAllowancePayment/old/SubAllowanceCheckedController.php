...
class SubAllowanceCheckedController extends Controller
{
    ...
    {
        $subApplication = SubApplication::where('type_registration', ['Baru', 'Rayuan'])->where('sub_application_status', '!=', 'Permohonan Disimpan');
    ...
    public function kdpdetails($id)
    {
        ...
        return view('app.subsistence_allowance.listcheck.edit', [		
    ...
    public function kdpdetailswork($id)
    {
        ...
        return view('app.subsistence_allowance.listcheck.editwork', [		
			'subApplication' => $subApplication,
		]);
    }
    ...
    public function kdpdetailsdependent($id)
    {
        ...
        return view('app.subsistence_allowance.listcheck.editdependent', [		
			'subApplication' => $subApplication,
		]);
    }
    ...
    public function kdpdetailseducation($id)
    {
        ...
        return view('app.subsistence_allowance.listcheck.editeducation', [		
			'subApplication' => $subApplication,
		]);
    }
    ...
    public function kdpdetailsdoc($id)
    {
        ...
        return view('app.subsistence_allowance.listcheck.editdoc', [		
			'subApplication' => $subApplication,
            'doc' => $doc,
		]);
    }
    ...
    public function kdpdetailsfault($id)
    {
        ...
        return view('app.subsistence_allowance.listcheck.editfault', [		
			'subApplication' => $subApplication,
    ...
    public function kdpdetailsStatus($id)
    {
        ...
        return view('app.subsistence_allowance.listcheck.editstatus', [		
			'subApplication' => $subApplication,
    ...
    public function kdpdetailscheck($id)
    {
        ...
        return view('app.subsistence_allowance.listcheck.editcheck', [		
			'subApplication' => $subApplication,
			'landings' => $landings,
		]);
    }
