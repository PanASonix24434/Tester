...
class SubPaySupportDistrictController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $lists = SubPayment::where('entity_id', $entity_id)->whereIn('status',['Dihantar','Disokong Daerah'])->sortable();

        return view('app.subsistence_allowance_payment.supportdistrict.index',  [
    ...
    public function create(Request $request, $entity_id)
    {
        ...
        return view('app.subsistence_allowance_payment.supportdistrict.create',  [
    ...
    //         }
    //         DB::commit();
    //         return redirect()->route('subsistenceallowancepayment.supportdistrictdistrict.index')->with('alert', 'Senarai berjaya disimpan !!');
    //     }
    //     catch(Exception $e){
    //         DB::rollback();
    ...
    public function storeListName(Request $request)
    {
        ...
        //     'lists' => $request->has('sort') ? $lists->paginate(10) : $lists->orderBy('created_at')->paginate(10), 
        // ]);
        return redirect()->route('subsistenceallowancepayment.supportdistrict.index')->with('alert', 'Senarai berjaya dihantar !!');
    }
    ...
    public function generatePDF($id)
    {
        ...
        $pdf = PDF::loadView('app.subsistence_allowance_payment.supportdistrict.applistpdf',  compact('applications'));
    ...
    public function generateListNamePDF($id)
    {
        ...
        $pdf = PDF::loadView('app.subsistence_allowance_payment.supportdistrict.applistnamepdf',  compact('applications'));
    ...
    {   
        ...
        return view('app.subsistence_allowance_payment.supportdistrict.edit', [
