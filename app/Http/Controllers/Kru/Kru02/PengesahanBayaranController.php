...
class PengesahanBayaranController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru02.pengesahanbayaran.index', [
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru02.pengesahanbayaran.show', [
            'id' => $id,
            'app' => $app,
            'vessel' => $vessel,
    ...
    public function showKru(string $id)
    {
        ...
        return view('app.kru.kru02.pengesahanbayaran.showKru', [
    ...
    public function update(Request $request, string $id)
    {
        if ($request->action=='save'){
            ...
            try {
                ...
                $auditLog->log('kru02PengesahanBayaran', 'update', $audit_details);
                DB::commit();
            }
            catch (Exception $e) {
                DB::rollback();
                ...
                $auditLog = new AuditLog();
                $auditLog->log('kru02PengesahanBayaran', 'update', $audit_details, $e->getMessage());
            ...
            return redirect()->route('pembaharuankadpendaftarannelayan.pengesahanbayaran.index')->with('alert', 'Maklumat Bayaran berjaya dihantar !!');
        }
    }
