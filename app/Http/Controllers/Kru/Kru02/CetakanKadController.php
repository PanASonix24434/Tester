...
class CetakanKadController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru02.cetakankad.index', [
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru02.cetakankad.show', [
            'id' => $id,
            'app' => $app,
            'vessel' => $vessel,
    ...
    public function showKru(string $id)
    {
        ...
        return view('app.kru.kru02.cetakankad.showKru', [
    ...
    public function createSSD(Request $request, string $id)
    {
        ...
        $pin = $app->pin_number;
        return view('app.kru.kru02.cetakankad.createSSD', [
            'id' => $app->id,
            'pin' => $pin,
    ...
    {        
        ...
        try {
            ...
            $auditLog->log('kru02CetakanKad', 'updateSSD', $audit_details);
            DB::commit();
        }
        catch (Exception $e) {
            DB::rollback();
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru02CetakanKad', 'updateSSD', $audit_details, $e->getMessage());

            return redirect()->back()->with('alert', 'Maklumat SSD gagal disampan !!');
        }
        
        $selectedKrus = KruApplicationKru::where('kru_application_id',$selectedKru->kru_application_id)->where('selected_for_approval',true)->get();
        $allHasPrintedSucessfully = true;
        foreach ($selectedKrus as $selectedKru) {
            if ($selectedKru->has_sucessfully_printed !== true){
                $allHasPrintedSucessfully = false;
    ...
    {        
        ...
        try {
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru02CetakanKad', 'updatePrinted', $audit_details);
            DB::commit();
        }
        catch (Exception $e) {
            DB::rollback();
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru02CetakanKad', 'updatePrinted', $audit_details, $e->getMessage());
    ...
    {    
        ...
        $auditLog = new AuditLog();
        $auditLog->log('kru02CetakanKad', 'print', json_encode(['file_type' => 'PDF']));
    ...
    {        
        ...
        try {
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru02CetakanKad', 'updateCompleted', $audit_details);
            DB::commit();
        }
        catch (Exception $e) {
            DB::rollback();
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru02CetakanKad', 'updateCompleted', $audit_details, $e->getMessage());
