...
class SemakanDaerahController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru07.semakandaerah.index', [
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru07.semakandaerah.show', [
            'id' => $id,
            'app' => $app,
    ...
    public function update(Request $request, string $id)
    {
        if ($request->action=='save'){
            ...
            return redirect()->route('pembaharuanpenggunaankrubukanwarganegara.semakandaerah.index')->with('alert', 'Maklumat berjaya dihantar !!');
        }
