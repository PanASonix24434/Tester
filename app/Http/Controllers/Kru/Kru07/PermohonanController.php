...
class PermohonanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru07.index', [
    ...
    public function create()
    {
        ...
        return view('app.kru.kru07.create', [
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $appType = KruApplicationType::where('code','kru07')->first();
            ...
            $auditLog->log('kru07', 'create', $audit_details);
            DB::commit();
            return redirect()->route('pembaharuanpenggunaankrubukanwarganegara.permohonan.editB', $app->id)->with('alert', 'Permohonan berjaya disimpan !!');
        }
        catch (Exception $e) {
            DB::rollback();
            $audit_details = json_encode([
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru07', 'create', $audit_details, $e->getMessage());
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru07.show', [
            'id' => $id,
            'app' => $app,
    ...
    public function edit(string $id)
    {
        ...
        return view('app.kru.kru07.edit', [
            'id' => $id,
            'app' => $app,
            'vessels' => Vessel::where('user_id',$user->id)->whereIn('zon',['C','C2'])->orderBy('no_pendaftaran')->get(),
        ]);
    ...
    public function editB(string $id)
    {
        ...
        return view('app.kru.kru07.editB', [
            'id' => $id,
            'app' => $app,
            'appForeign' => $appForeign,
            'vessel' => $vessel,
    ...
    public function editC(string $id)
    {
        ...
        $vessel = Vessel::withTrashed()->find($app->vessel_id);
        $foreignKrus = KruApplicationForeignKru::where('kru_application_id',$id)->orderBy('created_at','ASC')->get();
        $foreignCrews = ForeignCrew::where('vessel_id',$vessel->id)->orderBy('created_at','ASC')->get();
        $selectedCrews = KruApplicationForeignKru::where('kru_application_id',$id)->select('passport_number')->get();

        return view('app.kru.kru07.editC', [
            'id' => $id,
            'app' => $app,
            'appForeign' => $appForeign,
            'vessel' => $vessel,
    ...
    public function editCAddKru(string $id)
    {
        ...
        return view('app.kru.kru07.editCAddKru', [
            'id' => $id,
            'app' => $app,
            'appForeign' => $appForeign,
    ...
    public function editD(string $id)
    {
        ...
        return view('app.kru.kru07.editD', [
            'id' => $id,
            'app' => $app,
    ...
    public function editE(string $id)
    {
        ...
        return view('app.kru.kru07.editE', [
            'id' => $id,
            'app' => $app,
            'statusIncompleteId' => $statusIncompleteId,
        ]);
    ...
    public function updateB(Request $request, string $id)
    {
        ...
        try {
            ...
            $kruAppForeign->crew_placement = $request->txtPlacement;
            $kruAppForeign->supervised = $request->txtSupervised;
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru07', 'editB', $audit_details);
            DB::commit();
        }
        catch (Exception $e) {
            DB::rollback();
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru07', 'editB', $audit_details, $e->getMessage());

            return redirect()->back()->with('alert', 'Permohonan gagal disimpan !!');
        }
        return redirect()->route('pembaharuanpenggunaankrubukanwarganegara.permohonan.editC', $app->id)->with('alert', 'Permohonan berjaya disimpan !!');
    }
    /**
     * Update the specified resource in storage.
     */
    public function updateC(Request $request, string $id)
    {
        ...
        try {
            ...
            foreach ($selKrus as $selKru) {
                $nelayan = ForeignCrew::find($selKru);
                ...
                if($appKru == null){
                    ...
                    $appKru->plks_number = $nelayan->passport_number;
                    $appKru->plks_end_date = $nelayan->passport_end_date;
                    ...
                    $appKru->crew_whereabout = $nelayan->crew_whereabout;
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru07', 'editC', $audit_details);
            DB::commit();
        }
        catch (Exception $e) {
            DB::rollback();
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru07', 'editC', $audit_details, $e->getMessage());

            return redirect()->back()->with('alert', 'Permohonan gagal disimpan !!');
        }
        return redirect()->route('pembaharuanpenggunaankrubukanwarganegara.permohonan.editD', $app->id)->with('alert', 'Permohonan berjaya disimpan !!');
    }
    ...
    public function updateCAddKru(Request $request, string $id)
    {
        ...
        try {
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru07', 'editCAddKru', $audit_details);
            DB::commit();
        }
        catch (Exception $e) {
            DB::rollback();
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru07', 'editCAddKru', $audit_details, $e->getMessage());
    ...
    public function updateD(Request $request, string $id)
    {
        ...
        try {
            ...
            if ($request->file('kadPengenalanDoc')) {
                ...
                $auditLog = new AuditLog();
                $auditLog->log('kru07', 'editD', $audit_details);
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru07', 'editD', $audit_details, $e->getMessage());

            return redirect()->back()->with('alert', 'Permohonan gagal disimpan !!');
        }
        return redirect()->route('pembaharuanpenggunaankrubukanwarganegara.permohonan.editE', $app->id)->with('alert', 'Permohonan berjaya disimpan !!');
    }
    ...
    public function updateE(Request $request, string $id)
    {
        ...
        try {
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru07', 'editE', $audit_details);
            DB::commit();
        }
        catch (Exception $e) {
            DB::rollback();
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru07', 'editE', $audit_details, $e->getMessage());

            return redirect()->back()->with('alert', 'Permohonan gagal dihantar !!');
        }
        return redirect()->route('pembaharuanpenggunaankrubukanwarganegara.permohonan.index')->with('alert', 'Permohonan berjaya dihantar !!');
    }
    ...
    public function exportPermissionLetter(Request $request, $id) 
    {
        ...
        $stateEntity = Entity::find($entity->parent_id);
        ...
        $data = [
            ...
            'approver' => User::find($app->decision_by),
            'entity' => $entity,//daerah
            'stateEntity' => $stateEntity,

            'allVessel' => $allVessel,
        ];

        $pdf = Pdf::loadView('app.kru.kru07.permissionletterpdf', $data);
