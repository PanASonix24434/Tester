...
class KeputusanDaerahController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->where('application_type','GANTI KRU')
        ...
        return view('app.kru.kru01.keputusandaerah.index', [
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru01.keputusandaerah.show', [
            'id' => $id,
            'app' => $app,
            'kru' => $kru,
            'applicant' => $applicant,
    ...
    public function update(Request $request, string $id)
    {
        if ($request->action=='save'){
            ...
            try {
                ...
                if($request->applicationStatus == 'approved'){
                    ...
                    $mailDataArr = array(
                        ...
                        'vessel' => strtoupper($vessel->vessel_no),
            ...
            return redirect()->route('kadpendaftarannelayan.keputusandaerah.index')->with('alert', 'Maklumat berjaya dihantar !!');
        }
    }
