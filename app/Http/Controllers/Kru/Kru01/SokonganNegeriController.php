...
class SokonganNegeriController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru01.sokongannegeri.index', [
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru01.sokongannegeri.show', [
            'id' => $id,
            'app' => $app,
            'kru' => $kru,
            'applicant' => $applicant,
    ...
    public function update(Request $request, string $id)
    {
        if ($request->action=='save'){
            ...
            try {
                ...
                $auditLog->log('kru01SokonganNegeri', 'update', $audit_details);
                DB::commit();
            }
            catch (Exception $e) {
                DB::rollback();
                ...
                $auditLog = new AuditLog();
                $auditLog->log('kru01SokonganNegeri', 'update', $audit_details, $e->getMessage());
            ...
            return redirect()->route('kadpendaftarannelayan.sokongannegeri.index')->with('alert', 'Maklumat berjaya dihantar !!');
        }
    }
