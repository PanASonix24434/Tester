...
class PengesahanBayaranController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru01.pengesahanbayaran.index', [
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru01.pengesahanbayaran.show', [
            'id' => $id,
            'app' => $app,
            'kru' => $kru,
            'applicant' => $applicant,
    ...
    public function update(Request $request, string $id)
    {
        if ($request->action=='save'){
            ...
            try {
                ...
                $auditLog->log('kru01PengesahanBayaran', 'update', $audit_details);
                DB::commit();
            }
            catch (Exception $e) {
                DB::rollback();
                ...
                $auditLog = new AuditLog();
                $auditLog->log('kru01PengesahanBayaran', 'update', $audit_details, $e->getMessage());
            ...
            return redirect()->route('kadpendaftarannelayan.pengesahanbayaran.index')->with('alert', 'Maklumat Bayaran berjaya dihantar !!');
        }
    }
