...
class SemakanDaerahController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru04.semakandaerah.index', [
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru04.semakandaerah.show', [
            'id' => $id,
            'app' => $app,
            'vessel' => $vessel,
    ...
    public function update(Request $request, string $id)
    {
        if ($request->action=='save'){
            ...
            return redirect()->route('pembatalankadpendaftarannelayan.semakandaerah.index')->with('alert', 'Maklumat berjaya dihantar !!');
        }
