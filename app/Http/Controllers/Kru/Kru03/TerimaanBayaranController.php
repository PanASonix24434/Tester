...
class TerimaanBayaranController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru03.terimaanbayaran.index', [
    ...
    public function storeReceipt(Request $request,string $id)
    {
        ...
        return redirect()->route('gantiankadpendaftarannelayan.terimaanbayaran.show', $id)->with('alert', 'Maklumat Bayaran berjaya disimpan !!');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru03.terimaanbayaran.show', [
            'id' => $id,
            'app' => $app,
            'vessel' => $vessel,
    ...
    public function createReceipt(string $id)
    {
        ...
        return view('app.kru.kru03.terimaanbayaran.create', [
            'id' => $id,
            'app' => $app,
            'vesel' => $vesel,
            'applicant' => $applicant,
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru03TerimaanBayaran', 'update', $audit_details);
            DB::commit();
        }
        catch (Exception $e) {
            DB::rollback();
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru03TerimaanBayaran', 'update', $audit_details, $e->getMessage());

            return redirect()->back()->with('alert', 'Maklumat Bayaran gagal dihantar !!');
        }
        return redirect()->route('gantiankadpendaftarannelayan.terimaanbayaran.index')->with('alert', 'Maklumat Bayaran berjaya dihantar !!');
    }
