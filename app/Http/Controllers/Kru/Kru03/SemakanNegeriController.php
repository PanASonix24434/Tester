...
class SemakanNegeriController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru03.semakannegeri.index', [
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru03.semakannegeri.show', [
            'id' => $id,
            'app' => $app,
            'vesel' => $vesel,
        ...
        if ($request->action=='save'){
            ...
            try {
                ...
                $audit_details = json_encode([
                    ...
                    'completed' => $request->applicationStatus,
                    // 'remark' => $request->remark,
                ]);
                $auditLog = new AuditLog();
                $auditLog->log('kru03SemakanNegeri', 'update', $audit_details);
                DB::commit();
            }
            catch (Exception $e) {
                DB::rollback();
                ...
                $auditLog = new AuditLog();
                $auditLog->log('kru03SemakanNegeri', 'update', $audit_details, $e->getMessage());
            ...
            return redirect()->route('gantiankadpendaftarannelayan.semakannegeri.index')->with('alert', 'Maklumat berjaya dihantar !!');
        }
