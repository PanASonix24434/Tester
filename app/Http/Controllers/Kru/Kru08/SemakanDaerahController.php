...
class SemakanDaerahController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru08.semakandaerah.index', [
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru08.semakandaerah.show', [
            'id' => $id,
            'app' => $app,
    ...
    public function update(Request $request, string $id)
    {
        if ($request->action=='save'){
            ...
            try {
                ...
                $auditLog->log('kru08SemakanDaerah', 'update', $audit_details);
                DB::commit();
            }
            catch (Exception $e) {
                DB::rollback();
                ...
                $auditLog = new AuditLog();
                $auditLog->log('kru08SemakanDaerah', 'update', $audit_details, $e->getMessage());
            ...
            return redirect()->route('pembatalanpenggunaankrubukanwarganegara.semakandaerah.index')->with('alert', 'Maklumat berjaya dihantar !!');
        }
