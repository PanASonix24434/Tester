...
use App\Mail\Kru\Kru08Approved;
...
class KeputusanDaerahController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru08.keputusandaerah.index', [
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru08.keputusandaerah.show', [
            'id' => $id,
            'app' => $app,
    ...
    public function update(Request $request, string $id)
    {
        if ($request->action=='save'){
            ...
            try {
                ...
                $auditLog->log('kru08KeputusanDaerah', 'update', $audit_details);
                DB::commit();
            }
            catch (Exception $e) {
                DB::rollback();
                ...
                $auditLog = new AuditLog();
                $auditLog->log('kru08KeputusanDaerah', 'update', $audit_details, $e->getMessage());
            ...
            try {
                ...
                if($request->applicationStatus == 'approved'){
                    ...
                    $appKrus = KruApplicationForeignKru::where('kru_application_id',$id)->where('selected_for_approval',true)->get();
                    foreach ($appKrus as $appKru) {
                        // $appKru->selected_for_approval = true;
                        // $appKru->updated_by = Auth::id();
                        // $appKru->save();
                        ...
                        $foreignCrew->vessel_id = null;
                        $foreignCrew->updated_by = Auth::id();
                        $foreignCrew->save();
                    }
                ...
                if($request->applicationStatus == 'approved'){
                    ...
                    Mail::to($pemilikVesel->email)->queue(new Kru08Approved($mailDataArr));
            ...
            return redirect()->route('pembatalanpenggunaankrubukanwarganegara.keputusandaerah.index')->with('alert', 'Maklumat berjaya dihantar !!');
        }
    }
