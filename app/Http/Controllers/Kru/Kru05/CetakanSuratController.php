...
class CetakanSuratController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru05.cetakansurat.index', [
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru05.cetakansurat.show', [
            'id' => $id,
            'app' => $app,
        ...
        if ($request->action=='save'){
            ...
            try {
                ...
                if($request->applicationStatus == 'approved'){
                    ...
                    Mail::to($pemilikVesel->email)->queue(new Kru05Approved($mailDataArr));
            ...
            return redirect()->route('kebenaranpenggunaankrubukanwarganegara.cetakansurat.index')->with('alert', 'Maklumat berjaya dihantar !!');
        }
    }
