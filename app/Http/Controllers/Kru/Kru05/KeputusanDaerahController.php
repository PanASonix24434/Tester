...
class KeputusanDaerahController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru05.keputusandaerah.index', [
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru05.keputusandaerah.show', [
            'id' => $id,
            'app' => $app,
    ...
    public function update(Request $request, string $id)
    {
        if ($request->action=='save'){
            ...
            return redirect()->route('kebenaranpenggunaankrubukanwarganegara.keputusandaerah.index')->with('alert', 'Maklumat berjaya dihantar !!');
        }
    }
