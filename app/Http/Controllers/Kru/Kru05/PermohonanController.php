...
class PermohonanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.kru.kru05.index', [
    ...
    public function create()
    {
        ...
        return view('app.kru.kru05.create', [
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $appType = KruApplicationType::where('code','KRU05')->first();
            ...
            $auditLog->log('kru05', 'create', $audit_details);
            DB::commit();
            return redirect()->route('kebenaranpenggunaankrubukanwarganegara.permohonan.editB', $app->id)->with('alert', 'Permohonan berjaya disimpan !!');
        }
        catch (Exception $e) {
            DB::rollback();
            $audit_details = json_encode([
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru05', 'create', $audit_details, $e->getMessage());
    ...
    public function show(string $id)
    {
        ...
        return view('app.kru.kru05.show', [
            'id' => $id,
            'app' => $app,
    ...
    public function edit(string $id)
    {
        ...
        return view('app.kru.kru05.edit', [
            'id' => $id,
            'app' => $app,
            'vessels' => Vessel::where('user_id',$user->id)->whereIn('zon',['C','C2'])->orderBy('no_pendaftaran')->get(),
        ]);
    ...
    public function editB(string $id)
    {
        ...
        $immigrationGates = null;
        if($appForeign != null && $appForeign->immigration_office_id != null){
            $stateId = optional(ImmigrationOffice::find($appForeign->immigration_office_id))->state_id;
            $immigrationGates = ImmigrationGate::where('state_id', $stateId)->orderBy('immigration_gates.gate_type')->orderBy('immigration_gates.name')->select('id','name','gate_type')->get();
        }

        return view('app.kru.kru05.editB', [
            'id' => $id,
            'app' => $app,
            'appForeign' => $appForeign,
            'vessel' => $vessel,
            ...
            'imigresenGates' => ImmigrationGate::orderBy('immigration_gates.gate_type')->orderBy('immigration_gates.name')->select('id','name','gate_type')->get()
        ]);
    }
    ...
    public function editC(string $id)
    {
        ...
        return view('app.kru.kru05.editC', [
            'id' => $id,
            'app' => $app,
            'appForeign' => $appForeign,
            'vessel' => $vessel,
    ...
    public function editCAddKru(string $id)
    {
        ...
        $minPassport = Carbon::now()->addYear()->format('Y-m-d');

        return view('app.kru.kru05.editCAddKru', [
            'id' => $id,
            'app' => $app,
            'appForeign' => $appForeign,
    ...
    public function editD(string $id)
    {
        ...
        $docExtra = KruApplicationDocument::where('kru_application_id',$id)->whereNotIn('description',KruApplicationDocument::DOC_ALL)->latest()->get();

        return view('app.kru.kru05.editD', [
            'id' => $id,
            'app' => $app,
    ...
    public function editE(string $id)
    {
        ...
        return view('app.kru.kru05.editE', [
            'id' => $id,
            'app' => $app,
            'statusIncompleteId' => $statusIncompleteId,
        ]);
    ...
    public function updateB(Request $request, string $id)
    {
        ...
        try {
            ...
            $kruAppForeign->immigration_gate_id = $request->selGate;
        ...
        return redirect()->route('kebenaranpenggunaankrubukanwarganegara.permohonan.editC', $app->id)->with('alert', 'Permohonan berjaya disimpan !!');
    }
    ...
    public function updateD(Request $request, string $id)
    {
        ...
        try {
            ...
            if ($request->file('extraDoc')) {
                ...
                $file_replace = str_replace(' ', '', $file->getClientOriginalName());
                $filename = $file_replace;
                $path = $request->file('extraDoc')->store('public/kru');
        ...
        return redirect()->route('kebenaranpenggunaankrubukanwarganegara.permohonan.editE', $app->id)->with('alert', 'Permohonan berjaya disimpan !!');
    }
    ...
    public function updateE(Request $request, string $id)
    {
        ...
        if(!($docs->contains('description', KruApplicationDocument::DOC_IC) || $docs->contains('description', KruApplicationDocument::DOC_PENDAFTARAN_SYARIKAT))){
            return redirect()->back()->with('alert', 'Perlukan Dokumen SALINAN KAD PENGENALAN MAJIKAN atau SALINAN PENDAFTARAN SYARIKAT!!');
        }
        ...
        try {
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru05', 'editE', $audit_details);
            DB::commit();
        }
        catch (Exception $e) {
            DB::rollback();
            ...
            $auditLog = new AuditLog();
            $auditLog->log('kru05', 'editE', $audit_details, $e->getMessage());

            return redirect()->back()->with('alert', 'Permohonan gagal dihantar !!');
        }
        return redirect()->route('kebenaranpenggunaankrubukanwarganegara.permohonan.index')->with('alert', 'Permohonan berjaya dihantar !!');
    }
    ...
    public function exportPermissionLetter(Request $request, $id) 
    {
        ...
        $data = [
            ...
            'immigrationGate' => strtoupper(ImmigrationGate::find($appForeign->immigration_gate_id)->name),
        ...
        $pdf = Pdf::loadView('app.kru.kru05.permissionletterpdf', $data);
